...
Strings.OfficeOM.L_ActivityLimitReached = "Aktivitetsgränsen har nåtts.";
Strings.OfficeOM.L_AddBindingFromPromptDefaultText = "Gör ett val.";
Strings.OfficeOM.L_AddinIsAlreadyRequestingToken = "Tillägget begär redan en åtkomsttoken.";
Strings.OfficeOM.L_AddinIsAlreadyRequestingTokenMessage = "Åtgärden misslyckades eftersom tillägget redan begär en åtkomsttoken.";
Strings.OfficeOM.L_ApiNotFoundDetails = "Metoden eller egenskapen {0} är en del av kravuppsättningen för {1}, som inte är tillgängligt i din version av {2}.";
Strings.OfficeOM.L_AppNameNotExist = "Det finns inget tilläggsnamn för {0}.";
...
Strings.OfficeOM.L_AttemptingToSetReadOnlyProperty = "Försöker att konfigurera den skrivskyddade egenskapen {0}.";
...
Strings.OfficeOM.L_ConfirmCancelMessage = "Det går inte att fortsätta.";
Strings.OfficeOM.L_ConfirmDialog = "Litar du på domänen {0} där den här Office-sessionen finns?";
Strings.OfficeOM.L_ConfirmRefreshMessage = "Ta bort tillägget och Lägg till det igen, eller uppdatera sidan om du vill fortsätta.";
...
Strings.OfficeOM.L_ContinueButton = "Fortsätt";
...
Strings.OfficeOM.L_DialogAddressNotTrusted = "URL-adressen ingår inte i AppDomains-elementet i manifestet, och är inte under domänen för käll platsen.";
Strings.OfficeOM.L_DialogAlreadyOpened = "Åtgärden misslyckades eftersom tillägget redan har en aktiv dialogruta.";
Strings.OfficeOM.L_DialogInvalidScheme = "URL-schemat stöds inte. Använd HTTPS i stället.";
Strings.OfficeOM.L_DialogNavigateError = "Fel i dialogrutenavigering";
Strings.OfficeOM.L_DialogOK = "OK";
Strings.OfficeOM.L_DialogRequireHTTPS = "HTTP-protokollet stöds inte. Använd HTTPS i stället";
Strings.OfficeOM.L_DisplayDialogError = "Fel i dialogrutevisning";
...
Strings.OfficeOM.L_ImplicitGetAuthContextMissing = "Funktionen för att hämta kontext för autentisering saknas";
Strings.OfficeOM.L_ImplicitNotLoaded = "Modulen lästes inte in innan token förvärvades";
...
Strings.OfficeOM.L_InvalidArgumentGeneric = "Den eller de argument som överfördes till funktionen fungerar inte i den här situationen, saknas eller är inte i rätt format.";
...
Strings.OfficeOM.L_InvalidGrant = "Förauktorisering saknas.";
Strings.OfficeOM.L_InvalidGrantMessage = "Behörighet saknas för detta tillägg.";
...
Strings.OfficeOM.L_InvalidObjectPath = 'Objektsökvägen {0} fungerar inte för det du försöker göra. Om du använder objektet i flera "context.sync"-anrop och utanför den sekventiella körningen av en ".run"-batch använder du metoderna "context.trackedObjects.add()" och "context.trackedObjects.remove()" för att hantera objektets livstid.';
Strings.OfficeOM.L_InvalidOperationInCellEditMode = "Excel är i cellredigeringsläge. Avsluta redigeringsläget genom att trycka på RETUR eller TABB eller genom att markera en annan cell och sedan försöka igen.";
Strings.OfficeOM.L_InvalidOrTimedOutSession = "Sessionen är ogiltig eller har upphört";
Strings.OfficeOM.L_InvalidOrTimedOutSessionMessage = "Office-sessionen har upphört att gälla eller är ogiltig. Uppdatera sidan om du vill fortsätta.";
...
Strings.OfficeOM.L_InvalidRequestContext = "Det går inte att använda objektet i flera olika begärankontexter.";
Strings.OfficeOM.L_InvalidResourceUrl = "Ogiltig programresurs-URL har angetts.";
Strings.OfficeOM.L_InvalidResourceUrlMessage = "Ogiltig resurs-URL har angetts i manifestet.";
Strings.OfficeOM.L_InvalidSSOAddinMessage = "Identitets-API stöds inte för detta tillägg.";
...
Strings.OfficeOM.L_NewWindowCrossZone = "Säkerhetsinställningarna i din webbläsare hindrar oss från att skapa en dialogruta. Försök med en annan webbläsare eller {0} så att {1} och den domän som visas i adressfältet är i samma säkerhetszon.";
Strings.OfficeOM.L_NewWindowCrossZoneConfigureBrowserLink = "konfigurera webbläsaren";
Strings.OfficeOM.L_NewWindowCrossZoneErrorString = "Webbläsarbegränsningar hindrade oss från att skapa dialogrutan. Dialogrutans domän och domänen för tilläggsvärden är inte i samma säkerhetszon.";
Strings.OfficeOM.L_NoCapability = "Du har inte tillräcklig behörighet för den här åtgärden.";
Strings.OfficeOM.L_NoHttpsWAC = "Den här Office-sessionen använder inte en säker anslutning. Vi rekommenderar att du tar extra försiktighets åtgärder.";
...
Strings.OfficeOM.L_NotTrustedWAC = "Det här tillägget har inaktiverats så att du kan hålla dig säker. Om du vill fortsätta använda tillägget verifierar du att det här objektet finns i en betrodd domän eller öppnar det i Office Desktop-appen.";
...
Strings.OfficeOM.L_PropertyDoesNotExist = "Egenskapen {0} finns inte i objektet.";
Strings.OfficeOM.L_PropertyNotLoaded = 'Egenskapen {0} är inte tillgänglig. Innan du läser egenskapens värde anropar du inläsningsmetoden för det innehållande objektet och anropar "context.sync()" för den associerade begärankontexten.';
...
Strings.OfficeOM.L_RunMustReturnPromise = 'Batchfunktionen som har överförts till metoden ".run" returnerade inte ett löfte. Funktionen måste returnera ett löfte så att automatiskt spårade objekt kan frisläppas när batchen slutförs. Normalt returnerar du ett löfte genom att returnera svaret från "context.sync()".';
Strings.OfficeOM.L_SSOClientError = "Fel uppstod i autentiseringsbegäran från Office.";
Strings.OfficeOM.L_SSOClientErrorMessage = "Ett oväntat fel uppstod i klienten.";
Strings.OfficeOM.L_SSOConnectionLostError = "En anslutning bröts under inloggningen.";
...
Strings.OfficeOM.L_ShowWindowDialogNotification = "{0} vill visa ett nytt fönster.";
...
Strings.OfficeOM.L_UnsupportedUserIdentity = "Användarens identitetstyp stöds inte.";
Strings.OfficeOM.L_UnsupportedUserIdentityMessage = "Användarens identitetstyp stöds inte.";
Strings.OfficeOM.L_UserAborted = "Användaren avbröt begäran om godkännande.";
Strings.OfficeOM.L_UserAbortedMessage = "Användaren har inte godkänt behörigheterna för tillägget.";
Strings.OfficeOM.L_UserClickIgnore = "Användaren valde att ignorera dialogrutan.";
Strings.OfficeOM.L_UserNotSignedIn = "Ingen användare är inloggad i Office.";
Strings.OfficeOM.L_ValueNotLoaded = 'Värdet för ett resultatobjekt har inte lästs in ännu. Anropa "context.sync()" i den associerade begärandekontexten innan du läser värdeegenskapen.';
Strings.OfficeOM.L_WorkbookHiddenMessage = "JavaScript-API-begäran misslyckades eftersom arbetsboken har dolts. Ta fram arbetsboken och försök igen.";
Strings.OfficeOM.L_WriteNotSupportedWhenModalDialogOpen = "Skrivåtgärden stöds inte för Office när en modal dialogruta är öppen.";