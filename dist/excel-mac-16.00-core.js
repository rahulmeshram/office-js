...
(function (OSFAppTelemetry) {
    ...
    function initialize(context) {
        ...
        appInfo.hostJSVersion = "16.0.11311.30002";
...
!function(e){var t={};function r(n){if(t[n])return t[n].exports;var i=t[n]={i:n,l:!1,exports:{}};return e[n].call(i.exports,i,i.exports,r),i.l=!0,i.exports}r.m=e,r.c=t,r.d=function(e,t,n){r.o(e,t)||Object.defineProperty(e,t,{enumerable:!0,get:n})},r.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},r.t=function(e,t){if(1&t&&(e=r(e)),8&t)return e;if(4&t&&"object"==typeof e&&e&&e.__esModule)return e;var n=Object.create(null);if(r.r(n),Object.defineProperty(n,"default",{enumerable:!0,value:e}),2&t&&"string"!=typeof e)for(var i in e)r.d(n,i,function(t){return e[t]}.bind(null,i));return n},r.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return r.d(t,"a",t),t},r.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},r.p="",r(r.s=1)}([function(e,t){e.exports=OfficeExtensionBatch},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=r(2),i=r(3);window._OfficeRuntimeNative={displayWebDialog:n.displayWebDialog,AsyncStorage:i.AsyncStorage}},function(e,t,r){"use strict";var n,i=this&&this.__extends||(n=function(e,t){return(n=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)t.hasOwnProperty(r)&&(e[r]=t[r])})(e,t)},function(e,t){function r(){this.constructor=e}n(e,t),e.prototype=null===t?Object.create(t):(r.prototype=t.prototype,new r)});Object.defineProperty(t,"__esModule",{value:!0});var o=r(0),s=(o.BatchApiHelper.createPropertyObject,o.BatchApiHelper.createMethodObject,o.BatchApiHelper.createIndexerObject,o.BatchApiHelper.createRootServiceObject,o.BatchApiHelper.createTopLevelServiceObject),c=(o.BatchApiHelper.createChildItemObject,o.BatchApiHelper.invokeMethod),a=(o.BatchApiHelper.invokeEnsureUnchanged,o.BatchApiHelper.invokeSetProperty,o.Utility.isNullOrUndefined),u=(o.Utility.isUndefined,o.Utility.throwIfNotLoaded,o.Utility.throwIfApiNotSupported,o.Utility.load,o.Utility.retrieve,o.Utility.toJson),l=o.Utility.fixObjectPathIfNecessary,p=(o.Utility._handleNavigationPropertyResults,o.Utility.adjustToDateTime,o.Utility.processRetrieveResult),d=function(){function e(e){this._dialogService=e}return e.prototype.close=function(){return this._dialogService.close(),this._dialogService.context.sync()},e}();t.Dialog=d,t.displayWebDialog=function(e,t){return void 0===t&&(t={}),new o.CoreUtility.Promise(function(n,i){if(t.width&&t.height&&(!r(t.width)||!r(t.height)))throw new o.Error({code:"InvalidArgument",message:"Dimensions must be % or number."});var s=new o.ClientRequestContext,c=g.newObject(s),a=new d(c),u=c.onDialogMessage.add(function(e){switch(o.Utility.log("dialogMessageHandler:"+JSON.stringify(e)),e.type){case 17:e.error?i(e.error):n(a);break;case 12:t.onMessage&&t.onMessage(e.message,a);break;case 10:default:12006===e.originalErrorCode?(u&&(u.remove(),s.sync()),t.onClose&&t.onClose()):t.onRuntimeError&&(t.onRuntimeError(e.error,a),i(e.error))}return o.CoreUtility.Promise.resolve()});return s.sync().then(function(){var r={width:t.width?parseInt(t.width):50,height:t.height?parseInt(t.height):50,displayInIFrame:t.displayInIFrame};return c.displayDialog(e,r),s.sync()}).catch(function(e){i(e)})});function r(e){return/^(\-|\+)?([0-9]+)%?$/.test(e)}};var f,g=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return i(t,e),Object.defineProperty(t.prototype,"_className",{get:function(){return"DialogService"},enumerable:!0,configurable:!0}),t.prototype.close=function(){c(this,"Close",1,[],4,0)},t.prototype.displayDialog=function(e,t){c(this,"DisplayDialog",1,[e,t],4,0)},t.prototype._handleResult=function(t){(e.prototype._handleResult.call(this,t),a(t))||l(this,t)},t.prototype._handleRetrieveResult=function(t,r){e.prototype._handleRetrieveResult.call(this,t,r),p(this,t,r)},t.newObject=function(e){return s(t,e,"Microsoft.Dialog.DialogService",!1,4)},Object.defineProperty(t.prototype,"onDialogMessage",{get:function(){return this.m_dialogMessage||(this.m_dialogMessage=new o.GenericEventHandlers(this.context,this,"DialogMessage",{eventType:65536,registerFunc:function(){},unregisterFunc:function(){},getTargetIdFunc:function(){return null},eventArgsTransformFunc:function(e){var t,r,n,i;try{var s=JSON.parse(e.message),c=s.errorCode?new o.Error((r=s.errorCode,(n={})[12002]={code:"InvalidUrl",message:"Cannot load URL, no such page or bad URL syntax."},n[12003]={code:"InvalidUrl",message:"HTTPS is required."},n[12004]={code:"Untrusted",message:"Domain is not trusted."},n[12005]={code:"InvalidUrl",message:"HTTPS is required."},n[12007]={code:"FailedToOpen",message:"Another dialog is already opened."},(i=n)[r]?i[r]:{code:"Unknown",message:"An unknown error has occured with code: "+r})):null;t={originalErrorCode:s.errorCode,type:s.type,error:c,message:s.message}}catch(e){t={originalErrorCode:null,type:17,error:new o.Error({code:"GenericException",message:"Unknown error"}),message:e.message}}return o.Utility._createPromiseFromResult(t)}})),this.m_dialogMessage},enumerable:!0,configurable:!0}),t.prototype.toJSON=function(){return u(this,{},{})},t}(o.ClientObject);t.DialogService=g,function(e){e[e.dialogMessageReceived=0]="dialogMessageReceived",e[e.dialogEventReceived=1]="dialogEventReceived"}(f||(f={})),function(e){e.generalException="GeneralException"}(t.DialogErrorCodes||(t.DialogErrorCodes={}))},function(e,t,r){"use strict";var n,i=this&&this.__extends||(n=function(e,t){return(n=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)t.hasOwnProperty(r)&&(e[r]=t[r])})(e,t)},function(e,t){function r(){this.constructor=e}n(e,t),e.prototype=null===t?Object.create(t):(r.prototype=t.prototype,new r)});Object.defineProperty(t,"__esModule",{value:!0});var o=r(0),s=(o.BatchApiHelper.createPropertyObject,o.BatchApiHelper.createMethodObject,o.BatchApiHelper.createIndexerObject,o.BatchApiHelper.createRootServiceObject,o.BatchApiHelper.createTopLevelServiceObject),c=(o.BatchApiHelper.createChildItemObject,o.BatchApiHelper.invokeMethod),a=(o.BatchApiHelper.invokeEnsureUnchanged,o.BatchApiHelper.invokeSetProperty,o.Utility.isNullOrUndefined),u=(o.Utility.isUndefined,o.Utility.throwIfNotLoaded,o.Utility.throwIfApiNotSupported,o.Utility.load,o.Utility.retrieve,o.Utility.toJson),l=o.Utility.fixObjectPathIfNecessary,p=(o.Utility._handleNavigationPropertyResults,o.Utility.adjustToDateTime,o.Utility.processRetrieveResult);function d(e,t,r){return new o.CoreUtility.Promise(function(n,i){var o=f.getInstance(),s=o.setCallBack(function(e,o){if(o)return r&&r(o),void i(o);var s=t(e);r&&r(null,s),n(s)});o.ctx.sync().then(function(){var t=o.getPersistentKvStorageService();return e(t,s),o.ctx.sync()}).catch(function(e){i(e)})})}t.AsyncStorage={getItem:function(e,t){return d(function(t,r){return t.multiGet(r,JSON.stringify([e]))},function(e){var t=JSON.parse(e);return t&&t[0]&&t[0][1]?t[0][1]:null},t)},setItem:function(e,t,r){return d(function(r,n){return r.multiSet(n,JSON.stringify([[e,t]]))},function(){return null},r)},removeItem:function(e,t){return d(function(t,r){return t.multiRemove(r,JSON.stringify([e]))},function(){return null},t)},multiGet:function(e,t){return d(function(t,r){return t.multiGet(r,JSON.stringify(e))},function(t){var r=JSON.parse(t),n={};return r&&r.forEach(function(e){var t=e[0],r=e[1];return n[t]=r,r}),e.map(function(e){return[e,n[e]?n[e]:null]})},t)},multiSet:function(e,t){return d(function(t,r){return t.multiSet(r,JSON.stringify(e))},function(){return null},t)},multiRemove:function(e,t){return d(function(t,r){return t.multiRemove(r,JSON.stringify(e))},function(){return null},t)},getAllKeys:function(e){return d(function(e,t){return e.getAllKeys(t)},function(e){return JSON.parse(e)},e)},clear:function(e){return d(function(e,t){return e.clear(t)},function(){return null},e)}};var f=function(){function e(){var e=this;this._invokeId=0,this._callDict={},this.ctx=new o.ClientRequestContext,this._perkvstorService=g.newObject(this.ctx),this._eventResult=this._perkvstorService.onPersistentStorageMessage.add(function(t){o.Utility.log("persistentKvStoragegMessageHandler:"+JSON.stringify(t));var r=e._callDict[t.invokeId];r&&(r(t.message,t.error),delete e._callDict[t.invokeId])})}return e.getInstance=function(){return void 0===e.instance?e.instance=new e:e.instance._perkvstorService=g.newObject(e.instance.ctx),e.instance},e.prototype.getPersistentKvStorageService=function(){return this._perkvstorService},e.prototype.getCallBack=function(e){return this._callDict[e]},e.prototype.setCallBack=function(e){var t=this._invokeId;return this._callDict[this._invokeId++]=e,t},e}(),g=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return i(t,e),Object.defineProperty(t.prototype,"_className",{get:function(){return"PersistentKvStorageService"},enumerable:!0,configurable:!0}),t.prototype.clear=function(e){c(this,"Clear",1,[e],4,0)},t.prototype.getAllKeys=function(e){c(this,"GetAllKeys",1,[e],4,0)},t.prototype.multiGet=function(e,t){c(this,"MultiGet",1,[e,t],4,0)},t.prototype.multiRemove=function(e,t){c(this,"MultiRemove",1,[e,t],4,0)},t.prototype.multiSet=function(e,t){c(this,"MultiSet",1,[e,t],4,0)},t.prototype._handleResult=function(t){(e.prototype._handleResult.call(this,t),a(t))||l(this,t)},t.prototype._handleRetrieveResult=function(t,r){e.prototype._handleRetrieveResult.call(this,t,r),p(this,t,r)},t.newObject=function(e){return s(t,e,"Microsoft.PersistentKvStorage.PersistentKvStorageService",!1,4)},Object.defineProperty(t.prototype,"onPersistentStorageMessage",{get:function(){return this.m_persistentStorageMessage||(this.m_persistentStorageMessage=new o.GenericEventHandlers(this.context,this,"PersistentStorageMessage",{eventType:65537,registerFunc:function(){},unregisterFunc:function(){},getTargetIdFunc:function(){return null},eventArgsTransformFunc:function(e){var t,r,n,i;try{var s=JSON.parse(e.message),c=parseInt(s.errorCode),a=0!=c?new o.Error((r=c,(n={})[16389]={code:"GenericException",message:"Unknown error."},n[65535]={code:"Unexcepted",message:"Catastrophic failure."},n[14]={code:"OutOfMemory",message:"Ran out of memory."},n[87]={code:"InvalidArg",message:"One or more arguments are invalid."},n[16385]={code:"NotImplemented",message:"Not implemented."},n[6]={code:"BadHandle",message:"File Handle is not Set."},n[5]={code:"AccessDenied",message:"Can't read the AsyncStorage File."},(i=n)[r]?i[r]:{code:"Unknown",message:"An unknown error has occured"})):null;t={invokeId:s.invokeId,message:s.message,error:a}}catch(e){t={invokeId:-1,message:e.message,error:new o.Error({code:"GenericException",message:"Unknown error"})}}return o.Utility._createPromiseFromResult(t)}})),this.m_persistentStorageMessage},enumerable:!0,configurable:!0}),t.prototype.toJSON=function(){return u(this,{},{})},t}(o.ClientObject);t.PersistentKvStorageService=g,function(e){e.generalException="GeneralException"}(t.ErrorCodes||(t.ErrorCodes={}))}]);