...
/*
 * This is a generated file.  Generated by richapishared\OfficeSharedApi\codegen\OfficeSharedApiGen.bat.
...
(function (OfficeCore) {
    ...
    /* Begin_PlaceHolder_AddinInternalService_BeforeDeclaration */
    /* End_PlaceHolder_AddinInternalService_BeforeDeclaration */
    /**
     *
     * Interface for Notify Event state.
     *
     * [Api set: InternalService 1.1]
     */
    var AddinInternalService = /** @class */ (function (_super) {
        ...
        /* Begin_PlaceHolder_AddinInternalService_Custom_Members */
        /* End_PlaceHolder_AddinInternalService_Custom_Members */
        ...
        AddinInternalService.prototype.notifyActionHandlerReady = function () {
            /* Begin_PlaceHolder_AddinInternalService_NotifyActionHandlerReady */
            /* End_PlaceHolder_AddinInternalService_NotifyActionHandlerReady */
            _invokeMethod(this, "NotifyActionHandlerReady", 1 /* Read */, [], 4 /* concurrent */, 0 /* none */);
        };
        ...
        AddinInternalService.prototype._handleResult = function (value) {
            ...
            var obj = value;
            _fixObjectPathIfNecessary(this, obj);
            /* Begin_PlaceHolder_AddinInternalService_HandleResult */
            /* End_PlaceHolder_AddinInternalService_HandleResult */
        };
        ...
        AddinInternalService.prototype._handleRetrieveResult = function (value, result) {
            _super.prototype._handleRetrieveResult.call(this, value, result);
            /* Begin_PlaceHolder_AddinInternalService_HandleRetrieveResult */
            /* End_PlaceHolder_AddinInternalService_HandleRetrieveResult */
            _processRetrieveResult(this, value, result);
        };
        /**
         * Create a new instance of OfficeCore.AddinInternalService object
         */
        AddinInternalService.newObject = function (context) {
            return _createTopLevelServiceObject(OfficeCore.AddinInternalService, context, "Microsoft.InternalService.AddinInternalService", false /*isCollection*/, 4 /* concurrent */);
        };
        /**
        * Overrides the JavaScript `toJSON()` method in order to provide more useful output when an API object is passed to `JSON.stringify()`. (`JSON.stringify`, in turn, calls the `toJSON` method of the object that is passed to it.)
        * Whereas the original OfficeCore.AddinInternalService object is an API object, the `toJSON` method returns a plain JavaScript object (typed as `OfficeCore.Interfaces.AddinInternalServiceData`) that contains shallow copies of any loaded child properties from the original object.
        */
...
})(OfficeCore || (OfficeCore = {})); // OfficeCore
            ...
            try {
                ...
                for (var i = 0; i < entryArray.length; i++) {
                    ...
                    if (entryArray[i].messageType === ActionDispatchMessageType) {
                        ...
                        // get optional argument if available
                        if (entryArray[i].message.length >= 2) {
                            ...
                            if (actionArgsJson) {
                                if (_isJsonObjectString(actionArgsJson)) {
                                    ...
                                    // string is not a json string fallback to raw value
...
(function (Excel) {
    ...
    var _libraryMetadataXlapi = { "version": "1.0.0",
        ...
        "clientObjectTypes": [[1, 0, [["assignees", 2], ["dueDate", 10], [192, 2], ["percentComplete", 2], [193, 2], ["startDate", 10], [194, 2]], [[195, 164, 2, 0, 0, 4]], [["addAssignee", 1], ["applyChanges", 1], ["removeAllAssignees"], ["removeAssignee", 1], ["schedule", 2], ["setPercentComplete", 1], ["setPriority", 1], ["setTitle", 1]]],
            ...
            [103, 1, 0, 0, [[424, 0, 0, 0, 2], [196, 0, 2, 9, 4]], [[197, 104, 1, 18, 0, 4], [287, 104, 1, 2, 9, 4], [286, 104, 3, 8, 1, 2]], 0, 104],
            [104, 0, [[199, 1, 0, 0, 2], [192, 3, 10, 0, 2], ["useCustomSortLists", 1, 2, 0, 2], ["enableDataValueEditing", 1, 2, 0, 2], ["allowMultipleFiltersPerField", 0, 6, 0, 2]], [[318, 12, 2, 0, 0, 4], ["hierarchies", 106, 19, 1, 0, 4], ["rowHierarchies", 108, 19, 1, 0, 4], ["columnHierarchies", 108, 19, 1, 0, 4], ["dataHierarchies", 112, 19, 1, 0, 4], ["filterHierarchies", 110, 19, 1, 0, 4], ["layout", 105, 2, 1, 0, 4]], [["refresh", 0, 0, 0, 2], [228, 0, 0, 1, 2]]],
            [105, 0, [["showColumnGrandTotals", 1, 0, 0, 2], ["showRowGrandTotals", 1, 0, 0, 2], ["enableFieldList", 1, 11, 0, 2], ["subtotalLocation", 1, 0, 0, 2], ["layoutType", 1, 0, 0, 2], ["autoFormat", 1, 2, 0, 2], ["preserveFormatting", 1, 2, 0, 2]], [["pivotStyle", 149, 35, 6, 0, 4]], [["getPivotItems", 2, 0, 2], ["setAutoSortOnCell", 2, 0, 2, 2], [357, 1, 0, 6, 2]], [[253, 16], ["getRowLabelRange", 16], ["getColumnLabelRange", 16], ["getFilterAxisRange", 16], [359, 16], [255, 16, 3, 0, 6], ["getDataHierarchy", 113, 1, 0, 2]]],
            [106, 1, 0, 0, [[196, 0, 2, 0, 4]], [[197, 107, 1, 18, 0, 4], [287, 107, 1, 2, 0, 4]], 0, 107],
            [107, 0, [[192, 3, 0, 0, 2], [199, 1, 0, 0, 2]], [[420, 114, 19, 0, 0, 4]]],
            [108, 1, 0, 0, [[196, 0, 2, 0, 4], [423, 1, 0, 0, 2]], [[197, 109, 1, 18, 0, 4], [287, 109, 1, 2, 0, 4], [286, 109, 1, 8, 0, 2]], 0, 109],
            [109, 0, [[192, 3, 0, 0, 2], [199, 1, 0, 0, 2], [225, 1, 0, 0, 2]], [[420, 114, 19, 0, 0, 4]], [[425, 0, 0, 0, 2]]],
            [110, 1, 0, 0, [[196, 0, 2, 0, 4], [423, 1, 0, 0, 2]], [[197, 111, 1, 18, 0, 4], [287, 111, 1, 2, 0, 4], [286, 111, 1, 8, 0, 2]], 0, 111],
            [111, 0, [[192, 3, 0, 0, 2], [199, 1, 0, 0, 2], [225, 1, 0, 0, 2], ["enableMultipleFilterItems", 1, 0, 0, 2]], [[420, 114, 19, 0, 0, 4]], [[425, 0, 0, 0, 2]]],
            [112, 1, 0, 0, [[196, 0, 2, 0, 4], [423, 1, 0, 0, 2]], [[197, 113, 1, 18, 0, 4], [287, 113, 1, 2, 0, 4], [286, 113, 1, 8, 0, 2]], 0, 113],
            [113, 0, [[192, 3, 0, 0, 2], [199, 1, 0, 0, 2], [225, 1, 0, 0, 2], [293, 1, 0, 0, 2], ["summarizeBy", 1, 0, 0, 2], ["showAs", 1, 0, 0, 2]], [["field", 115, 35, 0, 0, 4]], [[425, 0, 0, 0, 2]]],
            [114, 1, 0, 0, [[196, 0, 2, 0, 4]], [[197, 115, 1, 18, 0, 4], [287, 115, 1, 2, 0, 4]], 0, 115],
            [115, 0, [[192, 3, 0, 0, 2], [199, 1, 0, 0, 2], ["subtotals", 1, 0, 0, 2], ["showAllItems", 1, 0, 0, 2]], [["items", 116, 19, 0, 0, 4]], [["sortByLabels", 1, 1, 0, 2], ["sortByValues", 3, 0, 2, 2], ["applyFilter", 1, 0, 6, 2], ["clearAllFilters", 0, 0, 6, 2], ["clearFilter", 1, 0, 6, 2], ["getFilters", 0, 0, 6], ["isFiltered", 1, 0, 6]]],
            [116, 1, 0, 0, [[196, 0, 2, 0, 4]], [[197, 117, 1, 18, 0, 4], [287, 117, 1, 2, 0, 4]], 0, 117],
            [117, 0, [[192, 3, 0, 0, 2], [199, 1, 0, 0, 2], ["isExpanded", 1, 0, 0, 2], [348, 1, 0, 0, 2]]],
            ...
            [160, 0, 0, 0, [[424]], [[286, 5, 4, 8, 6, 2]]],
            [161, 1, 0, 0, [[196, 0, 2, 0, 4]], [[198, 16, 1, 2, 0, 4]], 0, 16],
            [162, 1, 0, 0, [[196, 0, 2, 0, 4]], [[198, 17, 1, 2, 0, 4]], 0, 17],
            [163, 5, 0, 0, [[196, 0, 2, 0, 4], [282, 0, 2, 6], [283, 0, 2, 6], [284, 0, 2, 6], [285, 0, 2, 6], [448, 0, 2, 12], [449, 0, 2, 12]], [[197, 164, 1, 18, 0, 4], [198, 164, 1, 2, 0, 4], [286, 164, 3, 8], ["getItemByReplyId", 164, 1, 2, 0, 4], ["getItemByCell", 164, 1, 2, 0, 4]], 0, 164, [[289, 0, 6, "MessageType.commentAddedEvent", 352, 282, 283], [265, 0, 12, "MessageType.commentChangedEvent", 352, 448, 449], [290, 0, 6, "MessageType.commentDeletedEvent", 352, 284, 285]]],
