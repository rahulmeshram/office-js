    ...
    var ClientObject = (function (_super) {
        ...
        function ClientObject(context, objectPath) {
            ...
            if (_this._objectPath) {
                ...
                if (OfficeExtension_1._internalConfig.appendTypeNameToObjectPathInfo && _this._className) {
                    objectPath.objectPathInfo.T = _this._className;
                }
            }
            return _this;
        }
...
(function (OfficeCore) {
    ...
    var _libraryMetadataOfficeSharedApi = { "version": "1.0.0",
        ...
        "clientObjectTypes": [[1, 4, 0, [["roamingSettings", 3, 2, 0, 0, 4]], [["getAccessToken", 2, 2, 0, 5], ["getPrimaryIdentityInfo", 0, 2, 1, 5], ["getIdentities", 0, 2, 2, 5]], 0, 0, 0, [["TokenReceived", 2, 1, "3001", "this._targetId", 34, 34]], "Microsoft.Authentication.AuthenticationService", 4],
            ...
            [26, 0, [["emailOrUpn", 3], [59, 3]], 0, [["requestToken"], [64], [65], ["requestIdentityUniqueId"], [66], [67], ["requestClientAccessToken"], [68], [69]], 0, 0, 0, [["ClientAccessTokenAvailable", 0, 0, "MessageType.lokiTokenProviderClientAccessTokenAvailableEvent", 63, 68, 69], ["IdentityUniqueIdAvailable", 0, 0, "MessageType.lokiTokenProviderIdentityUniqueIdAvailableEvent", 63, 66, 67], ["LokiTokenAvailable", 0, 0, "MessageType.lokiTokenProviderLokiTokenAvailableEvent", 63, 64, 65]]],
            [27, 0, 0, 0, 0, [[70, 26, 1]], 0, 0, 0, "Microsoft.People.LokiTokenProviderFactory", 4],
            [28, 0, 0, 0, [[60, 1], ["accountEmailOrUpn", 1], ["getPersonaPolicies"]], [[70, 26, 1], ["getPersonaLifetime", 25, 1], ["getInitialPersona", 24, 1]], 0, 0, 0, "Microsoft.People.ServiceContext", 4],
...
(function (Excel) {
    ...
    function enableMacroRecordingEvent(context) {
    ...
    Excel.enableMacroRecordingEvent = enableMacroRecordingEvent;
    ...
    var _libraryMetadataXlapi = { "version": "1.0.0",
        ...
        "clientObjectTypes": [[1, 0, [["connectionString", 2], [188, 2], ["commandText", 2], ["dataSourceType", 2]]],
            ...
            [159, 5, 0, 0, [[271, 0, 2, 0, 4], [272, 0, 2, 12], [273, 0, 2, 12], [274, 0, 2, 12], [275, 0, 2, 12], [441, 0, 2, 12], [442, 0, 2, 12]], [[276, 160, 1, 18, 0, 4], [335, 160, 1, 2, 0, 4], [277, 160, 3, 8], ["getItemByReplyId", 160, 1, 2, 0, 4], ["getItemByCell", 160, 1, 2, 0, 4]], 0, 160, [[280, 0, 12, "MessageType.commentAddedEvent", 344, 272, 273], [254, 0, 12, "MessageType.commentChangedEvent", 344, 441, 442], [281, 0, 12, "MessageType.commentDeletedEvent", 344, 274, 275]]],
