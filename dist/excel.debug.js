...
(function (OfficeCore) {
    ...
    var _libraryMetadataOfficeSharedApi = { "version": "1.0.0",
        ...
        "clientObjectTypes": [[1, 4, 0, [["roamingSettings", 3, 2, 0, 0, 4]], [["getAccessToken", 2, 2, 0, 5], ["getPrimaryIdentityInfo", 0, 2, 1, 5], ["getIdentities", 0, 2, 2, 5]], 0, 0, 0, [["TokenReceived", 2, 1, "3001", "this._targetId", 35, 35]], "Microsoft.Authentication.AuthenticationService", 4],
            ...
            [20, 0, 0, 0, [[57, 1, 2, 0, 4, 57], [58, 1, 0, 0, 0, 58], [59, 1, 2, 0, 4, 59]]],
            ...
            [24, 4, [["hostId", 3], ["type", 3], ["capabilities", 3], ["diagnosticId", 3], [60, 3]], [["photo", 20, 3, 0, 0, 4], ["personaInfo", 18, 3, 0, 0, 4], ["unifiedCommunicationInfo", 19, 3, 0, 0, 4], ["organization", 22, 3, 0, 0, 4], ["unifiedGroupInfo", 23, 35, 0, 0, 4], ["actions", 16, 2, 0, 0, 4]], [["getCustomizations", 0, 2, 0, 4], ["warmup", 1], [61], ["getViewableSources", 0, 2, 0, 4], ["reportTimeForRender", 2]], [["getMembers", 15, 0, 2, 0, 4], ["getMembership", 15, 0, 2, 0, 4]]],
            [25, 0, [[60, 3]], 0, [["getPolicies", 0, 2, 0, 4], [62], [63]], [["getPersona", 24, 1, 2, 0, 4], ["getPersonaForOrgEntry", 24, 4, 2, 0, 4], ["getPersonaForOrgByEntryId", 24, 4, 2, 0, 4]], 0, 0, [["PersonaUpdated", 0, 0, "MessageType.personaLifetimePersonaUpdatedEvent", 64, 62, 63]]],
            ...
            [27, 0, 0, 0, 0, [[71, 26, 1, 2, 0, 4]], 0, 0, 0, "Microsoft.People.LokiTokenProviderFactory", 4],
            [28, 0, 0, 0, [[61, 1], ["accountEmailOrUpn", 1, 2, 0, 4], ["getPersonaPolicies", 0, 2, 0, 4]], [[71, 26, 1, 2, 0, 4], ["getPersonaLifetime", 25, 1, 2, 0, 4], ["getInitialPersona", 24, 1, 2, 0, 4]], 0, 0, 0, "Microsoft.People.ServiceContext", 4],
