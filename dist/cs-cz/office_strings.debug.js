...
Strings.OfficeOM.L_AddinIsAlreadyRequestingToken = "Doplněk už žádá o přístupový token";
Strings.OfficeOM.L_AddinIsAlreadyRequestingTokenMessage = "Operace se nepovedla, protože tento doplněk už žádá o přístupový token.";
Strings.OfficeOM.L_ApiNotFoundDetails = "Metoda nebo vlastnost {0} je součástí sady požadavků {1}, která ve vaší verzi aplikace {2} není dostupná.";
...
Strings.OfficeOM.L_AttemptingToSetReadOnlyProperty = "Probíhá pokus nastavit vlastnost jen pro čtení {0}.";
...
Strings.OfficeOM.L_ConfirmCancelMessage = "Omlouváme se, nemůžeme pokračovat.";
Strings.OfficeOM.L_ConfirmDialog = "Důvěřovat doméně {0}, kde je tato relace Office hostovaná?";
Strings.OfficeOM.L_ConfirmRefreshMessage = "Pokud chcete pokračovat, odeberte doplněk a znovu ho přidejte nebo aktualizujte stránku.";
Strings.OfficeOM.L_ConnectionFailureWithDetails = "Žádost selhala se stavovým kódem {0}, kódem chyby {1} a následující chybovou zprávou: {2}";
Strings.OfficeOM.L_ConnectionFailureWithStatus = "Žádost selhala se stavovým kódem {0}.";
Strings.OfficeOM.L_ContinueButton = "Pokračovat";
Strings.OfficeOM.L_CustomFunctionDefinitionMissing = "V Excel.Script.CustomFunctions musí být vlastnost s tímto názvem, která představuje definici funkce.";
Strings.OfficeOM.L_CustomFunctionImplementationMissing = "Vlastnost s tímto názvem v Excel.Script.CustomFunctions, která představuje definici funkce, musí obsahovat vlastnost call implementující funkci.";
Strings.OfficeOM.L_CustomFunctionNameCannotSplit = "Název funkce musí obsahovat neprázdný obor názvů a neprázdný krátký název.";
Strings.OfficeOM.L_CustomFunctionNameContainsBadChars = "Název funkce může obsahovat pouze písmena, číslice, podtržítka a tečky.";
...
Strings.OfficeOM.L_DialogAddressNotTrusted = "Doména adresy URL není obsažena v elementu AppDomains v manifestu a není subdoménou zdrojového umístění.";
Strings.OfficeOM.L_DialogAlreadyOpened = "Operace se nepovedla, protože tento doplněk už má aktivní okno.";
Strings.OfficeOM.L_DialogInvalidScheme = "Schéma adresy URL není podporované. Použijte prosím HTTPS.";
...
Strings.OfficeOM.L_ImplicitGetAuthContextMissing = "Chybí funkce pro získání obsahu ověření";
Strings.OfficeOM.L_ImplicitNotLoaded = "Modul není načten před získáním tokenu ";
...
Strings.OfficeOM.L_InvalidApiArgumentsMessage = "Neplatné vstupní argumenty";
...
Strings.OfficeOM.L_InvalidArgumentGeneric = "Argument nebo argumenty předané funkci nejsou použitelné v této situaci, nejsou úplné nebo nemají správný formát.";
...
Strings.OfficeOM.L_InvalidGrant = "Chybí předběžná autorizace.";
Strings.OfficeOM.L_InvalidGrantMessage = "Chybí oprávnění pro tento doplněk.";
...
Strings.OfficeOM.L_InvalidOperationInCellEditMode = "Excel je v režimu úprav buňky. Ukončete prosím režim úprav stisknutím klávesy ENTER nebo TAB nebo výběrem jiné buňky a pak to zkuste znovu.";
Strings.OfficeOM.L_InvalidOrTimedOutSession = "Relace je neplatná nebo vypršel její časový limit";
Strings.OfficeOM.L_InvalidOrTimedOutSessionMessage = "Vaše relace Office je neplatná nebo vypršel její časový limit. Pokud chcete pokračovat, aktualizujte stránku.";
...
Strings.OfficeOM.L_InvalidResourceUrl = "Je zadaná neplatná adresa URL prostředku aplikace.";
Strings.OfficeOM.L_InvalidResourceUrlMessage = "V manifestu je zadaná neplatná adresa URL prostředku.";
Strings.OfficeOM.L_InvalidSSOAddinMessage = "Rozhraní API identit se pro tento doplněk nepodporuje.";
...
Strings.OfficeOM.L_NoHttpsWAC = "Tato relace Office nepoužívá zabezpečené připojení. Doporučujeme zařídit dodatečná opatření.";
...
Strings.OfficeOM.L_NotTrustedWAC = "Tento doplněk není kvůli zabezpečení povolený. Pokud chcete doplněk dále používat, potvrďte, že je tato položka hostovaná na věrohodné doméně nebo ji otevřete v desktopové aplikaci Office.";
...
Strings.OfficeOM.L_SSOClientError = "V požadavku na ověření z Office se vyskytla chyba.";
Strings.OfficeOM.L_SSOClientErrorMessage = "V klientovi došlo k neočekávané chybě.";
Strings.OfficeOM.L_SSOConnectionLostError = "Během procesu přihlášení se přerušilo připojení.";
Strings.OfficeOM.L_SSOConnectionLostErrorMessage = "Během procesu přihlášení se přerušilo připojení a uživatel možná není přihlášený. Způsobila to asi konfigurační nastavení v prohlížeči uživatele, například zóny zabezpečení.";
Strings.OfficeOM.L_SSOServerError = "Ve zprostředkovateli ověřování došlo k chybě.";
Strings.OfficeOM.L_SSOServerErrorMessage = "Na serveru došlo k neočekávané chybě.";
Strings.OfficeOM.L_SSOUnsupportedPlatform = "API není v této platformě podporováno.";
Strings.OfficeOM.L_SSOUserConsentNotSupportedByCurrentAddinCategory = "Tento doplněk nepodporuje vyjádření souhlasu uživatele.";
Strings.OfficeOM.L_SSOUserConsentNotSupportedByCurrentAddinCategoryMessage = "Operace selhala, protože tento doplněk v této kategorii nepodporuje vyjádření souhlasu uživatele.";
...
Strings.OfficeOM.L_Timeout = "Časový limit operace vypršel.";
...
Strings.OfficeOM.L_UnsupportedUserIdentity = "Typ identity uživatele se nepodporuje.";
Strings.OfficeOM.L_UnsupportedUserIdentityMessage = "Typ identity uživatele se nepodporuje.";
Strings.OfficeOM.L_UserAborted = "Uživatel přerušil žádost o souhlas.";
Strings.OfficeOM.L_UserAbortedMessage = "Uživatel nevyslovil souhlas s oprávněními pro doplněk.";
...
Strings.OfficeOM.L_WorkbookHiddenMessage = "Požadavek jazyka JavaScript API se nezdařil, protože sešit je skrytý. Zviditelněte jej a zkuste to znovu.";
Strings.OfficeOM.L_WriteNotSupportedWhenModalDialogOpen = "Operace Zapisovat není pro Office podporovaná, když je otevřený modální dialogové okno.";