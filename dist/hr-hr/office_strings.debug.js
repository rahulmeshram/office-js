...
Strings.OfficeOM.L_AddinIsAlreadyRequestingToken = "Dodatak već zahtijeva token za pristup.";
Strings.OfficeOM.L_AddinIsAlreadyRequestingTokenMessage = "Operacija nije uspjela jer dodatak već zahtijeva token za pristup.";
Strings.OfficeOM.L_ApiNotFoundDetails = "Metoda svojstva {0} dio je skupa preduvjeta {1} koji nije dostupan u vašoj verziji aplikacije {2}.";
Strings.OfficeOM.L_AppNameNotExist = "Naziv dodatka za {0} ne postoji.";
...
Strings.OfficeOM.L_AttemptingToSetReadOnlyProperty = "Pokušaj postavljanja svojstva namijenjenog samo čitanju '{0}'.";
...
Strings.OfficeOM.L_ConfirmCancelMessage = "Nažalost, nastavak nije moguć.";
Strings.OfficeOM.L_ConfirmDialog = "Smatrate li domenu {0} na kojoj se ova sesija sustava Office hostira pouzdanom?";
Strings.OfficeOM.L_ConfirmRefreshMessage = "Da biste nastavili, uklonite dodatak i ponovno ga dodajte ili osvježite stranicu.";
Strings.OfficeOM.L_ConnectionFailureWithDetails = "Zahtjev nije uspio uz šifru stanja {0}, šifru pogreške {1} i sljedeću poruku o pogrešci: {2}";
Strings.OfficeOM.L_ConnectionFailureWithStatus = "Zahtjev nije uspio uz šifru stanja {0}.";
Strings.OfficeOM.L_ContinueButton = "Nastavi";
Strings.OfficeOM.L_CustomFunctionDefinitionMissing = "U stavci Excel.Script.CustomFunctions mora postojati svojstvo tog naziva koje predstavlja definiciju funkcije.";
Strings.OfficeOM.L_CustomFunctionImplementationMissing = 'Svojstvo tog naziva koje predstavlja koje predstavlja definiciju funkcije u stavci Excel.Script.CustomFunctions mora sadržavati svojstvo "call" koje implementira tu funkciju.';
Strings.OfficeOM.L_CustomFunctionNameCannotSplit = "Naziv funkcije mora sadržavati polje naziva koje nije prazno i kratki naziv koji nije prazan.";
Strings.OfficeOM.L_CustomFunctionNameContainsBadChars = "Naziv funkcije smije sadržavati samo slova, znamenke, podcrte i točke.";
Strings.OfficeOM.L_CustomXmlError = "Pogreška prilagođenog XML-a.";
Strings.OfficeOM.L_CustomXmlExceedQuotaMessage = "XPath ograničava odabir na 1024 stavke.";
Strings.OfficeOM.L_CustomXmlExceedQuotaName = "Dosegnuto je ograničenje odabira";
...
Strings.OfficeOM.L_DialogRequireHTTPS = "HTTP protokol nije podržan. Umjesto njega upotrijebite HTTPS";
Strings.OfficeOM.L_DisplayDialogError = "Pogreška dijaloškog okvira prikaza";
...
Strings.OfficeOM.L_InvalidApiArgumentsMessage = "Ulazni argumenti nisu valjani.";
Strings.OfficeOM.L_InvalidApiCallInContext = "Poziv API-ja nije valjan u trenutnom kontekstu.";
Strings.OfficeOM.L_InvalidArgument = "Argument '{0}' ne funkcionira za ovu situaciju, nema ga ili nije u pravilnom obliku.";
Strings.OfficeOM.L_InvalidArgumentGeneric = "Argumenti umetnuti u funkciju ne funkcioniraju u toj situaciji, nedostaju ili nisu u odgovarajućem obliku.";
...
Strings.OfficeOM.L_InvalidResourceUrl = "Naveden je URL resursa aplikacija koji nije valjan.";
Strings.OfficeOM.L_InvalidResourceUrlMessage = "U manifestu je naveden URL resursa koji nije valjan.";
Strings.OfficeOM.L_InvalidSSOAddinMessage = "API identiteta nije podržan u ovom dodatku.";
...
Strings.OfficeOM.L_NewWindowCrossZone = "Sigurnosne postavke u pregledniku sprječavaju nas pri stvaranju dijaloškog okvira. Isprobajte neki drugi preglednik ili {0} da bi domena '{1}' i domena prikazana u adresnoj traci bile u istoj sigurnosnoj zoni.";
Strings.OfficeOM.L_NewWindowCrossZoneConfigureBrowserLink = "konfigurirajte preglednik";
Strings.OfficeOM.L_NewWindowCrossZoneErrorString = "Ograničenja preglednika spriječila su nas pri stvaranju dijaloškog okvira. Domena dijaloškog okvira i domena glavnog računala dodatka nisu u istoj sigurnosnoj zoni.";
Strings.OfficeOM.L_NoCapability = "Nemate dovoljno ovlasti za pokretanje tog postupka.";
Strings.OfficeOM.L_NoHttpsWAC = "Ova sesija sustava Office ne koristi sigurnu vezu. Preporučujemo da provedete dodatne mjere opreza.";
...
Strings.OfficeOM.L_NotTrustedWAC = "Dodatak je onemogućen radi vaše sigurnosti. Da biste nastavili koristiti dodatak, provjerite je li ova stavka smještena u pouzdanom domeni ili je otvorite u aplikaciji Office na radnoj površini.";
Strings.OfficeOM.L_OperationCancelledError = "Operacija je prekinuta";
...
Strings.OfficeOM.L_RunMustReturnPromise = 'Skupna funkcija proslijeđena metodi ".run" nije vratila obećanje. Funkcija mora vratiti obećanje da bi se automatski praćeni objekti mogli osloboditi nakon dovršetka skupne operacije­­­. Obećanje se najčešće vraća tako da se vrati odgovor funkcije "context.sync()".';
Strings.OfficeOM.L_SSOClientError = "U zahtjevu za provjeru autentičnosti iz sustava Office došlo je do pogreške.";
Strings.OfficeOM.L_SSOClientErrorMessage = "Došlo je do neočekivane pogreške u klijentu.";
Strings.OfficeOM.L_SSOConnectionLostError = "Tijekom postupka prijave prekinuta je veza.";
Strings.OfficeOM.L_SSOConnectionLostErrorMessage = "Tijekom postupka prijave prekinuta je veza i korisnik se nije prijavio. Uzrok su vjerojatno konfiguracijske postavke korisnikova preglednika, npr. sigurnosne zone.";
Strings.OfficeOM.L_SSOServerError = "U davatelju usluge provjere autentičnosti došlo je do pogreške.";
Strings.OfficeOM.L_SSOServerErrorMessage = "Došlo je do neočekivane pogreške na poslužitelju.";
Strings.OfficeOM.L_SSOUnsupportedPlatform = "API nije podržan na ovoj platformi.";
Strings.OfficeOM.L_SSOUserConsentNotSupportedByCurrentAddinCategory = "Dodatak ne podržava korisnički pristanak.";
Strings.OfficeOM.L_SSOUserConsentNotSupportedByCurrentAddinCategoryMessage = "Operacija nije uspjela jer dodatak ne podržava korisnički pristanak u toj kategoriji";
...
Strings.OfficeOM.L_ShowWindowDialogNotification = "{0} želi prikazati novi prozor.";
Strings.OfficeOM.L_ShowWindowDialogNotificationAllow = "Dopusti";
...
Strings.OfficeOM.L_Timeout = "Isteklo je vremensko ograničenje za operaciju.";
...
Strings.OfficeOM.L_UnsupportedUserIdentity = "Vrsta korisničkog identiteta nije podržana.";
Strings.OfficeOM.L_UnsupportedUserIdentityMessage = "Vrsta identiteta korisnika nije podržana.";
Strings.OfficeOM.L_UserAborted = "Korisnik je povukao zahtjev za davanje pristanka.";
Strings.OfficeOM.L_UserAbortedMessage = "Korisnik nije dao dozvolu za dodatak.";
...
Strings.OfficeOM.L_WriteNotSupportedWhenModalDialogOpen = "Operacija pisanja nije podržana za Office kada je otvoren neki drugi dijaloški okvir.";