...
_u.ExtensibilityStrings.l_CannotPersistPropertyInUnsavedDraftError_Text = "Не можна зберігати сповіщення серед незбережених нотаток. Збережіть цей елемент, перш ніж викликати цей інтерфейс API.";
...
_u.ExtensibilityStrings.l_InvalidCommandIdError_Text = 'Значення параметра "commandId" неприпустиме.';
