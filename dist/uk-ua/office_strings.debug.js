...
Strings.OfficeOM.L_ConfirmDialog = "Ви довіряєте {0} домену, де розміщено цей сеанс Office?";
...
Strings.OfficeOM.L_InvalidOperationInCellEditMode = "В Excel зараз відкрито режим редагування клітинок. Закрийте цей режим, натиснувши клавішу Enter або Tab чи вибравши іншу клітинку, а потім спробуйте ще раз.";
Strings.OfficeOM.L_InvalidOrTimedOutSession = "Сеанс неприпустимий, або час його очікування завершився";
Strings.OfficeOM.L_InvalidOrTimedOutSessionMessage = "Термін дії вашого сеансу Office минув, або він неприпустимий. Щоб продовжити, оновіть сторінку.";
...
Strings.OfficeOM.L_InvalidRequestContext = "Не можна використовувати цей об’єкт у різних контекстах запитів.";
Strings.OfficeOM.L_InvalidResourceUrl = "Указано неприпустиму URL-адресу ресурсу програми.";
Strings.OfficeOM.L_InvalidResourceUrlMessage = "У маніфесті вказано неприпустиму URL-адресу ресурсу.";
Strings.OfficeOM.L_InvalidSSOAddinMessage = "Інтерфейс API ідентичності не підтримується для цієї надбудови.";
...
Strings.OfficeOM.L_NewWindowCrossZone = 'Не вдалося створити діалогове вікно через параметри безпеки вашого браузера. Скористайтесь іншим браузером, або {0} так, щоб домен "{1}" і домен, який відображається в адресному рядку, перебували в одній зоні безпеки.';
Strings.OfficeOM.L_NewWindowCrossZoneConfigureBrowserLink = "налаштуйте свій браузер";
Strings.OfficeOM.L_NewWindowCrossZoneErrorString = "Не вдалося створити діалогове вікно через обмеження браузера. Домен діалогового вікна та домен хоста надбудови перебувають у різних зонах безпеки.";
Strings.OfficeOM.L_NoCapability = "У вас недостатньо дозволів для виконання цієї дії.";
Strings.OfficeOM.L_NoHttpsWAC = "У цьому сеансі Office не використовується захищене підключення. Радимо вжити додаткові засоби безпеки.";
...
Strings.OfficeOM.L_NotTrustedWAC = "Цю надбудову вимкнуто з міркувань безпеки. Щоб продовжити використовувати надбудову, переконайтеся, що цей елемент розміщено в надійному домені або відкрийте його в класичній програмі Office.";
...
Strings.OfficeOM.L_PropertyDoesNotExist = 'Властивості "{0}" немає в об’єкті.';
Strings.OfficeOM.L_PropertyNotLoaded = 'Властивість "{0}" недоступна. Перш ніж прочитати значення властивості, викличте метод завантаження (load) для об’єкта, що її містить, і викличте функцію "context.sync()" для контексту пов’язаного запиту.';
...
Strings.OfficeOM.L_SSOClientError = "Сталася помилка під час виконання запиту автентифікації з Office.";
Strings.OfficeOM.L_SSOClientErrorMessage = "Сталася неочікувана помилка в клієнті.";
Strings.OfficeOM.L_SSOConnectionLostError = "Під час входу в систему втрачено підключення.";
Strings.OfficeOM.L_SSOConnectionLostErrorMessage = "Під час входу в систему втрачено підключення. Можливо, вхід для користувача не виконано. Причина може бути в параметрах браузера користувача, наприклад у зонах безпеки.";
Strings.OfficeOM.L_SSOServerError = "Сталася помилка постачальника автентифікації.";
Strings.OfficeOM.L_SSOServerErrorMessage = "Сталася неочікувана помилка на сервері.";
Strings.OfficeOM.L_SSOUnsupportedPlatform = "API не підтримується в цій платформі.";
...
Strings.OfficeOM.L_ShowWindowDialogNotification = "Надбудові {0} потрібно відкрити нове вікно.";
Strings.OfficeOM.L_ShowWindowDialogNotificationAllow = "Дозволити";
Strings.OfficeOM.L_ShowWindowDialogNotificationIgnore = "Пропустити";
...
Strings.OfficeOM.L_Timeout = "Час очікування операції завершився.";
...
Strings.OfficeOM.L_UnsupportedEnumerationMessage = "Перелічення не підтримується в поточній хост-програмі.";
Strings.OfficeOM.L_UnsupportedUserIdentity = "Тип ідентичності користувача не підтримується.";
Strings.OfficeOM.L_UnsupportedUserIdentityMessage = "Тип ідентичності користувача не підтримується.";
Strings.OfficeOM.L_UserAborted = "Користувач перервав запит на згоду.";
Strings.OfficeOM.L_UserAbortedMessage = "Користувач не погодився з дозволами надбудови.";
Strings.OfficeOM.L_UserClickIgnore = "Користувач вирішив пропустити діалогове вікно.";
Strings.OfficeOM.L_UserNotSignedIn = "Ніхто з користувачів не ввійшов у службу Office.";
Strings.OfficeOM.L_ValueNotLoaded = 'Значення результуючого об’єкта ще на завантажено. Перш ніж прочитати властивість значення, викличте функцію "context.sync()" для контексту пов’язаного вмісту.';
Strings.OfficeOM.L_WorkbookHiddenMessage = "Не вдалося виконати запит інтерфейсу API JavaScript, тому що книгу приховано. Зробіть книгу видимою та спробуйте ще раз.";
Strings.OfficeOM.L_WriteNotSupportedWhenModalDialogOpen = "Коли діалогове вікно відкрите, функція записування для Office не підтримується.";