...
// runtime: 16.0.12103.30000
// core: 16.0\12105.10000
// host: 16.0\12105.10000
...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.12105.10000";
...
!function(e) {
    ...
    (function(e) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            isSetSupported: function(t, r) {
                ...
                if (void 0 == r && (r = "0.0.0"), void 0 === e.__apiSets) return !1;
                ...
                if (i > -1) {
                    ...
                    try {
                        var a, c = n(r);
                        if ((a = Array.isArray(u) ? function(e, t) {
    ...
    var r = "_Office_AsyncStorage_", o = r + "|_unusedKey_";
    function i() {
        window.localStorage.setItem(o, null), window.localStorage.removeItem(o);
    }
    function u(e, t) {
    ...
    function a(e, t, n) {
        return void 0 === n && (n = function() {}), new Promise(function(r, o) {
            var u = [];
            try {
                i();
            } catch (e) {
    ...
    t.Dialog = o, t.displayWebDialog = function(e, t) {
        return new r.CoreUtility.Promise(function(n, i) {
            ...
            Office.context.ui.displayDialogAsync(e, c, function(e) {
                "failed" === e.status ? i(new r.Error(l(e.error.code))) : ((u = e.value).addEventHandler(Office.EventType.DialogMessageReceived, a), 
                u.addEventHandler(Office.EventType.DialogEventReceived, s), n(new o(u)));
            });
        });
    };
}, function(e, t, n) {
    ...
    i.BatchApiHelper.invokeMethod), a = (i.BatchApiHelper.invokeEnsureUnchanged, i.BatchApiHelper.invokeSetProperty, 
    i.Utility.isNullOrUndefined), s = (i.Utility.isUndefined, i.Utility.throwIfNotLoaded, 
    ...
    function p(e, t) {
        return new i.CoreUtility.Promise(function(n, r) {
            var o = m.getInstance(), i = o.setCallBack(function(e, o) {
                if (o) r(o); else {
                    var i = t(e);
                    n(i);
                }
    ...
    function d(e, t, n) {
        return new i.CoreUtility.Promise(function(r, o) {
            var i = m.getInstance(), u = i.setCallBack(function(e, i) {
    ...
    var m = function() {
        function e() {
            ...
            this._perkvstorService = g.newObject(this.ctx), this._eventResult = this._perkvstorService.onPersistentStorageMessage.add(function(t) {
        ...
        return e.getInstance = function() {
            return void 0 === e.instance ? e.instance = new e() : e.instance._perkvstorService = g.newObject(e.instance.ctx), 
            e.instance;
        ...
        return o(t, e), Object.defineProperty(t.prototype, "_className", {
            ...
            e.prototype._handleResult.call(this, t), a(t) || f(this, t);
            ...
            get: function() {
                return this.m_persistentStorageMessage || (this.m_persistentStorageMessage = new i.GenericEventHandlers(this.context, this, "PersistentStorageMessage", {
                    ...
                    eventArgsTransformFunc: function(e) {
                        var t, n, r, o;
                        try {
                            var u = JSON.parse(e.message), c = parseInt(u.errorCode), a = 0 != c ? new i.Error((n = c, 
                            (r = {})[16389] = {
    ...
    t.PersistentKvStorageService = g, (t.ErrorCodes || (t.ErrorCodes = {})).generalException = "GeneralException";
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    });
    var r = "_OfficeRuntime_Storage_", o = r + "|_unusedKey_";
    function i() {
        window.localStorage.setItem(o, null), window.localStorage.removeItem(o);
    }
    function u(e) {
    ...
    function a(e, t) {
        return new Promise(function(n, r) {
            ...
            o.length > 0 ? r(new Error("Unknown error.")) : n();
        });
    }
    t.storage = {
        getItem: function(e) {
        ...
        getItems: function(e) {
            return new Promise(function(t, n) {
                ...
                }), u.length > 0 ? n(new Error("Unknown error.")) : t(o);
            });
        },
        setItems: function(e) {
