...
Strings.OfficeOM.L_ConfirmDialog = "Megbízik a {0} tartományban, ahol ez az Office-munkamenet végbemegy?";
...
Strings.OfficeOM.L_NotTrustedWAC = "Ez a bővítmény le van tiltva a biztonsága érdekében. A bővítmény további használatához ellenőrizze, hogy az elem megbízható tartományban található-e, vagy nyissa meg az Office asztali alkalmazásban.";
...
Strings.OfficeOM.L_SSOClientError = "Hibás az Office-tól érkezett hitelesítési kérelem.";
Strings.OfficeOM.L_SSOClientErrorMessage = "Hiba történt az ügyfélgépen.";
Strings.OfficeOM.L_SSOConnectionLostError = "Megszakadt a kapcsolat a bejelentkezés közben.";
...
Strings.OfficeOM.L_Timeout = "Időtúllépést okozott a művelet.";
...
Strings.OfficeOM.L_UnsupportedUserIdentity = "Nem támogatott a felhasználó identitástípusa.";
Strings.OfficeOM.L_UnsupportedUserIdentityMessage = "Nem támogatott típusú a felhasználó identitása.";
Strings.OfficeOM.L_UserAborted = "A felhasználó megszakította a jóváhagyáskérést.";
Strings.OfficeOM.L_UserAbortedMessage = "A felhasználó nem járult hozzá, hogy engedélyeket rendeljünk a bővítményhez.";
...
Strings.OfficeOM.L_WriteNotSupportedWhenModalDialogOpen = "Az írási művelet nem támogatott az Office-ban, ha meg van nyitva egy modális párbeszédpanel.";