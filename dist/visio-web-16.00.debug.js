...
// runtime: 16.0.12706.30002
// core: 16.0\12709.10000
// host: 16.0\16.0.12710.34950
...
var OSFVisioWAC;
(function (OSFVisioWAC) {
	var VisioDocument=(function () {
		function VisioDocument(officeAppContext, settings) {
	...
	OSFVisioWAC.VisioDocument=VisioDocument;
})(OSFVisioWAC || (OSFVisioWAC={}));
OSF.DDA.VisioDocument=OSFVisioWAC.VisioDocument;
...
OSF.InitializationHelper.prototype.loadAppSpecificScriptAndCreateOM=function OSF_InitializationHelper$loadAppSpecificScriptAndCreateOM(appContext, appReady, basePath) {
	...
	appContext.doc=new OSF.DDA.VisioDocument(appContext, this._initializeSettings(appContext, true));
