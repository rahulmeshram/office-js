...
(function (OSF) {
    ...
    if (!isNodeJs() && !isOfficeReactNative()) {
...
(function (OfficeRuntime) {
    ...
    (function (ApiHelper) {
        ...
        (function (Platform) {
            ...
            Platform["web"] = "web";
            Platform["mac"] = "mac";
            Platform["mac_sdx"] = "macsdx";
        })(Platform = ApiHelper.Platform || (ApiHelper.Platform = {}));
            ...
            try {
                if (typeof (OSF) !== "undefined" &&
                    ...
                    if (hostPlatform === 'win32') {
                        ...
                        if (window._useSDXSandbox) {
                            platform = Platform.mac_sdx;
                        }
                        else {
        ...
        ApiHelper.getPlatform = getPlatform;
        ...
        ApiHelper.isSharedRuntime = isSharedRuntime;
    })(ApiHelper = OfficeRuntime.ApiHelper || (OfficeRuntime.ApiHelper = {}));
})(OfficeRuntime || (OfficeRuntime = {}));
var OfficeRuntime;
(function (OfficeRuntime) {
    var platform = OfficeRuntime.ApiHelper.getPlatform();
    if (platform === OfficeRuntime.ApiHelper.Platform.win32 || platform === OfficeRuntime.ApiHelper.Platform.mac_sdx) {
...
(function (OfficeRuntime) {
    ...
    function displayWebDialog(url, options) {
        ...
        return new OfficeExtension.CoreUtility.Promise(function (resolve, reject) {
            ...
            if (OfficeRuntime.ApiHelper.getPlatform() === OfficeRuntime.ApiHelper.Platform.win32) {
...
(function (OfficeRuntime) {
    ...
    var platform = OfficeRuntime.ApiHelper.getPlatform();
    if (!OfficeRuntime.ApiHelper.isSharedRuntime() && (platform === OfficeRuntime.ApiHelper.Platform.win32 || platform === OfficeRuntime.ApiHelper.Platform.mac_sdx)) {
...
(function (OfficeCore) {
    ...
    var _libraryMetadataOfficeSharedApi = { "version": "1.0.0",
        ...
        "clientObjectTypes": [[1, 4, 0, [["roamingSettings", 3, 2, 0, 0, 4]], [["getAccessToken", 2, 2, 0, 5], ["getPrimaryIdentityInfo", 0, 2, 1, 5], ["getIdentities", 0, 2, 2, 5]], 0, 0, 0, [["TokenReceived", 2, 1, "3001", "this._targetId", 35, 35]], "Microsoft.Authentication.AuthenticationService", 4],
            ...
            [34, 0, [[36, 3]], 0, [[73, 0, 2, 0, 4], [74, 0, 2, 0, 4]], 0, 0, 0, [["StateChanged", 2, 0, "LicenseEventType.featureStateChanged", "this.id", 73, 74]]]] };
