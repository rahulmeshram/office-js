...
_u.ExtensibilityStrings.l_AttachmentItemIdTooLong_Text = "Mindestens eine der Anlagen-IDs ist zu lang.";
_u.ExtensibilityStrings.l_AttachmentNameTooLong_Text = "Mindestens einer der Anlagennamen ist zu lang.";
_u.ExtensibilityStrings.l_AttachmentNotSupported_Text = "Der Anlagentyp wird nicht unterstützt.";
_u.ExtensibilityStrings.l_AttachmentUploadGeneralFailure_Text = "Die Anlage kann dem Element nicht hinzugefügt werden.";
_u.ExtensibilityStrings.l_AttachmentUrlTooLong_Text = "Mindestens eine der Anlagen-URLs ist zu lang.";
_u.ExtensibilityStrings.l_CallSaveAsyncBeforeToken_Text = "Das Token kann erst abgerufen werden, nachdem das Element gespeichert wurde.";
...
_u.ExtensibilityStrings.l_CannotPersistPropertyInUnsavedDraftError_Text = "Benachrichtigungen können in ungespeicherten Entwürfen nicht beibehalten werden. Speichern Sie das Element, bevor Sie diese API aufrufen.";
...
_u.ExtensibilityStrings.l_Internal_Server_Error_Text = "Der Exchange-Server hat einen Fehler zurückgegeben. Weitere Informationen finden Sie im Diagnoseobjekt.";
_u.ExtensibilityStrings.l_Internet_Not_Connected_Error_Text = "Der Benutzer ist nicht mehr mit dem Netzwerk verbunden. Überprüfen Sie Ihre Netzwerkverbindung, und versuchen Sie es noch mal.";
...
_u.ExtensibilityStrings.l_InvalidCommandIdError_Text = 'Der Wert des Parameters "commandId" ist ungültig.';
...
_u.ExtensibilityStrings.l_NumberOfNotificationsExceeded_Text = "Die Benachrichtigung konnte nicht hinzugefügt werden, da die Benachrichtigungsgrenze erreicht wurde.";
...
_u.ExtensibilityStrings.l_Olk_Http_Error_Text = "Fehler bei der Anforderung. Sehen Sie sich das Diagnoseobjekt für den HTTP-Fehlercode an.";
_u.ExtensibilityStrings.l_ParameterValueTooLongError_Text = 'Der Wert des Parameters "{0}" ist zu lang. Die maximal zulässige Anzahl von Zeichen ist {1}.';
_u.ExtensibilityStrings.l_ParametersNotAsExpected_Text = "Der angegebene Parameter weist nicht das erwartete Format auf.";
_u.ExtensibilityStrings.l_PersistedNotificationArrayReadError_Text = "Fehler Ihres API-Aufrufs, weil die beibehaltenen Benachrichtigungen nicht abgerufen werden konnten.";
