                ...
                if ((event.source == hostUserTrustIframe.contentWindow) &&
                    ...
                    try {
                        ...
                        if (receivedObj.hostUserTrusted === true) {
                            me._webAppState.clientEndPoint._hostTrustCheckStatus = Microsoft.Office.Common.HostTrustStatus.trusted;
                            OSF.OUtil.removeEventListener("message", hostUserTrustCallback);
...
OSF.InitializationHelper.prototype.setAgaveHostCommunication = function OSF_InitializationHelper$setAgaveHostCommunication() {
    try {
        ...
        me._webAppState.clientEndPoint._checkReceiverOriginAndRun = function (funcToRun) {
            if (OfficeExt.WACUtils.isTeamsWebView()) {
                funcToRun();
            }
            else {
                if (document.body) {
...
!function(e) {
    ...
    var o = n(2), i = n(3), u = n(4), c = n(5), s = n(6), a = n(7), f = n(10), l = n(11);
    window._OfficeRuntimeWeb = r({}, window.OfficeRuntime, {
        displayWebDialog: u.displayWebDialog,
        AsyncStorage: i,
        storage: c.storage,
        experimentation: s.experimentation,
        apiInformation: o.apiInformation,
        message: a.Message.instance,
        ui: l.ui,
        auth: f.Auth.instance
    ...
    var r = function() {
        ...
        return e.prototype.getBooleanFeatureGate = function(e, t) {
            try {
                ...
                return null == n ? t : "true" === n.toString().toLowerCase();
            } catch (e) {
                return t;
            }
            ...
            return Promise.resolve(this.getBooleanFeatureGate(e, t));
        }, e.prototype.getIntFeatureGateAsync = function(e, t) {
            return Promise.resolve(this.getIntFeatureGate(e, t));
        }, e.prototype.getStringFeatureGateAsync = function(e, t) {
            return Promise.resolve(this.getStringFeatureGate(e, t));
        }, e;
    }();
    t.experimentation = new r;
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
