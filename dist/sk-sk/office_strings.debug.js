...
Strings.OfficeOM.L_AddinIsAlreadyRequestingToken = "Doplnok si už vyžaduje prístupový token.";
Strings.OfficeOM.L_AddinIsAlreadyRequestingTokenMessage = "Operácia zlyhala, pretože tento doplnok si už vyžaduje prístupový token.";
Strings.OfficeOM.L_ApiNotFoundDetails = "Metóda alebo vlastnosť {0} je súčasťou množiny požiadaviek rozhrania {1}, ktoré nie je k dispozícii vo vašej verzii aplikácie {2}.";
...
Strings.OfficeOM.L_ConfirmDialog = "Dôverujete doméne {0}, kde je táto relácia balíka Office hosťovaná?";
Strings.OfficeOM.L_ConfirmRefreshMessage = "Ak chcete pokračovať, odstráňte doplnok a pridajte ho znova alebo obnovte stránku.";
...
Strings.OfficeOM.L_CustomXmlExceedQuotaMessage = "XPath obmedzuje výber 1024 položiek.";
...
Strings.OfficeOM.L_CustomXmlOutOfDateMessage = "Údaje sú neaktuálne. Načítať objekt znova.";
Strings.OfficeOM.L_CustomXmlOutOfDateName = "Neaktuálne údaje";
...
Strings.OfficeOM.L_InvalidArgument = "Argument {0} pre túto situáciu nefunguje, chýba alebo nemá správny formát.";
...
Strings.OfficeOM.L_NoHttpsWAC = "Táto relácia balíka Office nepoužíva zabezpečené pripojenie. Odporúčame vám vykonať ďalšie preventívne opatrenia.";
...
Strings.OfficeOM.L_PropertyNotLoaded = "Vlastnosť {0} nie je dostupná. Pred čítaním hodnoty vlastnosti zavolajte metódu načítania na objekt, ktorý je súčasťou, a zavolajte funkciu context.sync() v kontexte priradenej žiadosti.";
...
Strings.OfficeOM.L_SSOClientError = "V žiadosti o overenie z balíka Office sa vyskytla chyba.";
Strings.OfficeOM.L_SSOClientErrorMessage = "V klientovi sa vyskytla neočakávaná chyba.";
Strings.OfficeOM.L_SSOConnectionLostError = "Počas procesu prihlásenia sa prerušilo spojenie.";
...
Strings.OfficeOM.L_Timeout = "Časový limit operácie uplynul.";
...
Strings.OfficeOM.L_UnsupportedUserIdentity = "Typ identity používateľa nie je podporovaný.";
Strings.OfficeOM.L_UnsupportedUserIdentityMessage = "Typ identity používateľa nie je podporovaný.";
