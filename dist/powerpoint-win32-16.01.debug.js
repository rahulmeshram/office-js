...
!function(e) {
    ...
    var i = r(2), o = r(4), a = r(5), c = r(6);
    window._OfficeRuntimeNative = n({}, window.OfficeRuntime, {
    ...
    (function(e) {
        function r(e) {
            var r, t = e.split("."), n = 0, i = 0;
            if (t.length < 2 && isNaN(Number(e))) throw "version format incorrect";
            if (r = Number(t[0]), t.length >= 2 && (n = Number(t[1])), t.length >= 3 && (i = Number(t[2])), 
            isNaN(r) || isNaN(n) || isNaN(i)) throw "version format incorrect";
            return {
                major: r,
                minor: n,
                patch: i
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            isSetSupported: function(t, n) {
                if ("string" != typeof t) return !1;
                if (void 0 == n && (n = "0.0.0"), void 0 === e.__apiSets) return !1;
                var i = e.__apiSets, o = Object.keys(i).map(function(e) {
                    return e.toLowerCase();
                }).indexOf(t.toLowerCase());
                if (o > -1) {
                    var a = i[Object.keys(i)[o]];
                    try {
                        var s, c = r(n);
                        if ((s = Array.isArray(a) ? function(e, t) {
    ...
    var o = r(0), a = (o.BatchApiHelper.createPropertyObject, o.BatchApiHelper.createMethodObject, 
    ...
    o.BatchApiHelper.invokeMethod), s = (o.BatchApiHelper.invokeEnsureUnchanged, o.BatchApiHelper.invokeSetProperty, 
    o.Utility.isNullOrUndefined), u = (o.Utility.isUndefined, o.Utility.throwIfNotLoaded, 
    ...
    t.Dialog = p, t.displayWebDialog = function(e, t) {
        return void 0 === t && (t = {}), new o.CoreUtility.Promise(function(n, i) {
            if (t.width && t.height && (!r(t.width) || !r(t.height))) throw new o.Error({
                code: "InvalidArgument",
                message: 'Dimensions must be "number%" or number.'
            });
            var a = new o.ClientRequestContext(), c = d.newObject(a), s = new p(c), u = c.onDialogMessage.add(function(e) {
                switch (o.Utility.log("dialogMessageHandler:" + JSON.stringify(e)), e.type) {
                  case 17:
                    e.error ? i(e.error) : n(s);
                    break;

                  case 12:
                    t.onMessage && t.onMessage(e.message, s);
                    break;

                  case 10:
                  default:
                    12006 === e.originalErrorCode ? (u && (u.remove(), a.sync()), t.onClose && t.onClose()) : t.onRuntimeError && (t.onRuntimeError(e.error, s), 
                    i(e.error));
                }
                return o.CoreUtility.Promise.resolve();
            });
            return a.sync().then(function() {
                var r = {
                    width: t.width ? parseInt(t.width) : 50,
                    height: t.height ? parseInt(t.height) : 50,
                    displayInIFrame: t.displayInIFrame
                };
                return c.displayDialog(e, r), a.sync();
            }).catch(function(e) {
                i(e);
            });
        });
    ...
    var g, d = function(e) {
        ...
        return i(t, e), Object.defineProperty(t.prototype, "_className", {
            ...
            e.prototype._handleResult.call(this, t), s(t) || l(this, t);
        }, t.prototype._handleRetrieveResult = function(t, r) {
            e.prototype._handleRetrieveResult.call(this, t, r), f(this, t, r);
        }, t.newObject = function(e) {
            return a(t, e, "Microsoft.Dialog.DialogService", !1, 4);
            ...
            get: function() {
                return this.m_dialogMessage || (this.m_dialogMessage = new o.GenericEventHandlers(this.context, this, "DialogMessage", {
                    ...
                    eventArgsTransformFunc: function(e) {
                        var t, r, n, i;
                        try {
                            var a = JSON.parse(e.message), c = a.errorCode ? new o.Error((r = a.errorCode, (n = {})[12002] = {
                                code: "InvalidUrl",
                                ...
                                code: "Unknown",
                                message: "An unknown error has occured with code: " + r
                            })) : null;
                            t = {
                                originalErrorCode: a.errorCode,
                                type: a.type,
                                error: c,
                                message: a.message
                            };
    ...
    }(g || (g = {})), (t.DialogErrorCodes || (t.DialogErrorCodes = {})).generalException = "GeneralException";
}, function(e, t, r) {
    "use strict";
    var n, i = this && this.__extends || (n = function(e, t) {
        return (n = Object.setPrototypeOf || {
    ...
    function p(e, t) {
        return new o.CoreUtility.Promise(function(r, n) {
    ...
    function g(e, t, r) {
        return new o.CoreUtility.Promise(function(n, i) {
            var o = d.getInstance(), a = o.setCallBack(function(e, o) {
                if (o) return r && r(o), void i(o);
                var a = t(e);
                r && r(null, a), n(a);
            });
            o.ctx.sync().then(function() {
                var t = o.getPersistentKvStorageService();
                return e(t, a), o.ctx.sync();
            }).catch(function(e) {
                i(e);
            });
        });
    ...
    o.Utility.setMockData, t.AsyncStorage = {
        getItem: function(e, t) {
            return g(function(t, r) {
                return t.multiGet(r, JSON.stringify([ e ]));
            }, function(e) {
                var t = JSON.parse(e);
        ...
        setItem: function(e, t, r) {
            return g(function(r, n) {
                return r.multiSet(n, JSON.stringify([ [ e, t ] ]));
            }, function() {
                return null;
            }, r);
        },
        removeItem: function(e, t) {
            return g(function(t, r) {
                return t.multiRemove(r, JSON.stringify([ e ]));
            }, function() {
                return null;
            }, t);
        },
        ...
        multiSet: function(e, t) {
            return g(function(t, r) {
                return t.multiSet(r, JSON.stringify(e));
            }, function() {
                return null;
            }, t);
        },
        ...
        setItems: function(e) {
            ...
            return p(function(e, r) {
                return e.multiSet(r, JSON.stringify(t));
            }, function() {
                return null;
            });
        },
    ...
    var d = function() {
        function e() {
            ...
            this._perkvstorService = y.newObject(this.ctx), this._eventResult = this._perkvstorService.onPersistentStorageMessage.add(function(t) {
                o.Utility.log("persistentKvStoragegMessageHandler:" + JSON.stringify(t));
                var r = e._callDict[t.invokeId];
                r && (r(t.message, t.error), delete e._callDict[t.invokeId]);
            });
        }
        return e.getInstance = function() {
            return void 0 === e.instance ? e.instance = new e() : e.instance._perkvstorService = y.newObject(e.instance.ctx), 
            e.instance;
        ...
        return i(t, e), Object.defineProperty(t.prototype, "_className", {
            ...
            return a(t, e, "Microsoft.PersistentKvStorage.PersistentKvStorageService", !1, 4);
            ...
            get: function() {
                return this.m_persistentStorageMessage || (this.m_persistentStorageMessage = new o.GenericEventHandlers(this.context, this, "PersistentStorageMessage", {
                    ...
                    eventArgsTransformFunc: function(e) {
                        var t, r, n, i;
                        try {
                            var a = JSON.parse(e.message), c = parseInt(a.errorCode), s = 0 != c ? new o.Error((r = c, 
                            (n = {})[16389] = {
                                code: "GenericException",
                                message: "Unknown error."
                            }, n[65535] = {
    ...
    t.PersistentKvStorageService = y, (t.ErrorCodes || (t.ErrorCodes = {})).generalException = "GeneralException";
}, function(e, t, r) {
    "use strict";
    ...
    var o = function() {
        ...
        return e.prototype.getBooleanFeatureGate = function(e, t) {
            try {
                var r = Microsoft.Office.WebExtension.FeatureGates[e];
                return "true" === r.toString().toLowerCase() || !0 === r;
            } catch (e) {
                return t;
            }
        }, e.prototype.getIntFeatureGate = function(e, t) {
            try {
                var r = parseInt(Microsoft.Office.WebExtension.FeatureGates[e]);
                return isNaN(r) ? t : r;
            } catch (e) {
                return t;
            }
            ...
            return n(this, void 0, void 0, function() {
                ...
                return i(this, function(i) {
                    switch (i.label) {
                      case 0:
                        return i.trys.push([ 0, 2, , 3 ]), r = this.getRequestContext(), n = r.flighting.getFeature(e, "Boolean", t), 
                        r.load(n), [ 4, r.sync() ];

                      case 1:
                        return i.sent(), [ 2, n.value ];
            ...
            return n(this, void 0, void 0, function() {
                ...
                return i(this, function(i) {
                    switch (i.label) {
                      case 0:
                        return i.trys.push([ 0, 2, , 3 ]), r = this.getRequestContext(), n = r.flighting.getFeature(e, "String", t), 
                        r.load(n), [ 4, r.sync() ];
            ...
            return n(this, void 0, void 0, function() {
                ...
                return i(this, function(i) {
                    switch (i.label) {
                      case 0:
                        return i.trys.push([ 0, 2, , 3 ]), r = this.getRequestContext(), n = r.flighting.getFeature(e, "Integer", t), 
                        r.load(n), [ 4, r.sync() ];
