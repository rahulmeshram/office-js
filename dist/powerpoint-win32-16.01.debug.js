...
// Sources:
// osfweb: 16.0\12920.10000
// runtime: 16.0\12920.10000
// core: 16.0\12920.10000
// host: 16.0\12920.10000
...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.12920.10000";
...
OSF.InitializationHelper.prototype.prepareApiSurface=function OSF_InitializationHelper$PowerPointWin32_prepareApiSurface(appContext) {
	var license=new OSF.DDA.License(appContext.get_eToken());
	if (appContext.get_isDialog()) {
		appContext.ui=new OSF.DDA.UI.ChildUI();
	}
			...
			get: function () {
				...
				if (!this.m_visibilityChanged) {
					this.m_visibilityChanged=new OfficeExtension.GenericEventHandlers(this.context, this, "VisibilityChanged", {
						...
						getTargetIdFunc: function () { return ""; },
						eventArgsTransformFunc: function (value) {
							var event=_CC.AppRuntimeService_VisibilityChanged_EventArgsTransform(_this, value);
							return OfficeExtension.Utility._createPromiseFromResult(event);
						}
					});
				}
...
!function (e) {
	...
	n.m=e, n.c=t, n.d=function (e, t, r) {
		...
		e.exports=OfficeExtensionBatch;
	}, function (e, t, n) {
		"use strict";
		...
		var i=n(2), o=n(4), s=n(5), c=n(6), u=n(7), a=n(10), l=n(11);
		window._OfficeRuntimeNative=r({}, window.OfficeRuntime, {
			displayWebDialog: o.displayWebDialog,
			AsyncStorage: s.AsyncStorage,
			storage: s.storage,
			experimentation: c.experimentation,
			apiInformation: i.apiInformation,
			message: u.Message.instance,
			ui: a.ui,
			auth: l.Auth.instance
		}), Object.freeze(window._OfficeRuntimeNative);
	}, function (e, t, n) {
		"use strict";
		(function (e) {
			function n(e) {
				var n, t=e.split("."), r=0, i=0;
				if (t.length < 2 && isNaN(Number(e)))
					throw "version format incorrect";
				if (n=Number(t[0]), t.length >=2 && (r=Number(t[1])), t.length >=3 && (i=Number(t[2])),
					isNaN(n) || isNaN(r) || isNaN(i))
					throw "version format incorrect";
				return {
					major: n,
					minor: r,
			...
			Object.defineProperty(t, "__esModule", {
				...
				isSetSupported: function (t, r) {
					if ("string" !=typeof t)
						return !1;
					if (null==r && (r="0.0.0"), void 0===e.__apiSets)
						return !1;
					var i=e.__apiSets, o=Object.keys(i).map((function (e) {
						return e.toLowerCase();
					})).indexOf(t.toLowerCase());
					if (o > -1) {
						var s=i[Object.keys(i)[o]];
						try {
							var u, c=n(r);
							if ((u=Array.isArray(s) ? function (e, t) {
							...
							}(s, c.major) : n(s)).major > 0) {
								if (u.major > c.major)
									return !0;
								if (u.major==c.major && u.minor > c.minor)
									return !0;
								if (u.major==c.major && u.minor==c.minor && u.patch >=c.patch)
									return !0;
							}
						}
						catch (e) {
		...
		var o=n(0), s=(o.BatchApiHelper.createPropertyObject, o.BatchApiHelper.createMethodObject,
			o.BatchApiHelper.createIndexerObject, o.BatchApiHelper.createRootServiceObject,
			o.BatchApiHelper.createTopLevelServiceObject), c=(o.BatchApiHelper.createChildItemObject,
			o.BatchApiHelper.invokeMethod), u=(o.BatchApiHelper.invokeEnsureUnchanged, o.BatchApiHelper.invokeSetProperty,
			o.Utility.isNullOrUndefined), a=(o.Utility.isUndefined, o.Utility.throwIfNotLoaded,
			o.Utility.throwIfApiNotSupported, o.Utility.load, o.Utility.retrieve, o.Utility.toJson), l=o.Utility.fixObjectPathIfNecessary, f=(o.Utility._handleNavigationPropertyResults,
			o.Utility.adjustToDateTime, o.Utility.processRetrieveResult), p=(o.Utility.setMockData,
			function () {
				function e(e) {
		...
		t.Dialog=p, t.displayWebDialog=function (e, t) {
			return void 0===t && (t={}), new o.CoreUtility.Promise((function (r, i) {
				if (t.width && t.height && (!n(t.width) || !n(t.height)))
					throw new o.Error({
						code: "InvalidArgument",
						message: 'Dimensions must be "number%" or number.'
					});
				var s=new o.ClientRequestContext, c=d.newObject(s), u=new p(c), a=c.onDialogMessage.add((function (e) {
					switch (o.Utility.log("dialogMessageHandler:"+JSON.stringify(e)), e.type) {
						case 17:
							e.error ? i(e.error) : r(u);
							break;
						case 12:
							t.onMessage && t.onMessage(e.message, u);
							break;
						case 10:
						default:
							12006===e.originalErrorCode ? (a && (a.remove(), s.sync()), t.onClose && t.onClose()) : t.onRuntimeError && (t.onRuntimeError(e.error, u),
								i(e.error));
					}
					return o.CoreUtility.Promise.resolve();
				}));
				return s.sync().then((function () {
					var n={
						width: t.width ? parseInt(t.width) : 50,
						height: t.height ? parseInt(t.height) : 50,
						displayInIFrame: t.displayInIFrame
					};
					return c.displayDialog(e, n), s.sync();
				}))["catch"]((function (e) {
					i(e);
				}));
			}));
		...
		var g, d=function (e) {
			...
			return i(t, e), Object.defineProperty(t.prototype, "_className", {
				get: function () {
				...
				c(this, "Close", 1, [], 4, 0);
			}, t.prototype.displayDialog=function (e, t) {
				c(this, "DisplayDialog", 1, [e, t], 4, 0);
			}, t.prototype._handleResult=function (t) {
				e.prototype._handleResult.call(this, t), u(t) || l(this, t);
			}, t.prototype._handleRetrieveResult=function (t, n) {
				e.prototype._handleRetrieveResult.call(this, t, n), f(this, t, n);
			}, t.newObject=function (e) {
				return s(t, e, "Microsoft.Dialog.DialogService", !1, 4);
			}, Object.defineProperty(t.prototype, "onDialogMessage", {
				get: function () {
					return this.m_dialogMessage || (this.m_dialogMessage=new o.GenericEventHandlers(this.context, this, "DialogMessage", {
						eventType: 65536,
						...
						eventArgsTransformFunc: function (e) {
							var t, n, r, i;
							try {
								var s=JSON.parse(e.message), c=s.errorCode ? new o.Error((n=s.errorCode, (r={})[12002]={
									code: "InvalidUrl",
									...
									code: "Unknown",
									message: "An unknown error has occured with code: "+n
								})) : null;
								t={
									originalErrorCode: s.errorCode,
									type: s.type,
									error: c,
									message: s.message
								};
							...
							return o.Utility._createPromiseFromResult(t);
						}
		...
		t.DialogService=d, function (e) {
			e[e.dialogMessageReceived=0]="dialogMessageReceived", e[e.dialogEventReceived=1]="dialogEventReceived";
		}(g || (g={})), function (e) {
			e.generalException="GeneralException";
		}(t.DialogErrorCodes || (t.DialogErrorCodes={}));
	}, function (e, t, n) {
		"use strict";
		var r, i=this && this.__extends || (r=function (e, t) {
			return (r=Object.setPrototypeOf || {
		...
		var o=n(0), s=(o.BatchApiHelper.createPropertyObject, o.BatchApiHelper.createMethodObject,
			...
			o.Utility.isNullOrUndefined), a=(o.Utility.isUndefined, o.Utility.throwIfNotLoaded,
			o.Utility.throwIfApiNotSupported, o.Utility.load, o.Utility.retrieve, o.Utility.toJson), l=o.Utility.fixObjectPathIfNecessary, f=(o.Utility._handleNavigationPropertyResults,
			o.Utility.adjustToDateTime, o.Utility.processRetrieveResult);
		function p(e, t) {
			return new o.CoreUtility.Promise((function (n, r) {
				var i=d.getInstance(), o=i.setCallBack((function (e, i) {
					if (i)
						r(i);
					else {
						var o=t(e);
				...
				i.ctx.sync().then((function () {
					var t=i.getPersistentKvStorageService();
					return e(t, o), i.ctx.sync();
				}))["catch"]((function (e) {
					r(e);
				}));
			}));
		...
		function g(e, t, n) {
			return new o.CoreUtility.Promise((function (r, i) {
				var o=d.getInstance(), s=o.setCallBack((function (e, o) {
					if (o)
						return n && n(o), void i(o);
					var s=t(e);
					n && n(null, s), r(s);
				}));
				o.ctx.sync().then((function () {
					var t=o.getPersistentKvStorageService();
					return e(t, s), o.ctx.sync();
				}))["catch"]((function (e) {
					i(e);
				}));
			}));
		}
		o.Utility.setMockData, t.AsyncStorage={
			getItem: function (e, t) {
				return g((function (t, n) {
					return t.multiGet(n, JSON.stringify([e]));
				}), (function (e) {
					var t=JSON.parse(e);
					return t && t[0] && t[0][1] ? t[0][1] : null;
				}), t);
			},
			setItem: function (e, t, n) {
				return g((function (n, r) {
					return n.multiSet(r, JSON.stringify([[e, t]]));
				}), (function () {
					return null;
				}), n);
			},
			removeItem: function (e, t) {
				return g((function (t, n) {
					return t.multiRemove(n, JSON.stringify([e]));
				}), (function () {
					return null;
				}), t);
			},
			multiGet: function (e, t) {
				return g((function (t, n) {
					return t.multiGet(n, JSON.stringify(e));
				}), (function (t) {
					var n=JSON.parse(t), r={};
					return n && n.forEach((function (e) {
						var t=e[0], n=e[1];
						return r[t]=n, n;
					})), e.map((function (e) {
						return [e, r[e] ? r[e] : null];
					}));
				}), t);
			},
			multiSet: function (e, t) {
				return g((function (t, n) {
					return t.multiSet(n, JSON.stringify(e));
				}), (function () {
					return null;
				}), t);
			},
			multiRemove: function (e, t) {
				return g((function (t, n) {
					return t.multiRemove(n, JSON.stringify(e));
				}), (function () {
					return null;
			...
			setItems: function (e) {
				...
				return p((function (e, n) {
					return e.multiSet(n, JSON.stringify(t));
				}), (function () {
					return null;
				}));
			},
		...
		var d=function () {
			function e() {
				var e=this;
				this._invokeId=0, this._callDict={}, this.ctx=new o.ClientRequestContext,
					this._perkvstorService=h.newObject(this.ctx), this._eventResult=this._perkvstorService.onPersistentStorageMessage.add((function (t) {
					o.Utility.log("persistentKvStoragegMessageHandler:"+JSON.stringify(t));
					var n=e._callDict[t.invokeId];
					n && (n(t.message, t.error), delete e._callDict[t.invokeId]);
				}));
			}
			return e.getInstance=function () {
				return void 0===e.instance ? e.instance=new e : e.instance._perkvstorService=h.newObject(e.instance.ctx),
					e.instance;
			}, e.prototype.getPersistentKvStorageService=function () {
				return this._perkvstorService;
			}, e.prototype.getCallBack=function (e) {
				return this._callDict[e];
			}, e.prototype.setCallBack=function (e) {
				var t=this._invokeId;
				return this._callDict[this._invokeId++]=e, t;
			}, e;
		}(), h=function (e) {
			function t() {
				return null !==e && e.apply(this, arguments) || this;
			...
			return i(t, e), Object.defineProperty(t.prototype, "_className", {
				...
				c(this, "Clear", 1, [e], 4, 0);
			}, t.prototype.getAllKeys=function (e) {
				c(this, "GetAllKeys", 1, [e], 4, 0);
			}, t.prototype.multiGet=function (e, t) {
				c(this, "MultiGet", 1, [e, t], 4, 0);
			}, t.prototype.multiRemove=function (e, t) {
				c(this, "MultiRemove", 1, [e, t], 4, 0);
			}, t.prototype.multiSet=function (e, t) {
				c(this, "MultiSet", 1, [e, t], 4, 0);
			}, t.prototype._handleResult=function (t) {
				e.prototype._handleResult.call(this, t), u(t) || l(this, t);
			}, t.prototype._handleRetrieveResult=function (t, n) {
				e.prototype._handleRetrieveResult.call(this, t, n), f(this, t, n);
			}, t.newObject=function (e) {
				return s(t, e, "Microsoft.PersistentKvStorage.PersistentKvStorageService", !1, 4);
			}, Object.defineProperty(t.prototype, "onPersistentStorageMessage", {
				get: function () {
					return this.m_persistentStorageMessage || (this.m_persistentStorageMessage=new o.GenericEventHandlers(this.context, this, "PersistentStorageMessage", {
						eventType: 65537,
						registerFunc: function () { },
						unregisterFunc: function () { },
						getTargetIdFunc: function () {
						...
						eventArgsTransformFunc: function (e) {
							var t, n, r, i;
							try {
								var s=JSON.parse(e.message), c=parseInt(s.errorCode), u=0 !=c ? new o.Error((n=c,
									(r={})[16389]={
										code: "GenericException",
										message: "Unknown error."
									}, r[65535]={
		...
		t.PersistentKvStorageService=h, function (e) {
			e.generalException="GeneralException";
		...
		var o=function () {
			function e() { }
			return e.prototype.getBooleanFeatureGate=function (e, t) {
				try {
					var n=Microsoft.Office.WebExtension.FeatureGates[e];
					return "true"===n.toString().toLowerCase() || !0===n;
				}
				catch (e) {
					return t;
				}
			}, e.prototype.getIntFeatureGate=function (e, t) {
				try {
					var n=parseInt(Microsoft.Office.WebExtension.FeatureGates[e]);
					return isNaN(n) ? t : n;
				}
				catch (e) {
					return t;
				}
			}, e.prototype.getStringFeatureGate=function (e, t) {
				try {
					var n=Microsoft.Office.WebExtension.FeatureGates[e];
					return null==n ? t : n;
				}
			...
			}, e.prototype.getChangeGate=function (e) {
				return this.getBooleanFeatureGate(e, !0);
			}, e.prototype.getBooleanFeatureGateAsync=function (e, t) {
				return r(this, void 0, void 0, (function () {
					var n, r;
					return i(this, (function (i) {
						switch (i.label) {
							case 0:
								return i.trys.push([0, 2, , 3]), n=this.getRequestContext(), r=n.flighting.getFeature(e, "Boolean", t),
									n.load(r), [4, n.sync()];
							case 1:
								return i.sent(), [2, r.value];
							case 2:
								return i.sent(), [2, Promise.resolve(t)];
							case 3:
								return [2];
						}
					}));
				}));
			}, e.prototype.getStringFeatureGateAsync=function (e, t) {
				return r(this, void 0, void 0, (function () {
					var n, r;
					return i(this, (function (i) {
						switch (i.label) {
							case 0:
								return i.trys.push([0, 2, , 3]), n=this.getRequestContext(), r=n.flighting.getFeature(e, "String", t),
									n.load(r), [4, n.sync()];
							case 1:
								return i.sent(), [2, r.value];
							case 2:
			...
			}, e.prototype.getIntFeatureGateAsync=function (e, t) {
				return r(this, void 0, void 0, (function () {
					var n, r;
					return i(this, (function (i) {
						switch (i.label) {
							case 0:
								return i.trys.push([0, 2, , 3]), n=this.getRequestContext(), r=n.flighting.getFeature(e, "Integer", t),
									n.load(r), [4, n.sync()];
							case 1:
								return i.sent(), [2, r.value];
							case 2:
			...
			}, e.prototype.getRequestContext=function () {
				var e;
				if (Office.context.platform !==Office.PlatformType.OfficeOnline) {
					switch (Office.context.host) {
						case Office.HostType.Excel:
							e=new Excel.RequestContext;
							break;
						case Office.HostType.OneNote:
							e=new OneNote.RequestContext;
							break;
						case Office.HostType.PowerPoint:
							e=new PowerPoint.RequestContext;
							break;
						case Office.HostType.Word:
							e=new Word.RequestContext;
							break;
						default:
		...
		var r=n(9), i=function () {
			...
			return e.prototype.on=function (e, t) {
				return this.add(e, t), new Promise((function (e) {
					e();
				}));
			}, e.prototype.off=function (e, t) {
				return this.remove(e, t), new Promise((function (e) {
					e();
				}));
			}, e.prototype.emit=function (e, t) {
				return this.send(e, t), new Promise((function (e) {
					e();
				}));
			}, Object.defineProperty(e, "instance", {
				get: function () {
					return e.singleton || (e.singleton=new e), this.singleton;
				},
				enumerable: !0,
				configurable: !0
			}), e.prototype.setupReceive=function () {
				...
				this.listeners.hasOwnProperty(e) || (this.listeners[e]=new r.ListenerManager,
					this.setupReceive()), this.listeners[e].add(t);
			}, e.prototype.remove=function (e, t) {
				this.listeners.hasOwnProperty(e) && (t ? this.listeners[e].remove(t) : delete this.listeners[e]);
			}, e.prototype.send=function (e, t) {
				var n={
					eventName: e,
					message: t
				};
				Office && Office.context && Office.context.messaging && Office.context.messaging.sendMessage && Office.context.messaging.sendMessage(n);
			}, e.prototype.receiveMessage=function (e) {
				var t=e.eventName, n=e.message;
				this.listeners.hasOwnProperty(t) && this.listeners[t].call(n);
			}, e;
		}();
		t.Message=i;
	}, function (e, t, n) {
		...
		var r=function () {
			...
			return e.prototype.add=function (e) {
				...
				var t=this.listeners.lastIndexOf(e);
		...
		var r=function () {
			...
			return e.prototype.requestUpdate=function (e) {
				var t=this.requestContext.ribbon;
				return e.tabs.filter((function (e) {
					return !!e.id;
				})).forEach((function (e) {
					var n=t.getTab(e.id);
					void 0 !==e.visible && null !==e.visible && n.setVisibility(e.visible), e.controls.filter((function (e) {
						return !!e.id;
					})).forEach((function (e) {
						var n=t.getButton(e.id);
						void 0 !==e.enabled && null !==e.enabled && (n.enabled=e.enabled);
					}));
		...
		var r=n(0), i=function () {
			function e() { }
			return e.prototype.getAccessToken=function (e) {
				return new r.CoreUtility.Promise((function (t, n) {
					try {
						Office.context.auth.getAccessTokenAsync(e || {}, (function (e) {
							"succeeded"===e.status ? t(e.value) : n(e.error);
						}));
					}
					catch (e) {
						n(e);
				...
				get: function () {
					return e.singleton || (e.singleton=new e), e.singleton;
				},
				enumerable: !0,
				configurable: !0
			}), e;
...
(function (Office) {
	...
	storage: (_a=OfficeRuntime)===null || _a===void 0 ? void 0 : _a.storage;
	getAccessToken: (_c=(_b=OfficeRuntime)===null || _b===void 0 ? void 0 : _b.auth)===null || _c===void 0 ? void 0 : _c.getAccessToken;
	addin: (_d=OfficeRuntime)===null || _d===void 0 ? void 0 : _d.addin;
	isSetSupported: (_f=(_e=OfficeRuntime)===null || _e===void 0 ? void 0 : _e.apiInformation)===null || _f===void 0 ? void 0 : _f.isSetSupported;
	license: (_g=OfficeRuntime)===null || _g===void 0 ? void 0 : _g.license;
	message: (_h=OfficeRuntime)===null || _h===void 0 ? void 0 : _h.message;
})(Office || (Office={}));
