...
!function(e) {
    ...
    var o = n(2), i = n(3), u = n(5), c = n(6), s = n(7), a = n(8), f = n(9), l = n(10), p = n(13), g = n(14);
    window._useSDXSandbox ? window._OfficeRuntimeNative = r({}, window.OfficeRuntime, {
        displayWebDialog: c.displayWebDialog,
        AsyncStorage: s.AsyncStorage,
        storage: s.storage,
        experimentation: f.experimentation,
        apiInformation: i.apiInformation,
        message: l.Message.instance,
        ui: p.ui,
        auth: g.Auth.instance
    }) : window._OfficeRuntimeNative = r({}, window.OfficeRuntime, {
        displayWebDialog: c.displayWebDialog,
        AsyncStorage: u,
        storage: a.storage,
        experimentation: f.experimentation,
        apiInformation: o.apiInformation,
        message: l.Message.instance,
        ui: p.ui,
        auth: g.Auth.instance
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        isSetSupported: function(e, t) {
            try {
                return !!(Office && Office.context && Office.context.requirements) && Office.context.requirements.isSetSupported(e, Number(t));
            } catch (e) {
                return !1;
            }
        }
    ...
    (function(e) {
        function n(e) {
            var n, t = e.split("."), r = 0, o = 0;
            if (t.length < 2 && isNaN(Number(e))) throw "version format incorrect";
            if (n = Number(t[0]), t.length >= 2 && (r = Number(t[1])), t.length >= 3 && (o = Number(t[2])), 
            isNaN(n) || isNaN(r) || isNaN(o)) throw "version format incorrect";
            return {
                major: n,
                minor: r,
                patch: o
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            isSetSupported: function(t, r) {
                ...
                if (null == r && (r = "0.0.0"), void 0 === e.__apiSets) return !1;
                var o = e.__apiSets, i = Object.keys(o).map((function(e) {
                    return e.toLowerCase();
                })).indexOf(t.toLowerCase());
                if (i > -1) {
                    var u = o[Object.keys(o)[i]];
                    try {
                        var s, c = n(r);
                        if ((s = Array.isArray(u) ? function(e, t) {
                            for (var r = 0; r < e.length; r++) {
                                var o = n(e[r]);
                                if (o.major == t) return o;
                            }
                            return {
                                major: 0,
                                minor: 0,
    ...
    function i(e, t) {
        return void 0 === t && (t = function() {}), new Promise((function(n, r) {
            try {
                o(), e(), t(null), n();
            } catch (e) {
                t(e), r(e);
    ...
    function c(e, t, n) {
        return void 0 === n && (n = function() {}), new Promise((function(r, i) {
            var u = [];
            try {
                o();
            } catch (e) {
            ...
            })), n(u), u.length > 0 ? i(u) : r();
        }));
    }
    t.getItem = function(e, t) {
        return u((function() {
            return window.localStorage.getItem(r + e);
        }), t);
    }, t.setItem = function(e, t, n) {
        return i((function() {
            return window.localStorage.setItem(r + e, t);
        }), n);
    }, t.removeItem = function(e, t) {
        return i((function() {
            return window.localStorage.removeItem(r + e);
        }), t);
    }, t.clear = function(e) {
        return i((function() {
            Object.keys(window.localStorage).filter((function(e) {
                return 0 === e.indexOf(r);
            })).forEach((function(e) {
                return window.localStorage.removeItem(e);
            }));
        }), e);
    }, t.getAllKeys = function(e) {
        return u((function() {
            return Object.keys(window.localStorage).filter((function(e) {
                return 0 === e.indexOf(r);
            })).map((function(e) {
                return e.substr(r.length);
            }));
        }), e);
    }, t.multiSet = function(e, t) {
        return c(e, (function(e) {
            var t = e[0], n = e[1];
            return window.localStorage.setItem(r + t, n);
        }), t);
    }, t.multiRemove = function(e, t) {
        return c(e, (function(e) {
            return window.localStorage.removeItem(r + e);
        }), t);
    }, t.multiGet = function(e, t) {
        return new Promise((function(n, o) {
            t || (t = function() {});
            var i = [], u = e.map((function(e) {
                try {
                    return [ e, window.localStorage.getItem(r + e) ];
                } catch (e) {
                    i.push(e);
                }
            })).filter((function(e) {
            ...
            i.length > 0 ? (t(i, u), o(i)) : (t(null, u), n(u));
        }));
    };
}, function(e, t, n) {
    "use strict";
    ...
    var r = n(0), o = function() {
        ...
        return e.prototype.close = function() {
            return this._dialog.close(), r.CoreUtility.Promise.resolve();
        }, e;
    }();
    t.Dialog = o, t.displayWebDialog = function(e, t) {
        return new r.CoreUtility.Promise((function(n, i) {
            if (t.width && t.height && (!f(t.width) || !f(t.height))) throw new r.Error({
                code: "InvalidArgument",
                message: 'Dimensions must be "number%" or number.'
            });
            var u, c = {
                width: t.width ? parseInt(t.width, 10) : 50,
                height: t.height ? parseInt(t.height, 10) : 50,
                displayInIframe: t.displayInIFrame || !1
            };
            function s(e) {
                t.onMessage && t.onMessage(e.message, u);
            }
            function a(e) {
                12006 === e.error ? t.onClose && t.onClose() : t.onRuntimeError && t.onRuntimeError(new r.Error(l(e.error)), u);
            }
            function f(e) {
                return /^(\-|\+)?([0-9]+)%?$/.test(e);
            }
            ...
            Office.context.ui.displayDialogAsync(e, c, (function(e) {
                "failed" === e.status ? i(new r.Error(l(e.error.code))) : ((u = e.value).addEventHandler(Office.EventType.DialogMessageReceived, s), 
                u.addEventHandler(Office.EventType.DialogEventReceived, a), n(new o(u)));
            }));
        }));
    };
}, function(e, t, n) {
    ...
    var i = n(0), u = (i.BatchApiHelper.createPropertyObject, i.BatchApiHelper.createMethodObject, 
    i.BatchApiHelper.createIndexerObject, i.BatchApiHelper.createRootServiceObject, 
    i.BatchApiHelper.createTopLevelServiceObject), c = (i.BatchApiHelper.createChildItemObject, 
    i.BatchApiHelper.invokeMethod), s = (i.BatchApiHelper.invokeEnsureUnchanged, i.BatchApiHelper.invokeSetProperty, 
    i.Utility.isNullOrUndefined), a = (i.Utility.isUndefined, i.Utility.throwIfNotLoaded, 
    i.Utility.throwIfApiNotSupported, i.Utility.load, i.Utility.retrieve, i.Utility.toJson), f = i.Utility.fixObjectPathIfNecessary, l = (i.Utility._handleNavigationPropertyResults, 
    i.Utility.adjustToDateTime, i.Utility.processRetrieveResult);
    function p(e, t) {
        return new i.CoreUtility.Promise((function(n, r) {
            var o = d.getInstance(), i = o.setCallBack((function(e, o) {
                if (o) r(o); else {
                    var i = t(e);
                    n(i);
                }
    ...
    function g(e, t, n) {
        return new i.CoreUtility.Promise((function(r, o) {
            var i = d.getInstance(), u = i.setCallBack((function(e, i) {
                if (i) return n && n(i), void o(i);
                var u = t(e);
                n && n(null, u), r(u);
            }));
            i.ctx.sync().then((function() {
                var t = i.getPersistentKvStorageService();
                return e(t, u), i.ctx.sync();
            })).catch((function(e) {
                o(e);
            }));
        }));
    }
    i.Utility.setMockData, t.AsyncStorage = {
    ...
    var d = function() {
        function e() {
            var e = this;
            this._invokeId = 0, this._callDict = {}, this.ctx = new i.ClientRequestContext, 
            this._perkvstorService = m.newObject(this.ctx), this._eventResult = this._perkvstorService.onPersistentStorageMessage.add((function(t) {
                i.Utility.log("persistentKvStoragegMessageHandler:" + JSON.stringify(t));
                var n = e._callDict[t.invokeId];
                n && (n(t.message, t.error), delete e._callDict[t.invokeId]);
            }));
        }
        return e.getInstance = function() {
            return void 0 === e.instance ? e.instance = new e : e.instance._perkvstorService = m.newObject(e.instance.ctx), 
            e.instance;
        ...
        return o(t, e), Object.defineProperty(t.prototype, "_className", {
            get: function() {
            ...
            e.prototype._handleResult.call(this, t), s(t) || f(this, t);
        }, t.prototype._handleRetrieveResult = function(t, n) {
            e.prototype._handleRetrieveResult.call(this, t, n), l(this, t, n);
        }, t.newObject = function(e) {
            return u(t, e, "Microsoft.PersistentKvStorage.PersistentKvStorageService", !1, 4);
        }, Object.defineProperty(t.prototype, "onPersistentStorageMessage", {
            get: function() {
                return this.m_persistentStorageMessage || (this.m_persistentStorageMessage = new i.GenericEventHandlers(this.context, this, "PersistentStorageMessage", {
                    eventType: 65537,
                    ...
                    eventArgsTransformFunc: function(e) {
                        var t, n, r, o;
                        try {
                            var u = JSON.parse(e.message), c = parseInt(u.errorCode), s = 0 != c ? new i.Error((n = c, 
                            (r = {})[16389] = {
                        ...
                        return i.Utility._createPromiseFromResult(t);
                    }
    ...
    t.PersistentKvStorageService = m, function(e) {
    ...
    function c(e, t) {
        return new Promise((function(n, r) {
            ...
            for (var u in e) if (e.hasOwnProperty(u) || Array.isArray(e)) try {
                Array.isArray(e) ? t(e[u]) : t(u);
            } catch (e) {
                i.push(e);
            }
            i.length > 0 ? r(new Error("Unknown error.")) : n();
        }));
    }
    t.storage = {
        getItem: function(e) {
        ...
        getItems: function(e) {
            return new Promise((function(t, n) {
                ...
                e.forEach((function(e) {
                    try {
                        var t = window.localStorage.getItem(r + e);
                        i[e] = t || null;
                    } catch (e) {
                        u.push(e);
                    }
                })), u.length > 0 ? n(new Error("Unknown error.")) : t(i);
            }));
        },
        setItems: function(e) {
            return c(e, (function(t) {
                return window.localStorage.setItem(r + t, e[t]);
            }));
        },
        removeItems: function(e) {
            return c(e, (function(e) {
                window.localStorage.removeItem(r + e);
            }));
        },
        getKeys: function() {
            return u((function() {
        ...
        return e.prototype.getBooleanFeatureGate = function(e, t) {
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    switch (o.label) {
                      case 0:
                        return o.trys.push([ 0, 2, , 3 ]), n = this.getRequestContext(), r = n.flighting.getFeature(e, "Boolean", t), 
                        n.load(r), [ 4, n.sync() ];

                      case 1:
                        return o.sent(), [ 2, r.value ];

                      case 2:
                        return o.sent(), [ 2, Promise.resolve(t) ];
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    switch (o.label) {
                      case 0:
                        return o.trys.push([ 0, 2, , 3 ]), n = this.getRequestContext(), r = n.flighting.getFeature(e, "String", t), 
                        n.load(r), [ 4, n.sync() ];
            ...
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    switch (o.label) {
                      case 0:
                        return o.trys.push([ 0, 2, , 3 ]), n = this.getRequestContext(), r = n.flighting.getFeature(e, "Integer", t), 
                        n.load(r), [ 4, n.sync() ];
