...
_u.ExtensibilityStrings.l_AttachmentItemIdTooLong_Text = "Vähintään yhden liitteen tunnus on liian pitkä.";
_u.ExtensibilityStrings.l_AttachmentNameTooLong_Text = "Vähintään yhden liitteen nimi on liian pitkä.";
_u.ExtensibilityStrings.l_AttachmentNotSupported_Text = "Liitetiedostotyyppiä ei tueta.";
_u.ExtensibilityStrings.l_AttachmentUploadGeneralFailure_Text = "Kohteeseen ei voi lisätä liitettä.";
_u.ExtensibilityStrings.l_AttachmentUrlTooLong_Text = "Vähintään yhden liitteen URL-osoite on liian pitkä.";
_u.ExtensibilityStrings.l_CallSaveAsyncBeforeToken_Text = "Tunnusta ei voi noutaa, ennen kuin kohde on tallennettu.";
...
_u.ExtensibilityStrings.l_CannotPersistPropertyInUnsavedDraftError_Text = "Tallentamattomissa luonnoksissa ei voi olla pysyviä ilmoituksia. Tallenna kohde ennen tämän ohjelmointirajapinnan kutsumista.";
...
_u.ExtensibilityStrings.l_Internal_Server_Error_Text = "Exchange-palvelin palautti virheen. Katso lisätietoja diagnostiikkaobjektista.";
_u.ExtensibilityStrings.l_Internet_Not_Connected_Error_Text = "Käyttäjä ei ole enää yhteydessä verkkoon. Tarkista verkkoyhteys ja yritä uudelleen.";
...
_u.ExtensibilityStrings.l_InvalidCommandIdError_Text = "Parametrin commandId arvo on virheellinen.";
...
_u.ExtensibilityStrings.l_NumberOfNotificationsExceeded_Text = "Ilmoitusta ei voitu lisätä, koska ilmoituksia koskeva raja on täyttynyt.";
...
_u.ExtensibilityStrings.l_Olk_Http_Error_Text = "Pyyntö epäonnistui. Katso HTTP-virhekoodi diagnostiikkaobjektista.";
_u.ExtensibilityStrings.l_ParameterValueTooLongError_Text = "Parametrin {0} arvo on liian pitkä. Merkkien enimmäismäärä on {1}.";
_u.ExtensibilityStrings.l_ParametersNotAsExpected_Text = "Annetut parametrit eivät vastaa odotettua muotoa.";
_u.ExtensibilityStrings.l_PersistedNotificationArrayReadError_Text = "Tekemäsi ohjelmointirajapinnan kutsu epäonnistui, koska pysyviä ilmoituksia ei voitu noutaa.";
