...
Strings.OfficeOM.L_ConfirmDialog = "Haluatko luottaa toimi alueeseen {0}, missä tätä Office-istuntoa isännöidään?";
...
Strings.OfficeOM.L_PropertyDoesNotExist = "Ominaisuutta {0} ei ole olemassa objektissa.";
Strings.OfficeOM.L_PropertyNotLoaded = "Ominaisuus {0} ei ole käytettävissä. Ennen kuin luet ominaisuuden arvon, kutsu Load-menetelmä sisältävään objektiin ja kutsu context.sync() siihen liittyvään pyyntökontekstiin.";
...
Strings.OfficeOM.L_RowIndexOutOfRange = "Rivi-indeksin arvo on sallitun alueen ulkopuolella. Käytä arvoa (vähintään 0), joka on pienempi kuin rivien määrä.";
Strings.OfficeOM.L_RunMustReturnPromise = ".run-menetelmään välitetty erätoiminto ei palauttanut lupausta. Toiminnon on palautettava lupaus, jotta mahdolliset automaattisesti seuratut objektit voidaan vapauttaa erätoiminnon valmistuessa. Yleensä lupauksen palautus tapahtuu palauttamalla vastaus kohteesta context.sync().";
Strings.OfficeOM.L_SSOClientError = "Officen todentamispyynnössä tapahtui virhe.";
Strings.OfficeOM.L_SSOClientErrorMessage = "Odottamaton virhe asiakasohjelmassa.";
Strings.OfficeOM.L_SSOConnectionLostError = "Yhteys katkesi kirjautumisen aikana.";
...
Strings.OfficeOM.L_ShowWindowDialogNotification = "{0} haluaa avata uuden ikkunan.";
Strings.OfficeOM.L_ShowWindowDialogNotificationAllow = "Salli";
Strings.OfficeOM.L_ShowWindowDialogNotificationIgnore = "Ohita";
...
Strings.OfficeOM.L_Timeout = "Toiminto aikakatkaistiin.";
...
Strings.OfficeOM.L_UnsupportedUserIdentity = "Käyttäjätietotyyppiä ei tueta.";
Strings.OfficeOM.L_UnsupportedUserIdentityMessage = "Käyttäjän käyttäjätietotyyppiä ei tueta.";
Strings.OfficeOM.L_UserAborted = "Käyttäjä keskeytti lupapyynnön.";
Strings.OfficeOM.L_UserAbortedMessage = "Käyttäjä ei antanut lupaa apuohjelman käyttöoikeuksille.";
...
Strings.OfficeOM.L_WriteNotSupportedWhenModalDialogOpen = "Office ei tue kirjoitustoimintoa, kun modaalinen valintaikkuna on avoinna.";