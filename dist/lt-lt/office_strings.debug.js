...
Strings.OfficeOM.L_ActivityLimitReached = "Pasiektas veiklos limitas.";
Strings.OfficeOM.L_AddBindingFromPromptDefaultText = "Pažymėkite.";
Strings.OfficeOM.L_AddinIsAlreadyRequestingToken = "Papildinys jau prašo prieigos atpažinimo ženklo.";
Strings.OfficeOM.L_AddinIsAlreadyRequestingTokenMessage = "Operacija nepavyko, nes šis papildinys jau prašo prieigos atpažinimo ženklo.";
Strings.OfficeOM.L_ApiNotFoundDetails = "Metodas ar ypatybė {0} yra „{1}“ reikalavimų rinkinio dalis, kuri nepasiekiama jūsų „{2}“ versijoje.";
Strings.OfficeOM.L_AppNameNotExist = "Nėra {0} papildinio pavadinimo.";
...
Strings.OfficeOM.L_AttemptingToSetReadOnlyProperty = "Bandoma nustatyti tik skaitomą ypatybę „{0}“.";
...
Strings.OfficeOM.L_ConfirmCancelMessage = "Deja, negalime tęsti.";
Strings.OfficeOM.L_ConfirmDialog = "Ar pasitikite domenu {0}, kuriame šis „Office“ seansas yra laikomas?";
Strings.OfficeOM.L_ConfirmRefreshMessage = "Norėdami tęsti, pašalinkite papildinį ir įtraukite jį dar kartą arba atnaujinkite puslapį.";
...
Strings.OfficeOM.L_ContinueButton = "Tęsti";
...
Strings.OfficeOM.L_CustomXmlOutOfDateMessage = "Duomenys yra pasenę. Nuskaitykite objektą dar kartą.";
Strings.OfficeOM.L_CustomXmlOutOfDateName = "Duomenys neatnaujinti";
...
Strings.OfficeOM.L_DialogOK = "Gerai";
Strings.OfficeOM.L_DialogRequireHTTPS = "HTTP protokolas nepalaikomas. Vietoj jo naudokite HTTPS";
Strings.OfficeOM.L_DisplayDialogError = "Rodyti dialogo lango klaidą";
...
Strings.OfficeOM.L_InvalidApiArgumentsMessage = "Netinkami įvesties argumentai.";
Strings.OfficeOM.L_InvalidApiCallInContext = "Neleistinas API iškvietimas dabartiniame kontekste.";
Strings.OfficeOM.L_InvalidArgument = 'Argumentas „{0}" šioje situacijoje neveikia, jo nėra arba formatas netinkamas.';
Strings.OfficeOM.L_InvalidArgumentGeneric = "Perduoti argumentai šioje situacijoje neveikia, jų nėra arba netinkamas jų formatas.";
...
Strings.OfficeOM.L_InvalidGrant = "Trūksta išankstinio įgaliojimo.";
Strings.OfficeOM.L_InvalidGrantMessage = "Trūksta šio papildinio teisių suteikimo.";
...
Strings.OfficeOM.L_InvalidResourceUrl = "Pateiktas netinkamas programos ištekliaus URL.";
...
Strings.OfficeOM.L_NewWindowCrossZone = "Dėl jūsų naršyklės saugos parametrų negalime sukurti dialogo lango. Pabandykite kitą naršyklę arba {0}, kad „{1}“ ir naršyklės adreso juostoje rodomas domenas būtų toje pačioje saugos zonoje.";
Strings.OfficeOM.L_NewWindowCrossZoneConfigureBrowserLink = "konfigūruoti naršyklę";
Strings.OfficeOM.L_NewWindowCrossZoneErrorString = "Dėl naršyklės apribojimų mums nepavyko sukurti dialogo lango. Dialogo lango domenas ir papildinio pagrindinio kompiuterio domenas yra ne tose pačiose saugos zonose.";
Strings.OfficeOM.L_NoCapability = "Neturite pakankamai teisių šiam veiksmui atlikti.";
Strings.OfficeOM.L_NoHttpsWAC = "Šis „Office“ seansas nenaudoja saugaus ryšio. Rekomenduojame imtis papildomų atsargumo priemonių.";
...
Strings.OfficeOM.L_NotTrustedWAC = "Šis papildinys buvo išjungtas, kad būtų užtikrintas jūsų saugumas. Norėdami ir toliau naudoti papildinį, patikrinkite, ar šis elementas yra laikomas patikimame domene arba atidarykite jį „Office“ kompiuterio taikomojoje programoje.";
...
Strings.OfficeOM.L_PropertyDoesNotExist = "Ypatybės „{0}“ objekte nėra.";
Strings.OfficeOM.L_PropertyNotLoaded = 'Ypatybės „{0}" nėra. Prieš nuskaitydami ypatybės reikšmę, iškvieskite objekto „load" metodą ir susijusiame užklausos kontekste iškvieskite „context.sync()“.';
...
Strings.OfficeOM.L_SSOConnectionLostError = "Prisijungiant nutrūko ryšys.";
...
Strings.OfficeOM.L_ShowWindowDialogNotification = "„{0}“ nori atidaryti naują langą.";
Strings.OfficeOM.L_ShowWindowDialogNotificationAllow = "Leisti";
Strings.OfficeOM.L_ShowWindowDialogNotificationIgnore = "Nepaisyti";
...
Strings.OfficeOM.L_Timeout = "Baigėsi operacijos laikas. ";
...
Strings.OfficeOM.L_UnsupportedUserIdentity = "Vartotojo tapatybės tipas nepalaikomas.";
Strings.OfficeOM.L_UnsupportedUserIdentityMessage = "Vartotojo tapatybės tipas nepalaikomas.";
Strings.OfficeOM.L_UserAborted = "Vartotojas atmetė sutikimo užklausą.";
Strings.OfficeOM.L_UserAbortedMessage = "Vartotojas nesuteikė papildinio teisių.";
...
Strings.OfficeOM.L_WriteNotSupportedWhenModalDialogOpen = "Kai atidarytas modalusis dialogo langas, „Office“ rašymo operacijos nepalaiko.";