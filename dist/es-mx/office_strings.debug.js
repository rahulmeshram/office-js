...
Strings.OfficeOM.L_ColIndexOutOfRange = "El valor de índice de columna está fuera del intervalo permitido. Usa un valor (0 o superior) que sea menor que el número de columnas.";
Strings.OfficeOM.L_ConfirmCancelMessage = "No podemos continuar.";
Strings.OfficeOM.L_ConfirmDialog = "¿Confías en el {0} de dominio donde se hospeda esta sesión de Office?";
...
Strings.OfficeOM.L_RowIndexOutOfRange = "El valor de índice de fila está fuera del intervalo permitido. Usa un valor (0 o superior) que sea menor que el número de filas.";
...
Strings.OfficeOM.L_WorkbookHiddenMessage = "La solicitud de la API de JavaScript falló porque se ocultó el libro. Muestra el libro y vuelve a intentarlo.";
