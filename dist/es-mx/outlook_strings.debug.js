...
_u.ExtensibilityStrings.l_CannotPersistPropertyInUnsavedDraftError_Text = "Las notificaciones no se pueden conservar en borradores no guardados. Guarda el elemento antes de llamar a esta API.";
...
_u.ExtensibilityStrings.l_EwsRequestOversized_Text = "La solicitud supera el límite de tamaño de 1 MB. Modifica la solicitud de EWS.";
...
_u.ExtensibilityStrings.l_HtmlSanitizationFailure_Text = "Error en la inmunización HTML.";
...
_u.ExtensibilityStrings.l_Internal_Server_Error_Text = "El servidor de Exchange devolvió un error. Ver el objeto de diagnóstico para obtener más información.";
_u.ExtensibilityStrings.l_Internet_Not_Connected_Error_Text = "El usuario ya no está conectado a la red. Comprueba la conexión y vuelve a intentarlo.";
...
_u.ExtensibilityStrings.l_NumberOfNotificationsExceeded_Text = "No se pudo agregar la notificación porque se alcanzó el límite de notificaciones.";
...
_u.ExtensibilityStrings.l_Olk_Http_Error_Text = "La solicitud ha fallado. Ver el objeto de diagnóstico para el código de error HTTP.";
...
_u.ExtensibilityStrings.l_Recurrence_Error_Properties_Invalid_Text = "El patrón de periodicidad no es válido. Comprueba que las propiedades de frecuencia especificadas se alineen con el tipo de periodicidad.";
