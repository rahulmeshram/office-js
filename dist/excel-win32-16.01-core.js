...
(function (OSFAppTelemetry) {
    ...
    function initialize(context) {
        ...
        appInfo.hostJSVersion = "16.0.11218.30002";
...
!function(e){var t={};function r(n){if(t[n])return t[n].exports;var i=t[n]={i:n,l:!1,exports:{}};return e[n].call(i.exports,i,i.exports,r),i.l=!0,i.exports}r.m=e,r.c=t,r.d=function(e,t,n){r.o(e,t)||Object.defineProperty(e,t,{enumerable:!0,get:n})},r.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},r.t=function(e,t){if(1&t&&(e=r(e)),8&t)return e;if(4&t&&"object"==typeof e&&e&&e.__esModule)return e;var n=Object.create(null);if(r.r(n),Object.defineProperty(n,"default",{enumerable:!0,value:e}),2&t&&"string"!=typeof e)for(var i in e)r.d(n,i,function(t){return e[t]}.bind(null,i));return n},r.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return r.d(t,"a",t),t},r.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},r.p="",r(r.s=1)}([function(e,t){e.exports=OfficeExtensionBatch},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=r(2),i=r(3);window._OfficeRuntimeNative={displayWebDialog:n.displayWebDialog,AsyncStorage:i.AsyncStorage}},function(e,t,r){"use strict";var n=this&&this.__extends||function(){var e=function(t,r){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)t.hasOwnProperty(r)&&(e[r]=t[r])})(t,r)};return function(t,r){function n(){this.constructor=t}e(t,r),t.prototype=null===r?Object.create(r):(n.prototype=r.prototype,new n)}}();Object.defineProperty(t,"__esModule",{value:!0});var i=r(0),o=(i.BatchApiHelper.createPropertyObject,i.BatchApiHelper.createMethodObject,i.BatchApiHelper.createIndexerObject,i.BatchApiHelper.createRootServiceObject,i.BatchApiHelper.createTopLevelServiceObject),s=(i.BatchApiHelper.createChildItemObject,i.BatchApiHelper.invokeMethod),c=(i.BatchApiHelper.invokeEnsureUnchanged,i.BatchApiHelper.invokeSetProperty,i.Utility.isNullOrUndefined),a=(i.Utility.isUndefined,i.Utility.throwIfNotLoaded,i.Utility.throwIfApiNotSupported,i.Utility.load,i.Utility.retrieve,i.Utility.toJson),u=i.Utility.fixObjectPathIfNecessary,l=(i.Utility._handleNavigationPropertyResults,i.Utility.adjustToDateTime,i.Utility.processRetrieveResult),p=function(){function e(e){this._dialogService=e}return e.prototype.close=function(){return this._dialogService.close(),this._dialogService.context.sync()},e}();t.Dialog=p,t.displayWebDialog=function(e,t){return void 0===t&&(t={}),new i.CoreUtility.Promise(function(n,o){if(t.width&&t.height&&(!r(t.width)||!r(t.height)))throw new i.Error({code:"InvalidArgument",message:"Dimensions must be % or number."});var s=new i.ClientRequestContext,c=d.newObject(s),a=new p(c),u=c.onDialogMessage.add(function(e){switch(i.Utility.log("dialogMessageHandler:"+JSON.stringify(e)),e.type){case 17:e.error?o(e.error):n(a);break;case 12:t.onMessage&&t.onMessage(e.message,a);break;case 10:default:12006===e.originalErrorCode?(u&&(u.remove(),s.sync()),t.onClose&&t.onClose()):t.onRuntimeError&&(t.onRuntimeError(e.error,a),o(e.error))}return i.CoreUtility.Promise.resolve()});return s.sync().then(function(){var r={width:t.width?parseInt(t.width):50,height:t.height?parseInt(t.height):50,displayInIFrame:t.displayInIFrame};return c.displayDialog(e,r),s.sync()}).catch(function(e){o(e)})});function r(e){return/^(\-|\+)?([0-9]+)%?$/.test(e)}};var f,d=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return n(t,e),Object.defineProperty(t.prototype,"_className",{get:function(){return"DialogService"},enumerable:!0,configurable:!0}),t.prototype.close=function(){s(this,"Close",1,[],4,0)},t.prototype.displayDialog=function(e,t){s(this,"DisplayDialog",1,[e,t],4,0)},t.prototype._handleResult=function(t){(e.prototype._handleResult.call(this,t),c(t))||u(this,t)},t.prototype._handleRetrieveResult=function(t,r){e.prototype._handleRetrieveResult.call(this,t,r),l(this,t,r)},t.newObject=function(e){return o(t,e,"Microsoft.Dialog.DialogService",!1,4)},Object.defineProperty(t.prototype,"onDialogMessage",{get:function(){return this.m_dialogMessage||(this.m_dialogMessage=new i.GenericEventHandlers(this.context,this,"DialogMessage",{eventType:65536,registerFunc:function(){},unregisterFunc:function(){},getTargetIdFunc:function(){return null},eventArgsTransformFunc:function(e){var t;try{var r=JSON.parse(e.message),n=r.errorCode?new i.Error(function(e){var t,r=((t={})[12002]={code:"InvalidUrl",message:"Cannot load URL, no such page or bad URL syntax."},t[12003]={code:"InvalidUrl",message:"HTTPS is required."},t[12004]={code:"Untrusted",message:"Domain is not trusted."},t[12005]={code:"InvalidUrl",message:"HTTPS is required."},t[12007]={code:"FailedToOpen",message:"Another dialog is already opened."},t);return r[e]?r[e]:{code:"Unknown",message:"An unknown error has occured"}}(r.errorCode)):null;t={originalErrorCode:r.errorCode,type:r.type,error:n,message:r.message}}catch(e){t={originalErrorCode:null,type:17,error:new i.Error({code:"GenericException",message:"Unknown error"}),message:e.message}}return i.Utility._createPromiseFromResult(t)}})),this.m_dialogMessage},enumerable:!0,configurable:!0}),t.prototype.toJSON=function(){return a(this,{},{})},t}(i.ClientObject);t.DialogService=d,function(e){e[e.dialogMessageReceived=0]="dialogMessageReceived",e[e.dialogEventReceived=1]="dialogEventReceived"}(f||(f={})),function(e){e.generalException="GeneralException"}(t.DialogErrorCodes||(t.DialogErrorCodes={}))},function(e,t,r){"use strict";var n=this&&this.__extends||function(){var e=function(t,r){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)t.hasOwnProperty(r)&&(e[r]=t[r])})(t,r)};return function(t,r){function n(){this.constructor=t}e(t,r),t.prototype=null===r?Object.create(r):(n.prototype=r.prototype,new n)}}();Object.defineProperty(t,"__esModule",{value:!0});var i=r(0),o=(i.BatchApiHelper.createPropertyObject,i.BatchApiHelper.createMethodObject,i.BatchApiHelper.createIndexerObject,i.BatchApiHelper.createRootServiceObject,i.BatchApiHelper.createTopLevelServiceObject),s=(i.BatchApiHelper.createChildItemObject,i.BatchApiHelper.invokeMethod),c=(i.BatchApiHelper.invokeEnsureUnchanged,i.BatchApiHelper.invokeSetProperty,i.Utility.isNullOrUndefined),a=(i.Utility.isUndefined,i.Utility.throwIfNotLoaded,i.Utility.throwIfApiNotSupported,i.Utility.load,i.Utility.retrieve,i.Utility.toJson),u=i.Utility.fixObjectPathIfNecessary,l=(i.Utility._handleNavigationPropertyResults,i.Utility.adjustToDateTime,i.Utility.processRetrieveResult);function p(e,t,r){return new i.CoreUtility.Promise(function(n,i){var o=f.getInstance(),s=o.setCallBack(function(e,o){if(o)return r&&r(o),void i(o);var s=t(e);r&&r(null,s),n(s)});o.ctx.sync().then(function(){var t=o.getPersistentKvStorageService();return e(t,s),o.ctx.sync()}).catch(function(e){i(e)})})}t.AsyncStorage={getItem:function(e,t){return p(function(t,r){return t.multiGet(r,JSON.stringify([e]))},function(e){var t=JSON.parse(e);return t&&t[0]&&t[0][1]?t[0][1]:null},t)},setItem:function(e,t,r){return p(function(r,n){return r.multiSet(n,JSON.stringify([[e,t]]))},function(){return null},r)},removeItem:function(e,t){return p(function(t,r){return t.multiRemove(r,JSON.stringify([e]))},function(){return null},t)},multiGet:function(e,t){return p(function(t,r){return t.multiGet(r,JSON.stringify(e))},function(t){var r=JSON.parse(t),n={};return r&&r.forEach(function(e){var t=e[0],r=e[1];return n[t]=r,r}),e.map(function(e){return[e,n[e]?n[e]:null]})},t)},multiSet:function(e,t){return p(function(t,r){return t.multiSet(r,JSON.stringify(e))},function(){return null},t)},multiRemove:function(e,t){return p(function(t,r){return t.multiRemove(r,JSON.stringify(e))},function(){return null},t)},getAllKeys:function(e){return p(function(e,t){return e.getAllKeys(t)},function(e){return JSON.parse(e)},e)},clear:function(e){return p(function(e,t){return e.clear(t)},function(){return null},e)}};var f=function(){function e(){var e=this;this._invokeId=0,this._callDict={},this.ctx=new i.ClientRequestContext,this._perkvstorService=d.newObject(this.ctx),this._eventResult=this._perkvstorService.onPersistentStorageMessage.add(function(t){i.Utility.log("persistentKvStoragegMessageHandler:"+JSON.stringify(t));var r=e._callDict[t.invokeId];r&&(r(t.message,t.error),delete e._callDict[t.invokeId])})}return e.getInstance=function(){return void 0===e.instance?e.instance=new e:e.instance._perkvstorService=d.newObject(e.instance.ctx),e.instance},e.prototype.getPersistentKvStorageService=function(){return this._perkvstorService},e.prototype.getCallBack=function(e){return this._callDict[e]},e.prototype.setCallBack=function(e){var t=this._invokeId;return this._callDict[this._invokeId++]=e,t},e}(),d=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return n(t,e),Object.defineProperty(t.prototype,"_className",{get:function(){return"PersistentKvStorageService"},enumerable:!0,configurable:!0}),t.prototype.clear=function(e){s(this,"Clear",1,[e],4,0)},t.prototype.getAllKeys=function(e){s(this,"GetAllKeys",1,[e],4,0)},t.prototype.multiGet=function(e,t){s(this,"MultiGet",1,[e,t],4,0)},t.prototype.multiRemove=function(e,t){s(this,"MultiRemove",1,[e,t],4,0)},t.prototype.multiSet=function(e,t){s(this,"MultiSet",1,[e,t],4,0)},t.prototype._handleResult=function(t){(e.prototype._handleResult.call(this,t),c(t))||u(this,t)},t.prototype._handleRetrieveResult=function(t,r){e.prototype._handleRetrieveResult.call(this,t,r),l(this,t,r)},t.newObject=function(e){return o(t,e,"Microsoft.PersistentKvStorage.PersistentKvStorageService",!1,4)},Object.defineProperty(t.prototype,"onPersistentStorageMessage",{get:function(){return this.m_persistentStorageMessage||(this.m_persistentStorageMessage=new i.GenericEventHandlers(this.context,this,"PersistentStorageMessage",{eventType:65537,registerFunc:function(){},unregisterFunc:function(){},getTargetIdFunc:function(){return null},eventArgsTransformFunc:function(e){var t;try{var r=JSON.parse(e.message),n=parseInt(r.errorCode),o=0!=n?new i.Error(function(e){var t,r=((t={})[16389]={code:"GenericException",message:"Unknown error."},t[65535]={code:"Unexcepted",message:"Catastrophic failure."},t[14]={code:"OutOfMemory",message:"Ran out of memory."},t[87]={code:"InvalidArg",message:"One or more arguments are invalid."},t[16385]={code:"NotImplemented",message:"Not implemented."},t[6]={code:"BadHandle",message:"File Handle is not Set."},t[5]={code:"AccessDenied",message:"Can't read the AsyncStorage File."},t);return r[e]?r[e]:{code:"Unknown",message:"An unknown error has occured"}}(n)):null;t={invokeId:r.invokeId,message:r.message,error:o}}catch(e){t={invokeId:-1,message:e.message,error:new i.Error({code:"GenericException",message:"Unknown error"})}}return i.Utility._createPromiseFromResult(t)}})),this.m_persistentStorageMessage},enumerable:!0,configurable:!0}),t.prototype.toJSON=function(){return a(this,{},{})},t}(i.ClientObject);t.PersistentKvStorageService=d,function(e){e.generalException="GeneralException"}(t.ErrorCodes||(t.ErrorCodes={}))}]);