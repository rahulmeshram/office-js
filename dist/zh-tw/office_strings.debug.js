...
Strings.OfficeOM.L_ConfirmCancelMessage = "抱歉，我們無法繼續。";
Strings.OfficeOM.L_ConfirmDialog = "您是否信任主控此 Office 工作階段的網域 {0}?";
Strings.OfficeOM.L_ConfirmRefreshMessage = "若要繼續，請移除增益集並重新新增，或重新整理頁面。";
...
Strings.OfficeOM.L_ContinueButton = "繼續";
...
Strings.OfficeOM.L_NoHttpsWAC = "此 Office 工作階段未使用安全連線。我們建議您採取額外的預防措施。";
...
Strings.OfficeOM.L_NotTrustedWAC = "已停用此增益集以協助保護您的安全。若要繼續使用此增益集，請確認此專案是託管在受信任的網域中，或在 Office 傳統型應用程式中開啟它。";
...
Strings.OfficeOM.L_UserAbortedMessage = "使用者未同意增益集權限。";
...
Strings.OfficeOM.L_WriteNotSupportedWhenModalDialogOpen = "開啟強制回應對話方塊時，Office 不支援寫入作業。";