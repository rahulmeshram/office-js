...
Strings.OfficeOM.L_ConfirmDialog = "Vertrouwt u het domein {0} waar deze Office-sessie wordt gehost?";
...
Strings.OfficeOM.L_NotTrustedWAC = "Deze invoegtoepassing is uitgeschakeld om u te helpen uw veiligheid te beschermen. Als u de invoegtoepassing wilt blijven gebruiken, controleert u of dit item wordt gehost in een vertrouwd domein of opent in de Office Desktop-app.";
...
Strings.OfficeOM.L_PropertyNotLoaded = "De eigenschap {0} is niet beschikbaar. Voordat u de waarde van de eigenschap leest, roept u de laadmethode aan in het containerobject en context.sync() in de bijbehorende aanvraagcontext.";
...
Strings.OfficeOM.L_SSOClientError = "Er is een fout opgetreden in de verificatieaanvraag van Office.";
...
Strings.OfficeOM.L_ShowWindowDialogNotification = "Er wordt een nieuw venster geopend in {0}.";
Strings.OfficeOM.L_ShowWindowDialogNotificationAllow = "Toestaan";
