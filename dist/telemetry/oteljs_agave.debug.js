var oteljs_agave = function(modules) {
    ...
    var Enums_1 = __webpack_require__(0);
    var AWTQueueManager_1 = __webpack_require__(9);
    ...
    var AWTSemanticContext_1 = __webpack_require__(10);
    ...
    var AWTAutoCollection_1 = __webpack_require__(11);
    var Enums_1 = __webpack_require__(0);
    var Enums_2 = __webpack_require__(6);
    ...
    var AWTQueueManager = __webpack_require__(9);
    ...
    function initialize(configuration, ariaSinkProperties) {
        if (!awtInitialized) {
            hookUpAriaNotifications(ariaSinkProperties);
            AriaSDK["AWTLogManager"].initialize(ARIA_INIT_TOKEN, configuration);
            awtInitialized = true;
        }
    }
    function hookUpAriaNotifications(ariaSinkProperties) {
        if (ariaSinkProperties && ariaSinkProperties.notificationListener) {
            AriaSDK["AWTLogManager"].addNotificationListener(ariaSinkProperties.notificationListener);
        }
    ...
    var sendEventsForPriorityAndAboveActual;
    var statsCallback;
    function instrumentDeliveryTask(callback) {
        ...
        sendEventsForPriorityAndAboveActual = queueManager.sendEventsForPriorityAndAbove.bind(queueManager);
        queueManager.sendEventsForPriorityAndAbove = sendEventsForPriorityAndAboveWrapper;
        statsCallback = callback;
        return true;
    }
    function sendEventsForPriorityAndAboveWrapper(priority) {
        var duration;
        var startTime = performance.now();
        sendEventsForPriorityAndAboveActual(priority);
    ...
    var AriaSink_AriaSink = function() {
        function AriaSink(additionalDataFields, cacheMemorySizeLimitInNumberOfEvents, ariaSinkProperties) {
            ...
            initialize(this.getAWTLogConfiguration(cacheMemorySizeLimitInNumberOfEvents, ariaSinkProperties), ariaSinkProperties);
        }
