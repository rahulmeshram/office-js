var oteljs_agave = function(modules) {
    ...
    var AWTTransmissionManagerCore_1 = __webpack_require__(2);
    ...
    function isTelemetryApiSetSupported() {
        return typeof Office === "object" && typeof Office.context === "object" && typeof Office.context.requirements === "object" && typeof Office.context.requirements.isSetSupported === "function" && Office.context.requirements.isSetSupported("TelemetryApi", 1.1);
    }
    function sendTestEvent() {
        return __awaiter(this, void 0, void 0, function() {
            var ctx, telemetryProperties, e_2;
            return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                  ...
                  case 3:
                    _a.sent();
                    _sentFirstEvent = true;
                    return [ 3, 5 ];

                  case 4:
                    e_2 = _a.sent();
                    if (typeof e_2 === "object" && e_2.code === "InvalidArgument") {
                        logNotification(LogLevel.Info, Category.Sink, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    if (!_queue) {
                        _queue = new RichApiSendEvent_WorkQueue(processTelemetryEvents);
                    }
                    _queue.add(event);
                    return [ 2 ];
                }
    ...
    var RichApiSendEvent_WorkQueue = function() {
    ...
    function pauseIfNecessary() {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                    if (!!_sentFirstEvent) return [ 3, 2 ];
                    return [ 4, pause(_minimumMillisecondsBeforeFirstCall) ];
    ...
    var AWTTransmissionManagerCore = __webpack_require__(2);
    ...
    function getAriaEvent(telemetryEvent, additionalDataFields, timestamp) {
        ...
        if (telemetryEvent.eventContract) {
            ...
            GetAriaEvent_addDataFields(ariaEvent, telemetryEvent.eventContract.dataFields, false);
        }
        GetAriaEvent_addDataFields(ariaEvent, additionalDataFields, false);
        GetAriaEvent_addDataFields(ariaEvent, telemetryEvent.dataFields, true);
        return ariaEvent;
    }
    function GetAriaEvent_addDataFields(ariaEvent, fields, prependDataToken) {
        if (fields) {
        ...
        AriaSink.prototype.sendTelemetryEvent = function(event, timestamp) {
            try {
                this._preprocessors.forEach(function(preprocessor) {
                    preprocessor.processEvent(event);
                });
    ...
    var AgaveSink_AgaveSink = function() {
        ...
        AgaveSink.prototype.initialize = function() {
            if (isWacAgave() || typeof Promise === "undefined") {
                ...
                this.initializeWithPromises();
            }
        };
        AgaveSink.prototype.initializeWithPromises = function() {
