var oteljs_agave = function(modules) {
    ...
    var Enums_1 = __webpack_require__(0);
    var AWTHttpManager_1 = __webpack_require__(19);
    var AWTTransmissionManagerCore_1 = __webpack_require__(4);
    var AWTRecordBatcher_1 = __webpack_require__(29);
    ...
    var Bond = __webpack_require__(20);
    var Enums_1 = __webpack_require__(0);
    var AWTNotificationManager_1 = __webpack_require__(5);
    var Utils = __webpack_require__(3);
    ...
    var AWTKillSwitch_1 = __webpack_require__(27);
    var AWTClockSkewManager_1 = __webpack_require__(28);
    var Version = __webpack_require__(16);
    var Utils = __webpack_require__(3);
    var AWTNotificationManager_1 = __webpack_require__(5);
    var AWTTransmissionManagerCore_1 = __webpack_require__(4);
    ...
    var microsoft_bond_primitives_1 = __webpack_require__(8);
    var microsoft_bond_floatutils_1 = __webpack_require__(23);
    var microsoft_bond_utils_1 = __webpack_require__(24);
    ...
    var TelemetryContext_TelemetryContext = function() {
        ...
        TelemetryContext.setTelemetryContext = function(steContext) {
            this._steContext = steContext;
        };
        TelemetryContext.getDataFieldsFromContext = function() {
            var _this = this;
            var additionalDataFields = [];
            Object.keys(this._steContext).forEach(function(key) {
        ...
        TelemetryContext.isWacAgave = function() {
            return this._steContext["App.Platform"] === "Web";
        };
        TelemetryContext._steContext = {};
    ...
    var RichApiHelper_RichApiHelper = function() {
        ...
        RichApiHelper.prototype.processWorkBacklog = function() {
            ...
            this.pauseIfNecessary().then(function() {
                ...
                logError(Category.Sink, "RichApiSink Error", error);
                _this.waitAndProcessMore();
            });
        };
        ...
        RichApiHelper.prototype.processTelemetryEvents = function(telemetryEvents) {
            ...
            if (this._sentFirstEvent) {
                ctx.sync().catch(function(e) {
                    logError(Category.Sink, "RichApiError", e);
                });
            } else {
                this._sentFirstEvent = true;
                ctx.sync().then(function() {
                    if (_this._onSentFirstEvent) {
                        _this._onSentFirstEvent(true);
                    }
                }).catch(function() {
        ...
        RichApiHelper.prototype.pauseIfNecessary = function() {
            ...
            return Office.Promise.resolve(undefined);
        };
        return RichApiHelper;
    }();
    function pause(ms) {
    ...
    var RichApiSink_RichApiSink = function() {
        ...
        RichApiSink._richApiHelper = new RichApiHelper_RichApiHelper();
        return RichApiSink;
    }();
    function isWacAgave() {
    ...
    var OutlookSink_OutlookSink = function() {
        function OutlookSink() {
            ...
            if (platform === "iOS" || platform === "Android") {
                this._contextDataFields = TelemetryContext_TelemetryContext.getDataFieldsFromContext();
            }
        }
    ...
    var _sendEventEnabled = false;
    function enableAria(sendEventEnabled) {
    ...
    function canSendToAria() {
        ...
        var platform = TelemetryContext_TelemetryContext.getAppPlatform();
        var version = TelemetryContext_TelemetryContext.getAppVersion();
        var appName = TelemetryContext_TelemetryContext.getAppName();
    ...
    function getAriaSinkAsync(additionalDataFields, callback) {
        callback(new AriaSink_AriaSink(additionalDataFields));
    }
    var E_TELEMETRY_DISABLED = "AppTelemetry is disabled for this platform.";
    var E_NO_SINK_AVAILABLE = "AgaveSink has no available sink";
    var AgaveSink_AgaveSink = function() {
        function AgaveSink(steContext, ariaSendEventEnabled, onReady) {
            this._onReady = onReady;
            TelemetryContext_TelemetryContext.setTelemetryContext(steContext);
            enableAria(ariaSendEventEnabled);
            this.initialize();
        }
        AgaveSink.createInstance = function(steContext, ariaSendEventEnabled) {
            if (steContext === void 0) {
                steContext = {};
            }
        ...
        AgaveSink.prototype.initialize = function() {
            if (!this.isTelemetryEnabled()) {
                return this.failToInitialize(E_TELEMETRY_DISABLED);
            }
            if (RichApiSink_RichApiSink.isSupportedByDeclaration()) {
                this.connectRichApiSink();
            } else if (OutlookSink_OutlookSink.isSupported()) {
                this.connectSink("OutlookSink", new OutlookSink_OutlookSink());
            } else if (TelemetryContext_TelemetryContext.isWacAgave() && SdxWacSink_SdxWacSink.isSupported()) {
                this.connectSink("SdxWacSink", new SdxWacSink_SdxWacSink());
            } else if (RichApiSink_RichApiSink.isUnsupported()) {
                if (canSendToAria()) {
                    this.connectAriaSink();
                } else {
                    return this.failToInitialize();
                }
            } else {
                RichApiSink_RichApiSink.isSupportedAsync(this.onRichApiSupportedAsync.bind(this));
            }
        };
        ...
        AgaveSink.prototype.failToInitialize = function(reason) {
            var errorMessage = reason ? reason : E_NO_SINK_AVAILABLE;
            logNotification(LogLevel.Error, Category.Sink, function() {
                return errorMessage;
            });
            if (this._onReady) {
        ...
        AgaveSink.prototype.connectAriaSink = function() {
            var _this = this;
            getAriaSinkAsync(TelemetryContext_TelemetryContext.getDataFieldsFromContext(), function(ariaSink) {
                if (ariaSink) {
                    _this.connectSink("AriaSink", ariaSink);
                } else {
                    _this.failToInitialize();
                }
            });
        };
        AgaveSink.prototype.isTelemetryEnabled = function() {
            if (typeof OSF !== "undefined" && typeof OSF.AppTelemetry !== "undefined" && typeof OSF.AppTelemetry.enableTelemetry === "boolean" && OSF.AppTelemetry.enableTelemetry) {
                return true;
            }
