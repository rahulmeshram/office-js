...
_u.ExtensibilityStrings.l_CannotPersistPropertyInUnsavedDraftError_Text = "Уведомления невозможно сохранять в несохраненных черновиках. Сохраните элемент перед вызовом API.";
...
_u.ExtensibilityStrings.l_Duplicate_Category_Error_Text = "Одна из указанных категорий уже добавлена в основной список категорий.";
...
_u.ExtensibilityStrings.l_InvalidCommandIdError_Text = "Параметр commandId имеет недопустимое значение.";
...
_u.ExtensibilityStrings.l_InvalidParameterValueError_Text = "Параметр {0} имеет недопустимое значение.";
