...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.11427.10000";
				...
				resultPromise.then(function () {
					...
					Microsoft.Office.WebExtension.sendTelemetryEvent({
						...
						dataFields: [
							oteljs.makeStringDataField('identityProvider', OSFWebAuth.config.idp),
							oteljs.makeBooleanDataField('popup', (typeof popup==="boolean") ? popup : null),
							oteljs.makeBooleanDataField('result', false),
							oteljs.makeStringDataField('error', failure.ErrorCode)
						],
						eventFlags: {
							dataCategories: oteljs.DataCategories.ProductServiceUsage
						}
			...
			try {
				...
				Office.context.webAuth.getAuthContextAsync(function (result) {
					if (result.status==="succeeded") {
						...
						authContext.authority="https://login.windows-ppe.net/";
						var config={
