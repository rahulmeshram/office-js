...
// Sources:
// osfweb: custom
// runtime: 16.0.11311.30005
// core: 16.0\11314.10000
// host: 16.0\11314.10000
	...
	function initialize() {
		var callback=function () {
			Microsoft.Office.WebExtension.onReadyInternal().then(function () {
				return function () {
					if (typeof Implicit.Load !=="undefined") {
						Implicit.Load({
							idp: 'aad',
							aadConfig: {
		...
		OSF.OUtil.loadScript(OSF._OfficeAppFactory.getLoadScriptHelper().getOfficeJsBasePath()+CDN_PATH_WEBAUTHJS, callback, 1000);
	}
