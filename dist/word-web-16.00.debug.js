...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.11414.30000";
...
(function (OfficeFirstPartyAuth) {
	var ErrorCode=(function () {
		...
		ErrorCode.NoAuthContext="NoAuthContext";
	...
	var ErrorMessage=(function () {
		...
		ErrorMessage.NoAuthContext=(Strings && Strings.OfficeOM.L_ImplicitNoAuthContext) ? Strings.OfficeOM.L_ImplicitNoAuthContext : ErrorCode.NoAuthContext;
		ErrorMessage.NotLoaded=(Strings && Strings.OfficeOM.L_ImplicitNotLoaded) ? Strings.OfficeOM.L_ImplicitNotLoaded : ErrorCode.NotLoaded;
		return ErrorMessage;
	}());
		...
		if (OSF.WebAuth && OSF._OfficeAppFactory.getHostInfo().hostPlatform=="web") {
			return new OfficeExtension.CoreUtility.Promise(function (resolve, reject) {
				if (!retrievedAuthContext) {
					reject({ code: ErrorCode.NoAuthContext, message: ErrorMessage.NoAuthContext });
				}
				if (!OSF.WebAuth.loaded) {
					reject({ code: ErrorCode.NotLoaded, message: ErrorMessage.NotLoaded });
				}
