...
(function (OSFAriaLogger) {
	...
	var AriaLogger=(function () {
		...
		AriaLogger.EnableSendingTelemetryWithOTel=false;
		return AriaLogger;
	})();
...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.11305.10000";
...
++scalarPropCount;
	...
	var OperationalApiHelper=(function () {
		...
		OperationalApiHelper.invokeRetrieve=function (obj, select) {
			...
			var option=OperationalApiHelper._parseSelectOption(select);
		...
		OperationalApiHelper.invokeRecursiveUpdate=function (obj, properties) {
			return CoreUtility.createPromise(function (resolve) {
...
(function (Word) {
	...
	var AnnotationCollection=(function (_super) {
		...
		AnnotationCollection.prototype.getByType=function (annotationType) {
			return _createMethodObject(Word.AnnotationCollection, this, "GetByType", 0, [annotationType], true, false, null, 0);
		};
	...
	var Document=(function (_super) {
		...
		Object.defineProperty(Document.prototype, "_navigationPropertyNames", {
			get: function () {
				return ["sections", "body", "contentControls", "properties", "settings", "customXmlParts", "annotations"];
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Document.prototype, "annotations", {
			get: function () {
				if (!this._An) {
					this._An=_createPropertyObject(Word.AnnotationCollection, this, "Annotations", true, 4);
				}
				return this._An;
			},
			enumerable: true,
		...
		Document.prototype._handleResult=function (value) {
			...
			_handleNavigationPropertyResults(this, obj, ["annotations", "Annotations", "body", "Body", "contentControls", "ContentControls", "customXmlParts", "CustomXmlParts", "properties", "Properties", "sections", "Sections", "settings", "Settings"]);
		};
	...
	var Paragraph=(function (_super) {
		...
		Object.defineProperty(Paragraph.prototype, "_navigationPropertyNames", {
			get: function () {
				return ["font", "contentControls", "parentContentControl", "inlinePictures", "parentBody", "list", "parentTableCell", "parentTable", "listItem", "parentContentControlOrNullObject", "parentTableCellOrNullObject", "parentTableOrNullObject", "listOrNullObject", "listItemOrNullObject", "annotations"];
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Paragraph.prototype, "annotations", {
			get: function () {
				if (!this._An) {
					this._An=_createPropertyObject(Word.AnnotationCollection, this, "Annotations", true, 4);
				}
		...
		Paragraph.prototype._handleResult=function (value) {
			...
			_handleNavigationPropertyResults(this, obj, ["annotations", "Annotations", "contentControls", "ContentControls", "font", "Font", "inlinePictures", "InlinePictures", "list", "List", "listItem", "ListItem", "listItemOrNullObject", "ListItemOrNullObject", "listOrNullObject", "ListOrNullObject", "parentBody", "ParentBody", "parentContentControl", "ParentContentControl", "parentContentControlOrNullObject", "ParentContentControlOrNullObject", "parentTable", "ParentTable", "parentTableCell", "ParentTableCell", "parentTableCellOrNullObject", "ParentTableCellOrNullObject", "parentTableOrNullObject", "ParentTableOrNullObject"]);
		};
