...
// runtime: 16.0.11511.30005
// core: 16.0\11519.10000
// host: 16.0\11519.10000
...
OSF.CommonUI={
	HostButtonBorderColor: "#a3bde3",
	HostButtonBackgroundColor: "#d5e1f2"
};
var OSFLog;
(function (OSFLog) {
...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.11519.10000";
...
(function (OSFWebAuth) {
	...
	OSFWebAuth.config=null;
	function load(callback) {
		OSF.OUtil.loadScript(OSF._OfficeAppFactory.getLoadScriptHelper().getOfficeJsBasePath()+CDN_PATH_WEBAUTHJS, function () {
			if (OSFWebAuth.config) {
				Implicit.Load(OSFWebAuth.config);
				OSFWebAuth.loaded=true;
			}
			else {
				Implicit.GetAuthConfig().then(function (configParent) {
					...
					OSFWebAuth.loaded=false;
				});
			}
			if (callback) {
				callback(OSFWebAuth.loaded);
			}
		});
	}
	OSFWebAuth.load=load;
	function getToken(target, popup) {
		if (!OSFWebAuth.loaded)
			return null;
		if (typeof popup==="boolean") {
			return Implicit.GetToken(target, popup);
		}
		else {
			return Implicit.GetToken(target);
		}
	}
	...
	OSFWebAuth.clearCache=clearCache;
...
(function (OSFWordWAC) {
	var WordDocument=(function () {
		function WordDocument(officeAppContext, settings) {
			...
			OSF.DDA.DispIdHost.addEventSupport(this, new OSF.EventDispatch([
				Microsoft.Office.WebExtension.EventType.BindingSelectionChanged,
			]));
			OSF.DDA.DispIdHost.addEventSupport(this, new OSF.EventDispatch([
				Microsoft.Office.WebExtension.EventType.DataNodeInserted,
			]));
			OSF.DDA.DispIdHost.addEventSupport(this, new OSF.EventDispatch([
				Microsoft.Office.WebExtension.EventType.DataNodeReplaced,
			]));
			OSF.DDA.DispIdHost.addEventSupport(this, new OSF.EventDispatch([
				Microsoft.Office.WebExtension.EventType.DataNodeDeleted,
			]));
...
OSF.InitializationHelper.prototype.prepareRightBeforeWebExtensionInitialize=function OSF_InitializationHelper$prepareRightBeforeWebExtensionInitialize(appContext) {
	...
	if (!appContext.get_isDialog() && OSF.AdditionalPostContextSettingOverride) {
		OSF.AdditionalPostContextSettingOverride();
	}
...
(function (Word) {
	...
	var _adjustToDateTime=OfficeExtension.Utility.adjustToDateTime;
	var _processRetrieveResult=OfficeExtension.Utility.processRetrieveResult;
	var _typeAnnotation="Annotation";
	var Annotation=(function (_super) {
		__extends(Annotation, _super);
		function Annotation() {
			return _super !==null && _super.apply(this, arguments) || this;
		}
		Object.defineProperty(Annotation.prototype, "_className", {
			get: function () {
				return "Annotation";
			},
			enumerable: true,
		...
		Object.defineProperty(Annotation.prototype, "_ReferenceId", {
			get: function () {
				_throwIfNotLoaded("_ReferenceId", this.__R, _typeAnnotation, this._isNull);
				return this.__R;
			},
			enumerable: true,
			configurable: true
		...
		Annotation.prototype.load=function (option) {
			return _load(this, option);
		};
		Annotation.prototype.retrieve=function (option) {
			return _retrieve(this, option);
		};
		Annotation.prototype._handleIdResult=function (value) {
			_super.prototype._handleIdResult.call(this, value);
			if (_isNullOrUndefined(value)) {
				return;
			}
	...
	var _typeAnnotationCollection="AnnotationCollection";
	var AnnotationCollection=(function (_super) {
		__extends(AnnotationCollection, _super);
		function AnnotationCollection() {
			return _super !==null && _super.apply(this, arguments) || this;
		}
		Object.defineProperty(AnnotationCollection.prototype, "_className", {
			get: function () {
		...
		Object.defineProperty(AnnotationCollection.prototype, "_isCollection", {
			get: function () {
				return true;
			},
			enumerable: true,
		...
		Object.defineProperty(AnnotationCollection.prototype, "_scalarPropertyNames", {
			get: function () {
				return ["_ReferenceId"];
			},
			enumerable: true,
		...
		Object.defineProperty(AnnotationCollection.prototype, "items", {
			get: function () {
				_throwIfNotLoaded("items", this.m__items, _typeAnnotationCollection, this._isNull);
				return this.m__items;
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(AnnotationCollection.prototype, "_ReferenceId", {
			get: function () {
				_throwIfNotLoaded("_ReferenceId", this.__R, _typeAnnotationCollection, this._isNull);
				return this.__R;
			},
			enumerable: true,
			configurable: true
		});
		AnnotationCollection.prototype.getFirst=function () {
			return _createMethodObject(Word.Annotation, this, "GetFirst", 1, [], false, false, null, 4);
		};
		AnnotationCollection.prototype.getFirstOrNullObject=function () {
			return _createMethodObject(Word.Annotation, this, "GetFirstOrNullObject", 1, [], false, false, null, 4);
		};
		...
		AnnotationCollection.prototype._handleResult=function (value) {
			_super.prototype._handleResult.call(this, value);
			if (_isNullOrUndefined(value))
				return;
			var obj=value;
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.Annotation, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		};
		AnnotationCollection.prototype.load=function (option) {
			return _load(this, option);
		};
		AnnotationCollection.prototype.retrieve=function (option) {
			return _retrieve(this, option);
		};
		AnnotationCollection.prototype._handleIdResult=function (value) {
			_super.prototype._handleIdResult.call(this, value);
			if (_isNullOrUndefined(value)) {
				return;
			}
		...
		AnnotationCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.Annotation, true, _this, childItemData, index); });
		};
		Object.defineProperty(AnnotationCollection.prototype, "onAnnotationAdded", {
			get: function () {
				var _this=this;
				if (!this.m_annotationAdded) {
					this.m_annotationAdded=new OfficeExtension.GenericEventHandlers(this.context, this, "AnnotationAdded", {
						eventType: 4,
						registerFunc: function () { _this.context.document._RegisterEvent(_this._ReferenceId, "AnnotationAdded"); },
						unregisterFunc: function () { _this.context.document._UnregisterEvent(_this._ReferenceId, "AnnotationAdded"); },
						getTargetIdFunc: function () { return _this._ReferenceId; },
						eventArgsTransformFunc: function (args) {
							var evt={
								eventType: Word.EventType.annotationAdded,
								annotation: OfficeExtension.BatchApiHelper.createObjectFromReferenceId(Word.Annotation, _this.context, args)
							};
							evt.annotation.load();
				...
				return this.m_annotationAdded;
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(AnnotationCollection.prototype, "onAnnotationChanged", {
			get: function () {
				var _this=this;
				if (!this.m_annotationChanged) {
					this.m_annotationChanged=new OfficeExtension.GenericEventHandlers(this.context, this, "AnnotationChanged", {
						eventType: 5,
						registerFunc: function () { _this.context.document._RegisterEvent(_this._ReferenceId, "AnnotationChanged"); },
						unregisterFunc: function () { _this.context.document._UnregisterEvent(_this._ReferenceId, "AnnotationChanged"); },
						getTargetIdFunc: function () { return _this._ReferenceId; },
						eventArgsTransformFunc: function (args) {
							var evt={
				...
				return this.m_annotationChanged;
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(AnnotationCollection.prototype, "onAnnotationDeleted", {
			get: function () {
				var _this=this;
				if (!this.m_annotationDeleted) {
					this.m_annotationDeleted=new OfficeExtension.GenericEventHandlers(this.context, this, "AnnotationDeleted", {
						eventType: 6,
						registerFunc: function () { _this.context.document._RegisterEvent(_this._ReferenceId, "AnnotationDeleted"); },
						unregisterFunc: function () { _this.context.document._UnregisterEvent(_this._ReferenceId, "AnnotationDeleted"); },
						getTargetIdFunc: function () { return _this._ReferenceId; },
						eventArgsTransformFunc: function (args) {
							var evt={
				...
				return this.m_annotationDeleted;
			},
			enumerable: true,
			configurable: true
		});
		AnnotationCollection.prototype.track=function () {
			this.context.trackedObjects.add(this);
			return this;
		};
		AnnotationCollection.prototype.untrack=function () {
			this.context.trackedObjects.remove(this);
			return this;
		};
		AnnotationCollection.prototype.toJSON=function () {
			return _toJson(this, {}, {}, this.m__items);
		};
		return AnnotationCollection;
	}(OfficeExtension.ClientObject));
	Word.AnnotationCollection=AnnotationCollection;
	...
	var Application=(function (_super) {
		...
		Application.prototype.createDocument=function (base64File) {
			return _createMethodObject(Word.DocumentCreated, this, "CreateDocument", 1, [base64File], false, false, null, 4);
		};
		Application.prototype.getEnterpriseUserInfo=function () {
			return _invokeMethod(this, "GetEnterpriseUserInfo", 1, [], 4 | 1, 0);
		};
		Application.prototype.getMruFriendlyPath=function (documentUrl) {
			return _invokeMethod(this, "GetMruFriendlyPath", 1, [documentUrl], 4 | 1, 0);
		};
		Application.prototype.getSharePointTenantRoot=function () {
			return _invokeMethod(this, "GetSharePointTenantRoot", 1, [], 4 | 1, 0);
		};
		Application.prototype.isTapEnabled=function () {
			return _invokeMethod(this, "IsTapEnabled", 1, [], 4 | 1, 0);
		};
		Application.prototype.launchFileUrlInOfficeApp=function (documentUrl, useUniversalAsBackUp) {
			return _invokeMethod(this, "LaunchFileUrlInOfficeApp", 1, [documentUrl, useUniversalAsBackUp], 4 | 1, 0);
		};
		...
		Application.newObject=function (context) {
			return _createTopLevelServiceObject(Word.Application, context, "Microsoft.WordServices.Application", false, 4);
		};
	...
	var Body=(function (_super) {
		...
		Object.defineProperty(Body.prototype, "contentControls", {
			get: function () {
				if (!this._C) {
					this._C=_createPropertyObject(Word.ContentControlCollection, this, "ContentControls", true, 4);
				}
				return this._C;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "font", {
			get: function () {
				if (!this._F) {
					this._F=_createPropertyObject(Word.Font, this, "Font", false, 4);
				}
				return this._F;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "inlinePictures", {
			get: function () {
				if (!this._I) {
					this._I=_createPropertyObject(Word.InlinePictureCollection, this, "InlinePictures", true, 4);
				}
				return this._I;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "lists", {
			get: function () {
				...
				if (!this._L) {
					this._L=_createPropertyObject(Word.ListCollection, this, "Lists", true, 4);
				}
				return this._L;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "paragraphs", {
			get: function () {
				if (!this._P) {
					this._P=_createPropertyObject(Word.ParagraphCollection, this, "Paragraphs", true, 4);
				}
				return this._P;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "parentBody", {
			get: function () {
				...
				if (!this._Pa) {
					this._Pa=_createPropertyObject(Word.Body, this, "ParentBody", false, 4);
				}
				return this._Pa;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "parentBodyOrNullObject", {
			get: function () {
				...
				if (!this._Par) {
					this._Par=_createPropertyObject(Word.Body, this, "ParentBodyOrNullObject", false, 4);
				}
				return this._Par;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "parentContentControl", {
			get: function () {
				if (!this._Pare) {
					this._Pare=_createPropertyObject(Word.ContentControl, this, "ParentContentControl", false, 4);
				}
				return this._Pare;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "parentContentControlOrNullObject", {
			get: function () {
				...
				if (!this._Paren) {
					this._Paren=_createPropertyObject(Word.ContentControl, this, "ParentContentControlOrNullObject", false, 4);
				}
				return this._Paren;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "parentSection", {
			get: function () {
				...
				if (!this._Parent) {
					this._Parent=_createPropertyObject(Word.Section, this, "ParentSection", false, 4);
				}
				return this._Parent;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "parentSectionOrNullObject", {
			get: function () {
				...
				if (!this._ParentS) {
					this._ParentS=_createPropertyObject(Word.Section, this, "ParentSectionOrNullObject", false, 4);
				}
		...
		Object.defineProperty(Body.prototype, "tables", {
			get: function () {
				...
				if (!this._T) {
					this._T=_createPropertyObject(Word.TableCollection, this, "Tables", true, 4);
				}
				return this._T;
			},
			enumerable: true,
		...
		Object.defineProperty(Body.prototype, "styleBuiltIn", {
			...
			set: function (value) {
				this._St=value;
				_invokeSetProperty(this, "StyleBuiltIn", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		Body.prototype.getOoxml=function () {
			return _invokeMethod(this, "GetOoxml", 1, [], 4, 0);
		};
		...
		Body.prototype.insertBreak=function (breakType, insertLocation) {
			_invokeMethod(this, "InsertBreak", 0, [breakType, insertLocation], 0, 0);
		};
		Body.prototype.insertContentControl=function () {
			return _createMethodObject(Word.ContentControl, this, "InsertContentControl", 0, [], false, true, null, 0);
		};
		Body.prototype.insertFileFromBase64=function (base64File, insertLocation) {
			return _createMethodObject(Word.Range, this, "InsertFileFromBase64", 0, [base64File, insertLocation], false, true, null, 0);
		};
		Body.prototype.insertHtml=function (html, insertLocation) {
			return _createMethodObject(Word.Range, this, "InsertHtml", 0, [html, insertLocation], false, true, null, 0);
		};
		Body.prototype.insertInlinePictureFromBase64=function (base64EncodedImage, insertLocation) {
			...
			return _createMethodObject(Word.InlinePicture, this, "InsertInlinePictureFromBase64", 0, [base64EncodedImage, insertLocation], false, true, null, 0);
		};
		Body.prototype.insertOoxml=function (ooxml, insertLocation) {
			return _createMethodObject(Word.Range, this, "InsertOoxml", 0, [ooxml, insertLocation], false, true, null, 0);
		};
		Body.prototype.insertParagraph=function (paragraphText, insertLocation) {
			return _createMethodObject(Word.Paragraph, this, "InsertParagraph", 0, [paragraphText, insertLocation], false, true, null, 0);
		};
		Body.prototype.insertTable=function (rowCount, columnCount, insertLocation, values) {
			...
			return _createMethodObject(Word.Table, this, "InsertTable", 0, [rowCount, columnCount, insertLocation, values], false, true, null, 0);
		};
		Body.prototype.insertText=function (text, insertLocation) {
			return _createMethodObject(Word.Range, this, "InsertText", 0, [text, insertLocation], false, true, null, 0);
		};
		Body.prototype.search=function (searchText, searchOptions) {
			searchOptions=_normalizeSearchOptions(this.context, searchOptions);
			return _createMethodObject(Word.RangeCollection, this, "Search", 1, [searchText, searchOptions], true, false, null, 4);
		};
		Body.prototype.select=function (selectionMode) {
			_invokeMethod(this, "Select", 1, [selectionMode], 4, 0);
		};
	...
	var ContentControl=(function (_super) {
		...
		Object.defineProperty(ContentControl.prototype, "contentControls", {
			get: function () {
				if (!this._Con) {
					this._Con=_createPropertyObject(Word.ContentControlCollection, this, "ContentControls", true, 4);
				}
				return this._Con;
			},
			enumerable: true,
		...
		Object.defineProperty(ContentControl.prototype, "inlinePictures", {
			get: function () {
				if (!this._In) {
					this._In=_createPropertyObject(Word.InlinePictureCollection, this, "InlinePictures", true, 4);
				}
				return this._In;
			},
			enumerable: true,
		...
		Object.defineProperty(ContentControl.prototype, "parentContentControl", {
			get: function () {
				if (!this._Par) {
					this._Par=_createPropertyObject(Word.ContentControl, this, "ParentContentControl", false, 4);
				}
				return this._Par;
			},
			enumerable: true,
		...
		Object.defineProperty(ContentControl.prototype, "parentContentControlOrNullObject", {
			get: function () {
				...
				if (!this._Pare) {
					this._Pare=_createPropertyObject(Word.ContentControl, this, "ParentContentControlOrNullObject", false, 4);
				}
				return this._Pare;
			},
			enumerable: true,
		...
		Object.defineProperty(ContentControl.prototype, "parentTable", {
			get: function () {
				...
				if (!this._Paren) {
					this._Paren=_createPropertyObject(Word.Table, this, "ParentTable", false, 4);
				}
				return this._Paren;
			},
			enumerable: true,
		...
		Object.defineProperty(ContentControl.prototype, "parentTableCell", {
			get: function () {
				...
				if (!this._Parent) {
					this._Parent=_createPropertyObject(Word.TableCell, this, "ParentTableCell", false, 4);
				}
				return this._Parent;
			},
			enumerable: true,
		...
		Object.defineProperty(ContentControl.prototype, "parentTableCellOrNullObject", {
			get: function () {
				...
				if (!this._ParentT) {
					this._ParentT=_createPropertyObject(Word.TableCell, this, "ParentTableCellOrNullObject", false, 4);
				}
		...
		Object.defineProperty(ContentControl.prototype, "parentTableOrNullObject", {
			get: function () {
				...
				if (!this._ParentTa) {
					this._ParentTa=_createPropertyObject(Word.Table, this, "ParentTableOrNullObject", false, 4);
				}
		...
		Object.defineProperty(ContentControl.prototype, "appearance", {
			...
			set: function (value) {
				this._A=value;
				_invokeSetProperty(this, "Appearance", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(ContentControl.prototype, "cannotDelete", {
			...
			set: function (value) {
				this._C=value;
				_invokeSetProperty(this, "CannotDelete", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(ContentControl.prototype, "cannotEdit", {
			...
			set: function (value) {
				this._Ca=value;
				_invokeSetProperty(this, "CannotEdit", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(ContentControl.prototype, "placeholderText", {
			...
			set: function (value) {
				this._Pl=value;
				_invokeSetProperty(this, "PlaceholderText", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(ContentControl.prototype, "removeWhenEdited", {
			...
			set: function (value) {
				this._R=value;
				_invokeSetProperty(this, "RemoveWhenEdited", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(ContentControl.prototype, "tag", {
			...
			set: function (value) {
				this._Ta=value;
				_invokeSetProperty(this, "Tag", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		ContentControl.prototype["delete"]=function (keepContent) {
			_invokeMethod(this, "Delete", 0, [keepContent], 0, 0);
		};
		...
		ContentControl.prototype.split=function (delimiters, multiParagraphs, trimDelimiters, trimSpacing) {
			...
			return _createMethodObject(Word.RangeCollection, this, "Split", 1, [delimiters, multiParagraphs, trimDelimiters, trimSpacing], true, false, null, 4);
		};
		...
		Object.defineProperty(ContentControl.prototype, "onDataChanged", {
			get: function () {
				var _this=this;
				_throwIfApiNotSupported("ContentControl.onDataChanged", _defaultApiSetName, "1.4", _hostName);
				if (!this.m_dataChanged) {
					this.m_dataChanged=new OfficeExtension.GenericEventHandlers(this.context, this, "DataChanged", {
						eventType: 2,
						registerFunc: function () { _this.context.document._RegisterEvent(_this._ReferenceId, "ContentControlDataChanged"); },
						unregisterFunc: function () { _this.context.document._UnregisterEvent(_this._ReferenceId, "ContentControlDataChanged"); },
						getTargetIdFunc: function () { return _this._ReferenceId; },
						eventArgsTransformFunc: function (args) {
							var evt={
								eventType: Word.EventType.contentControlDataChanged,
								contentControl: _this
							};
							return OfficeExtension.Utility._createPromiseFromResult(evt);
						}
					});
		...
		Object.defineProperty(ContentControl.prototype, "onDeleted", {
			get: function () {
				var _this=this;
				_throwIfApiNotSupported("ContentControl.onDeleted", _defaultApiSetName, "1.4", _hostName);
				if (!this.m_deleted) {
					this.m_deleted=new OfficeExtension.GenericEventHandlers(this.context, this, "Deleted", {
						eventType: 0,
						registerFunc: function () { _this.context.document._RegisterEvent(_this._ReferenceId, "ContentControlDeleted"); },
						unregisterFunc: function () { _this.context.document._UnregisterEvent(_this._ReferenceId, "ContentControlDeleted"); },
						getTargetIdFunc: function () { return _this._ReferenceId; },
						eventArgsTransformFunc: function (args) {
							var evt={
		...
		Object.defineProperty(ContentControl.prototype, "onSelectionChanged", {
			get: function () {
				var _this=this;
				_throwIfApiNotSupported("ContentControl.onSelectionChanged", _defaultApiSetName, "1.4", _hostName);
				if (!this.m_selectionChanged) {
					this.m_selectionChanged=new OfficeExtension.GenericEventHandlers(this.context, this, "SelectionChanged", {
						eventType: 1,
						registerFunc: function () { _this.context.document._RegisterEvent(_this._ReferenceId, "ContentControlSelectionChanged"); },
						unregisterFunc: function () { _this.context.document._UnregisterEvent(_this._ReferenceId, "ContentControlSelectionChanged"); },
						getTargetIdFunc: function () { return _this._ReferenceId; },
						eventArgsTransformFunc: function (args) {
							var evt={
	...
	var ContentControlCollection=(function (_super) {
		...
		ContentControlCollection.prototype.getById=function (id) {
			return _createMethodObject(Word.ContentControl, this, "GetById", 1, [id], false, false, null, 4);
		};
		ContentControlCollection.prototype.getByIdOrNullObject=function (id) {
			...
			return _createMethodObject(Word.ContentControl, this, "GetByIdOrNullObject", 1, [id], false, false, null, 4);
		};
		ContentControlCollection.prototype.getByTag=function (tag) {
			return _createMethodObject(Word.ContentControlCollection, this, "GetByTag", 1, [tag], true, false, null, 4);
		};
		ContentControlCollection.prototype.getByTitle=function (title) {
			return _createMethodObject(Word.ContentControlCollection, this, "GetByTitle", 1, [title], true, false, null, 4);
		};
		ContentControlCollection.prototype.getByTypes=function (types) {
			...
			return _createMethodObject(Word.ContentControlCollection, this, "GetByTypes", 1, [types], true, false, null, 4);
		};
		ContentControlCollection.prototype.getFirst=function () {
			...
			return _createMethodObject(Word.ContentControl, this, "GetFirst", 1, [], false, false, null, 4);
		};
		ContentControlCollection.prototype.getFirstOrNullObject=function () {
			...
			return _createMethodObject(Word.ContentControl, this, "GetFirstOrNullObject", 1, [], false, false, null, 4);
		};
		ContentControlCollection.prototype.getItem=function (index) {
			return _createIndexerObject(Word.ContentControl, this, [index]);
		};
		...
		ContentControlCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.ContentControl, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		ContentControlCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.ContentControl, true, _this, childItemData, index); });
		};
	...
	var CustomPropertyCollection=(function (_super) {
		...
		CustomPropertyCollection.prototype.add=function (key, value) {
			return _createMethodObject(Word.CustomProperty, this, "Add", 0, [key, value], false, true, null, 0);
		};
		...
		CustomPropertyCollection.prototype.getItem=function (key) {
			return _createIndexerObject(Word.CustomProperty, this, [key]);
		};
		CustomPropertyCollection.prototype.getItemOrNullObject=function (key) {
			return _createMethodObject(Word.CustomProperty, this, "GetItemOrNullObject", 1, [key], false, false, null, 4);
		};
		...
		CustomPropertyCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.CustomProperty, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		CustomPropertyCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.CustomProperty, true, _this, childItemData, index); });
		};
	...
	var CustomXmlPart=(function (_super) {
		...
		Object.defineProperty(CustomXmlPart.prototype, "_scalarPropertyNames", {
			get: function () {
				return ["_ReferenceId", "id", "namespaceUri"];
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(CustomXmlPart.prototype, "_ReferenceId", {
			get: function () {
				_throwIfNotLoaded("_ReferenceId", this.__R, _typeCustomXmlPart, this._isNull);
				return this.__R;
			},
			enumerable: true,
			configurable: true
		...
		CustomXmlPart.prototype.deleteAttribute=function (xpath, namespaceMappings, name) {
			_invokeMethod(this, "DeleteAttribute", 0, [xpath, namespaceMappings, name], 0, 0);
		};
		CustomXmlPart.prototype.deleteElement=function (xpath, namespaceMappings) {
			_invokeMethod(this, "DeleteElement", 0, [xpath, namespaceMappings], 0, 0);
		};
		...
		CustomXmlPart.prototype.insertAttribute=function (xpath, namespaceMappings, name, value) {
			_invokeMethod(this, "InsertAttribute", 0, [xpath, namespaceMappings, name, value], 0, 0);
		};
		CustomXmlPart.prototype.insertElement=function (xpath, xml, namespaceMappings, index) {
			_invokeMethod(this, "InsertElement", 0, [xpath, xml, namespaceMappings, index], 0, 0);
		};
		CustomXmlPart.prototype.query=function (xpath, namespaceMappings) {
			return _invokeMethod(this, "Query", 0, [xpath, namespaceMappings], 0, 0);
		};
		...
		CustomXmlPart.prototype.updateAttribute=function (xpath, namespaceMappings, name, value) {
			_invokeMethod(this, "UpdateAttribute", 0, [xpath, namespaceMappings, name, value], 0, 0);
		};
		CustomXmlPart.prototype.updateElement=function (xpath, xml, namespaceMappings) {
			_invokeMethod(this, "UpdateElement", 0, [xpath, xml, namespaceMappings], 0, 0);
		};
		CustomXmlPart.prototype._KeepReference=function () {
			_invokeMethod(this, "_KeepReference", 1, [], 4, 0);
		};
	...
	var CustomXmlPartCollection=(function (_super) {
		...
		Object.defineProperty(CustomXmlPartCollection.prototype, "_scalarPropertyNames", {
			get: function () {
				return ["_ReferenceId"];
			},
			enumerable: true,
		...
		Object.defineProperty(CustomXmlPartCollection.prototype, "_ReferenceId", {
			get: function () {
				_throwIfNotLoaded("_ReferenceId", this.__R, _typeCustomXmlPartCollection, this._isNull);
				return this.__R;
			},
			enumerable: true,
			configurable: true
		...
		CustomXmlPartCollection.prototype.add=function (xml) {
			return _createMethodObject(Word.CustomXmlPart, this, "Add", 0, [xml], false, true, null, 0);
		};
		CustomXmlPartCollection.prototype.getByNamespace=function (namespaceUri) {
			return _createMethodObject(Word.CustomXmlPartScopedCollection, this, "GetByNamespace", 1, [namespaceUri], true, false, null, 4);
		};
		CustomXmlPartCollection.prototype.getCount=function () {
			return _invokeMethod(this, "GetCount", 1, [], 4, 0);
		};
		CustomXmlPartCollection.prototype.getItem=function (id) {
			return _createIndexerObject(Word.CustomXmlPart, this, [id]);
		};
		CustomXmlPartCollection.prototype.getItemOrNullObject=function (id) {
			return _createMethodObject(Word.CustomXmlPart, this, "GetItemOrNullObject", 1, [id], false, false, null, 4);
		};
		CustomXmlPartCollection.prototype._KeepReference=function () {
			_invokeMethod(this, "_KeepReference", 1, [], 4, 0);
		};
		CustomXmlPartCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.CustomXmlPart, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		CustomXmlPartCollection.prototype._handleIdResult=function (value) {
			_super.prototype._handleIdResult.call(this, value);
			if (_isNullOrUndefined(value)) {
				return;
			}
		...
		CustomXmlPartCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.CustomXmlPart, true, _this, childItemData, index); });
		};
	...
	var CustomXmlPartScopedCollection=(function (_super) {
		...
		Object.defineProperty(CustomXmlPartScopedCollection.prototype, "_scalarPropertyNames", {
			get: function () {
				return ["_ReferenceId"];
			},
			enumerable: true,
		...
		Object.defineProperty(CustomXmlPartScopedCollection.prototype, "_ReferenceId", {
			get: function () {
				_throwIfNotLoaded("_ReferenceId", this.__R, _typeCustomXmlPartScopedCollection, this._isNull);
				return this.__R;
			},
			enumerable: true,
			configurable: true
		...
		CustomXmlPartScopedCollection.prototype.getOnlyItem=function () {
			return _createMethodObject(Word.CustomXmlPart, this, "GetOnlyItem", 1, [], false, false, null, 4);
		};
		CustomXmlPartScopedCollection.prototype.getOnlyItemOrNullObject=function () {
			return _createMethodObject(Word.CustomXmlPart, this, "GetOnlyItemOrNullObject", 1, [], false, false, null, 4);
		};
		CustomXmlPartScopedCollection.prototype._KeepReference=function () {
			_invokeMethod(this, "_KeepReference", 1, [], 4, 0);
		};
		...
		CustomXmlPartScopedCollection.prototype._handleIdResult=function (value) {
			_super.prototype._handleIdResult.call(this, value);
			if (_isNullOrUndefined(value)) {
				return;
			}
	...
	var Document=(function (_super) {
		...
		Object.defineProperty(Document.prototype, "_navigationPropertyNames", {
			get: function () {
				return ["sections", "body", "contentControls", "properties", "settings", "customXmlParts"];
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Document.prototype, "body", {
			get: function () {
				if (!this._B) {
					this._B=_createPropertyObject(Word.Body, this, "Body", false, 4);
				}
				return this._B;
			},
			enumerable: true,
		...
		Object.defineProperty(Document.prototype, "customXmlParts", {
			get: function () {
				_throwIfApiNotSupported("Document.customXmlParts", _defaultApiSetName, "1.4", _hostName);
				if (!this._Cu) {
					this._Cu=_createPropertyObject(Word.CustomXmlPartCollection, this, "CustomXmlParts", true, 4);
				}
				return this._Cu;
			},
			enumerable: true,
		...
		Object.defineProperty(Document.prototype, "properties", {
			get: function () {
				...
				if (!this._P) {
					this._P=_createPropertyObject(Word.DocumentProperties, this, "Properties", false, 4);
				}
				return this._P;
			},
			enumerable: true,
		...
		Object.defineProperty(Document.prototype, "sections", {
			get: function () {
				if (!this._Se) {
					this._Se=_createPropertyObject(Word.SectionCollection, this, "Sections", true, 4);
				}
				return this._Se;
			},
			enumerable: true,
		...
		Object.defineProperty(Document.prototype, "settings", {
			get: function () {
				_throwIfApiNotSupported("Document.settings", _defaultApiSetName, "1.4", _hostName);
				if (!this._Set) {
					this._Set=_createPropertyObject(Word.SettingCollection, this, "Settings", true, 4);
				}
				return this._Set;
			},
			enumerable: true,
		...
		Object.defineProperty(Document.prototype, "allowCloseOnUntitled", {
			...
			set: function (value) {
				this._A=value;
				_invokeSetProperty(this, "AllowCloseOnUntitled", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		Document.prototype.deleteBookmark=function (name) {
			_throwIfApiNotSupported("Document.deleteBookmark", _defaultApiSetName, "1.4", _hostName);
			_invokeMethod(this, "DeleteBookmark", 0, [name], 0, 0);
		};
		Document.prototype.getAnnotationsByType=function (annotationType) {
			_throwIfApiNotSupported("Document.getAnnotationsByType", _defaultApiSetName, "1.4", _hostName);
			return _createMethodObject(Word.AnnotationCollection, this, "GetAnnotationsByType", 1, [annotationType], true, false, null, 4);
		};
		Document.prototype.getBookmarkRange=function (name) {
			_throwIfApiNotSupported("Document.getBookmarkRange", _defaultApiSetName, "1.4", _hostName);
			return _createMethodObject(Word.Range, this, "GetBookmarkRange", 1, [name], false, false, null, 4);
		};
		Document.prototype.getBookmarkRangeOrNullObject=function (name) {
			_throwIfApiNotSupported("Document.getBookmarkRangeOrNullObject", _defaultApiSetName, "1.4", _hostName);
			return _createMethodObject(Word.Range, this, "GetBookmarkRangeOrNullObject", 1, [name], false, false, null, 4);
		};
		Document.prototype.getMetadata=function (propertyGUID) {
			return _invokeMethod(this, "GetMetadata", 1, [propertyGUID], 4, 0);
		};
		Document.prototype.getNeighborhoodTextAroundSelection=function (maxLength) {
			return _invokeMethod(this, "GetNeighborhoodTextAroundSelection", 1, [maxLength], 4 | 1, 0);
		};
		Document.prototype.getSelection=function () {
			return _createMethodObject(Word.Range, this, "GetSelection", 1, [], false, true, null, 4);
		};
		Document.prototype.launchTapPane=function (documentUrl) {
			_invokeMethod(this, "LaunchTapPane", 1, [documentUrl], 4 | 1, 0);
		};
		Document.prototype.save=function () {
			_invokeMethod(this, "Save", 0, [], 0, 0);
		};
		Document.prototype.setMetadata=function (propertyGUID, propertyValue) {
			_invokeMethod(this, "SetMetadata", 0, [propertyGUID, propertyValue], 0, 0);
		};
		Document.prototype.setMetadataOnTile=function (tileID, propertyGUID, propertyValue) {
			_invokeMethod(this, "SetMetadataOnTile", 0, [tileID, propertyGUID, propertyValue], 0, 0);
		};
		...
		Document.prototype._RegisterEvent=function (referenceId, eventType) {
			_invokeMethod(this, "_RegisterEvent", 1, [referenceId, eventType], 4, 0);
		};
		...
		Document.prototype._UnregisterEvent=function (referenceId, eventType) {
			_invokeMethod(this, "_UnregisterEvent", 1, [referenceId, eventType], 4, 0);
		};
		Document.prototype._handleResult=function (value) {
			...
			_handleNavigationPropertyResults(this, obj, ["body", "Body", "contentControls", "ContentControls", "customXmlParts", "CustomXmlParts", "properties", "Properties", "sections", "Sections", "settings", "Settings"]);
		};
		...
		Object.defineProperty(Document.prototype, "onContentControlAdded", {
			get: function () {
				var _this=this;
				_throwIfApiNotSupported("Document.onContentControlAdded", _defaultApiSetName, "1.4", _hostName);
				if (!this.m_contentControlAdded) {
					this.m_contentControlAdded=new OfficeExtension.GenericEventHandlers(this.context, this, "ContentControlAdded", {
						eventType: 3,
						registerFunc: function () { _this._RegisterEvent(_this._ReferenceId, "ContentControlAdded"); },
						unregisterFunc: function () { _this._UnregisterEvent(_this._ReferenceId, "ContentControlAdded"); },
						getTargetIdFunc: function () { return _this._ReferenceId; },
						eventArgsTransformFunc: function (args) {
							var evt={
								eventType: Word.EventType.contentControlAdded,
								contentControl: OfficeExtension.BatchApiHelper.createObjectFromReferenceId(Word.ContentControl, _this.context, args)
							};
				...
				return this.m_contentControlAdded;
			},
			enumerable: true,
			configurable: true
		});
	...
	var DocumentCreated=(function (_super) {
		...
		Object.defineProperty(DocumentCreated.prototype, "customXmlParts", {
			get: function () {
				_throwIfApiNotSupported("DocumentCreated.customXmlParts", "WordApiHiddenDocument", "1.4", _hostName);
				if (!this._Cu) {
					this._Cu=_createPropertyObject(Word.CustomXmlPartCollection, this, "CustomXmlParts", true, 4);
				}
				return this._Cu;
		...
		Object.defineProperty(DocumentCreated.prototype, "settings", {
			get: function () {
				_throwIfApiNotSupported("DocumentCreated.settings", "WordApiHiddenDocument", "1.4", _hostName);
				if (!this._Set) {
					this._Set=_createPropertyObject(Word.SettingCollection, this, "Settings", true, 4);
				}
				return this._Set;
		...
		DocumentCreated.prototype.deleteBookmark=function (name) {
			_throwIfApiNotSupported("DocumentCreated.deleteBookmark", "WordApiHiddenDocument", "1.4", _hostName);
			_invokeMethod(this, "DeleteBookmark", 0, [name], 0, 0);
		};
		DocumentCreated.prototype.getBookmarkRange=function (name) {
			_throwIfApiNotSupported("DocumentCreated.getBookmarkRange", "WordApiHiddenDocument", "1.4", _hostName);
			return _createMethodObject(Word.Range, this, "GetBookmarkRange", 1, [name], false, false, null, 4);
		};
		DocumentCreated.prototype.getBookmarkRangeOrNullObject=function (name) {
			_throwIfApiNotSupported("DocumentCreated.getBookmarkRangeOrNullObject", "WordApiHiddenDocument", "1.4", _hostName);
			return _createMethodObject(Word.Range, this, "GetBookmarkRangeOrNullObject", 1, [name], false, false, null, 4);
		};
	...
	var DocumentProperties=(function (_super) {
		...
		Object.defineProperty(DocumentProperties.prototype, "customProperties", {
			get: function () {
				if (!this._Cu) {
					this._Cu=_createPropertyObject(Word.CustomPropertyCollection, this, "CustomProperties", true, 4);
				}
				return this._Cu;
			},
			enumerable: true,
		...
		Object.defineProperty(DocumentProperties.prototype, "format", {
			...
			set: function (value) {
				this._F=value;
				_invokeSetProperty(this, "Format", value, 0);
			},
			enumerable: true,
			configurable: true
		});
	...
	var Font=(function (_super) {
		...
		Object.defineProperty(Font.prototype, "doubleStrikeThrough", {
			...
			set: function (value) {
				this._D=value;
				_invokeSetProperty(this, "DoubleStrikeThrough", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Font.prototype, "highlightColor", {
			...
			set: function (value) {
				this._H=value;
				_invokeSetProperty(this, "HighlightColor", value, 0);
			},
			enumerable: true,
			configurable: true
		});
	...
	var InlinePicture=(function (_super) {
		...
		Object.defineProperty(InlinePicture.prototype, "_scalarPropertyNames", {
			get: function () {
				return ["_Id", "_ReferenceId", "altTextDescription", "altTextTitle", "height", "hyperlink", "lockAspectRatio", "width", "imageFormat"];
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(InlinePicture.prototype, "_scalarPropertyUpdateable", {
			get: function () {
				return [false, false, true, true, true, true, true, true, false];
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(InlinePicture.prototype, "paragraph", {
			get: function () {
				...
				if (!this._P) {
					this._P=_createPropertyObject(Word.Paragraph, this, "Paragraph", false, 4);
				}
				return this._P;
			},
			enumerable: true,
		...
		Object.defineProperty(InlinePicture.prototype, "parentContentControl", {
			get: function () {
				if (!this._Pa) {
					this._Pa=_createPropertyObject(Word.ContentControl, this, "ParentContentControl", false, 4);
				}
				return this._Pa;
			},
			enumerable: true,
		...
		Object.defineProperty(InlinePicture.prototype, "parentContentControlOrNullObject", {
			get: function () {
				...
				if (!this._Par) {
					this._Par=_createPropertyObject(Word.ContentControl, this, "ParentContentControlOrNullObject", false, 4);
				}
				return this._Par;
			},
			enumerable: true,
		...
		Object.defineProperty(InlinePicture.prototype, "parentTable", {
			get: function () {
				...
				if (!this._Pare) {
					this._Pare=_createPropertyObject(Word.Table, this, "ParentTable", false, 4);
				}
				return this._Pare;
			},
			enumerable: true,
		...
		Object.defineProperty(InlinePicture.prototype, "parentTableCell", {
			get: function () {
				...
				if (!this._Paren) {
					this._Paren=_createPropertyObject(Word.TableCell, this, "ParentTableCell", false, 4);
				}
				return this._Paren;
			},
			enumerable: true,
		...
		Object.defineProperty(InlinePicture.prototype, "parentTableCellOrNullObject", {
			get: function () {
				...
				if (!this._Parent) {
					this._Parent=_createPropertyObject(Word.TableCell, this, "ParentTableCellOrNullObject", false, 4);
				}
				return this._Parent;
			},
			enumerable: true,
		...
		Object.defineProperty(InlinePicture.prototype, "parentTableOrNullObject", {
			get: function () {
				...
				if (!this._ParentT) {
					this._ParentT=_createPropertyObject(Word.Table, this, "ParentTableOrNullObject", false, 4);
				}
				return this._ParentT;
			},
			enumerable: true,
		...
		Object.defineProperty(InlinePicture.prototype, "altTextDescription", {
			...
			set: function (value) {
				this._A=value;
				_invokeSetProperty(this, "AltTextDescription", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(InlinePicture.prototype, "imageFormat", {
			get: function () {
				_throwIfNotLoaded("imageFormat", this._I, _typeInlinePicture, this._isNull);
				_throwIfApiNotSupported("InlinePicture.imageFormat", _defaultApiSetName, "1.4", _hostName);
				return this._I;
			},
			enumerable: true,
			configurable: true
		...
		InlinePicture.prototype.getBase64ImageSrc=function () {
			return _invokeMethod(this, "GetBase64ImageSrc", 1, [], 4, 0);
		};
		InlinePicture.prototype.getNext=function () {
			_throwIfApiNotSupported("InlinePicture.getNext", _defaultApiSetName, "1.3", _hostName);
			return _createMethodObject(Word.InlinePicture, this, "GetNext", 1, [], false, false, null, 4);
		};
		InlinePicture.prototype.getNextOrNullObject=function () {
			...
			return _createMethodObject(Word.InlinePicture, this, "GetNextOrNullObject", 1, [], false, false, null, 4);
		};
	...
	var InlinePictureCollection=(function (_super) {
		...
		InlinePictureCollection.prototype.getFirst=function () {
			...
			return _createMethodObject(Word.InlinePicture, this, "GetFirst", 1, [], false, false, null, 4);
		};
		InlinePictureCollection.prototype.getFirstOrNullObject=function () {
			...
			return _createMethodObject(Word.InlinePicture, this, "GetFirstOrNullObject", 1, [], false, false, null, 4);
		};
		InlinePictureCollection.prototype._GetItem=function (index) {
			return _createIndexerObject(Word.InlinePicture, this, [index]);
		};
		...
		InlinePictureCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.InlinePicture, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		InlinePictureCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.InlinePicture, true, _this, childItemData, index); });
		};
	...
	var List=(function (_super) {
		...
		List.prototype.getLevelFont=function (level) {
			_throwIfApiNotSupported("List.getLevelFont", _defaultApiSetName, "1.4", _hostName);
			return _createMethodObject(Word.Font, this, "GetLevelFont", 1, [level], false, false, null, 4);
		};
		List.prototype.getLevelParagraphs=function (level) {
			return _createMethodObject(Word.ParagraphCollection, this, "GetLevelParagraphs", 1, [level], true, false, null, 4);
		};
		List.prototype.getLevelPicture=function (level) {
			_throwIfApiNotSupported("List.getLevelPicture", _defaultApiSetName, "1.4", _hostName);
			return _invokeMethod(this, "GetLevelPicture", 1, [level], 4, 0);
		};
		List.prototype.getLevelString=function (level) {
			return _invokeMethod(this, "GetLevelString", 1, [level], 4, 0);
		};
		...
		List.prototype.resetLevelFont=function (level, resetFontName) {
			_throwIfApiNotSupported("List.resetLevelFont", _defaultApiSetName, "1.4", _hostName);
			_invokeMethod(this, "ResetLevelFont", 0, [level, resetFontName], 0, 0);
		};
		List.prototype.setLevelAlignment=function (level, alignment) {
			_invokeMethod(this, "SetLevelAlignment", 0, [level, alignment], 0, 0);
		};
		List.prototype.setLevelBullet=function (level, listBullet, charCode, fontName) {
			_invokeMethod(this, "SetLevelBullet", 0, [level, listBullet, charCode, fontName], 0, 0);
		};
		List.prototype.setLevelIndents=function (level, textIndent, bulletNumberPictureIndent) {
			_invokeMethod(this, "SetLevelIndents", 0, [level, textIndent, bulletNumberPictureIndent], 0, 0);
		};
		List.prototype.setLevelNumbering=function (level, listNumbering, formatString) {
			_invokeMethod(this, "SetLevelNumbering", 0, [level, listNumbering, formatString], 0, 0);
		};
		List.prototype.setLevelPicture=function (level, base64EncodedImage) {
			_throwIfApiNotSupported("List.setLevelPicture", _defaultApiSetName, "1.4", _hostName);
			_invokeMethod(this, "SetLevelPicture", 0, [level, base64EncodedImage], 0, 0);
		};
		List.prototype.setLevelStartingNumber=function (level, startingNumber) {
			_invokeMethod(this, "SetLevelStartingNumber", 0, [level, startingNumber], 0, 0);
		};
	...
	var ListCollection=(function (_super) {
		...
		ListCollection.prototype.getById=function (id) {
			return _createMethodObject(Word.List, this, "GetById", 1, [id], false, false, null, 4);
		};
		ListCollection.prototype.getByIdOrNullObject=function (id) {
			return _createMethodObject(Word.List, this, "GetByIdOrNullObject", 1, [id], false, false, null, 4);
		};
		ListCollection.prototype.getFirst=function () {
			return _createMethodObject(Word.List, this, "GetFirst", 1, [], false, false, null, 4);
		};
		ListCollection.prototype.getFirstOrNullObject=function () {
			return _createMethodObject(Word.List, this, "GetFirstOrNullObject", 1, [], false, false, null, 4);
		};
		ListCollection.prototype.getItem=function (index) {
			return _createIndexerObject(Word.List, this, [index]);
		};
		...
		ListCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.List, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		ListCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.List, true, _this, childItemData, index); });
		};
	...
	var ListItem=(function (_super) {
		...
		ListItem.prototype.getAncestor=function (parentOnly) {
			return _createMethodObject(Word.Paragraph, this, "GetAncestor", 1, [parentOnly], false, false, null, 4);
		};
		ListItem.prototype.getAncestorOrNullObject=function (parentOnly) {
			return _createMethodObject(Word.Paragraph, this, "GetAncestorOrNullObject", 1, [parentOnly], false, false, null, 4);
		};
		ListItem.prototype.getDescendants=function (directChildrenOnly) {
			return _createMethodObject(Word.ParagraphCollection, this, "GetDescendants", 1, [directChildrenOnly], true, false, null, 4);
		};
	...
	var Paragraph=(function (_super) {
		...
		Object.defineProperty(Paragraph.prototype, "font", {
			get: function () {
				if (!this._Fo) {
					this._Fo=_createPropertyObject(Word.Font, this, "Font", false, 4);
				}
				return this._Fo;
			},
			enumerable: true,
		...
		Object.defineProperty(Paragraph.prototype, "list", {
			get: function () {
				...
				if (!this._Lis) {
					this._Lis=_createPropertyObject(Word.List, this, "List", false, 4);
				}
				return this._Lis;
			},
			enumerable: true,
		...
		Object.defineProperty(Paragraph.prototype, "listItem", {
			get: function () {
				...
				if (!this._List) {
					this._List=_createPropertyObject(Word.ListItem, this, "ListItem", false, 4);
				}
				return this._List;
			},
			enumerable: true,
		...
		Object.defineProperty(Paragraph.prototype, "listItemOrNullObject", {
			get: function () {
				...
				if (!this._ListI) {
					this._ListI=_createPropertyObject(Word.ListItem, this, "ListItemOrNullObject", false, 4);
				}
				return this._ListI;
			},
			enumerable: true,
		...
		Object.defineProperty(Paragraph.prototype, "listOrNullObject", {
			get: function () {
				...
				if (!this._ListO) {
					this._ListO=_createPropertyObject(Word.List, this, "ListOrNullObject", false, 4);
				}
				return this._ListO;
			},
			enumerable: true,
		...
		Object.defineProperty(Paragraph.prototype, "parentBody", {
			get: function () {
				...
				if (!this._P) {
					this._P=_createPropertyObject(Word.Body, this, "ParentBody", false, 4);
				}
				return this._P;
			},
			enumerable: true,
		...
		Object.defineProperty(Paragraph.prototype, "firstLineIndent", {
			...
			set: function (value) {
				this._F=value;
				_invokeSetProperty(this, "FirstLineIndent", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(Paragraph.prototype, "leftIndent", {
			...
			set: function (value) {
				this._L=value;
				_invokeSetProperty(this, "LeftIndent", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Paragraph.prototype, "lineSpacing", {
			...
			set: function (value) {
				this._Li=value;
				_invokeSetProperty(this, "LineSpacing", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Paragraph.prototype, "lineUnitAfter", {
			...
			set: function (value) {
				this._Lin=value;
				_invokeSetProperty(this, "LineUnitAfter", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Paragraph.prototype, "lineUnitBefore", {
			...
			set: function (value) {
				this._Line=value;
				_invokeSetProperty(this, "LineUnitBefore", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Paragraph.prototype, "outlineLevel", {
			...
			set: function (value) {
				this._O=value;
				_invokeSetProperty(this, "OutlineLevel", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Paragraph.prototype, "rightIndent", {
			...
			set: function (value) {
				this._R=value;
				_invokeSetProperty(this, "RightIndent", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Paragraph.prototype, "spaceAfter", {
			...
			set: function (value) {
				this._S=value;
				_invokeSetProperty(this, "SpaceAfter", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Paragraph.prototype, "spaceBefore", {
			...
			set: function (value) {
				this._Sp=value;
				_invokeSetProperty(this, "SpaceBefore", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		Paragraph.prototype.attachToList=function (listId, level) {
			...
			return _createMethodObject(Word.List, this, "AttachToList", 0, [listId, level], false, false, null, 0);
		};
		...
		Paragraph.prototype.detachFromList=function () {
			...
			_invokeMethod(this, "DetachFromList", 0, [], 0, 0);
		};
		...
		Paragraph.prototype.getNext=function () {
			...
			return _createMethodObject(Word.Paragraph, this, "GetNext", 1, [], false, false, null, 4);
		};
		Paragraph.prototype.getNextOrNullObject=function () {
			...
			return _createMethodObject(Word.Paragraph, this, "GetNextOrNullObject", 1, [], false, false, null, 4);
		};
		...
		Paragraph.prototype.getPrevious=function () {
			...
			return _createMethodObject(Word.Paragraph, this, "GetPrevious", 1, [], false, false, null, 4);
		};
		Paragraph.prototype.getPreviousOrNullObject=function () {
			...
			return _createMethodObject(Word.Paragraph, this, "GetPreviousOrNullObject", 1, [], false, false, null, 4);
		};
		...
		Paragraph.prototype.split=function (delimiters, trimDelimiters, trimSpacing) {
			...
			return _createMethodObject(Word.RangeCollection, this, "Split", 1, [delimiters, trimDelimiters, trimSpacing], true, false, null, 4);
		};
		Paragraph.prototype.startNewList=function () {
			_throwIfApiNotSupported("Paragraph.startNewList", _defaultApiSetName, "1.3", _hostName);
			return _createMethodObject(Word.List, this, "StartNewList", 0, [], false, false, null, 0);
		};
	...
	var ParagraphCollection=(function (_super) {
		...
		ParagraphCollection.prototype.getFirst=function () {
			...
			return _createMethodObject(Word.Paragraph, this, "GetFirst", 1, [], false, false, null, 4);
		};
		ParagraphCollection.prototype.getFirstOrNullObject=function () {
			...
			return _createMethodObject(Word.Paragraph, this, "GetFirstOrNullObject", 1, [], false, false, null, 4);
		};
		ParagraphCollection.prototype.getLast=function () {
			...
			return _createMethodObject(Word.Paragraph, this, "GetLast", 1, [], false, false, null, 4);
		};
		ParagraphCollection.prototype.getLastOrNullObject=function () {
			...
			return _createMethodObject(Word.Paragraph, this, "GetLastOrNullObject", 1, [], false, false, null, 4);
		};
		ParagraphCollection.prototype._GetItem=function (index) {
			return _createIndexerObject(Word.Paragraph, this, [index]);
		};
		...
		ParagraphCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.Paragraph, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		ParagraphCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.Paragraph, true, _this, childItemData, index); });
		};
	...
	var Range=(function (_super) {
		...
		Range.prototype.compareLocationWith=function (range) {
			...
			return _invokeMethod(this, "CompareLocationWith", 1, [range], 4, 0);
		};
		...
		Range.prototype.expandToOrNullObject=function (range) {
			...
			return _createMethodObject(Word.Range, this, "ExpandToOrNullObject", 0, [range], false, false, null, 0);
		};
		Range.prototype.getBookmarks=function (includeHidden, includeAdjacent) {
			_throwIfApiNotSupported("Range.getBookmarks", _defaultApiSetName, "1.4", _hostName);
			return _invokeMethod(this, "GetBookmarks", 1, [includeHidden, includeAdjacent], 4, 0);
		};
		...
		Range.prototype.getHyperlinkRanges=function () {
			...
			return _createMethodObject(Word.RangeCollection, this, "GetHyperlinkRanges", 1, [], true, false, null, 4);
		};
		Range.prototype.getNextTextRange=function (endingMarks, trimSpacing) {
			...
			return _createMethodObject(Word.Range, this, "GetNextTextRange", 1, [endingMarks, trimSpacing], false, false, null, 4);
		};
		Range.prototype.getNextTextRangeOrNullObject=function (endingMarks, trimSpacing) {
			...
			return _createMethodObject(Word.Range, this, "GetNextTextRangeOrNullObject", 1, [endingMarks, trimSpacing], false, false, null, 4);
		};
		...
		Range.prototype.insertBookmark=function (name) {
			...
			_invokeMethod(this, "InsertBookmark", 0, [name], 0, 0);
		};
		...
		Range.prototype.insertTapObjectFromFileContent=function (fileContent, objectType, contentFormat) {
			return _createMethodObject(Word.Range, this, "InsertTapObjectFromFileContent", 0, [fileContent, objectType, contentFormat], false, true, null, 1);
		};
		...
		Range.prototype.intersectWith=function (range) {
			...
			return _createMethodObject(Word.Range, this, "IntersectWith", 0, [range], false, false, null, 0);
		};
	...
	var RangeCollection=(function (_super) {
		...
		RangeCollection.prototype.getFirst=function () {
			...
			return _createMethodObject(Word.Range, this, "GetFirst", 1, [], false, false, null, 4);
		};
		RangeCollection.prototype.getFirstOrNullObject=function () {
			...
			return _createMethodObject(Word.Range, this, "GetFirstOrNullObject", 1, [], false, false, null, 4);
		};
		RangeCollection.prototype._GetItem=function (index) {
			return _createIndexerObject(Word.Range, this, [index]);
		};
		...
		RangeCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.Range, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		RangeCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.Range, true, _this, childItemData, index); });
		};
	...
	var SearchOptions=(function (_super) {
		...
		Object.defineProperty(SearchOptions.prototype, "ignorePunct", {
			...
			set: function (value) {
				this._I=value;
				_invokeSetProperty(this, "IgnorePunct", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(SearchOptions.prototype, "ignoreSpace", {
			...
			set: function (value) {
				this._Ig=value;
				_invokeSetProperty(this, "IgnoreSpace", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(SearchOptions.prototype, "matchCase", {
			...
			set: function (value) {
				this._M=value;
				_invokeSetProperty(this, "MatchCase", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(SearchOptions.prototype, "matchPrefix", {
			...
			set: function (value) {
				this._Ma=value;
				_invokeSetProperty(this, "MatchPrefix", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(SearchOptions.prototype, "matchSuffix", {
			...
			set: function (value) {
				this._Mat=value;
				_invokeSetProperty(this, "MatchSuffix", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(SearchOptions.prototype, "matchWholeWord", {
			...
			set: function (value) {
				this._Matc=value;
				_invokeSetProperty(this, "MatchWholeWord", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		SearchOptions.newObject=function (context) {
			return _createTopLevelServiceObject(Word.SearchOptions, context, "Microsoft.WordServices.SearchOptions", false, 4);
		};
	...
	var Section=(function (_super) {
		...
		Section.prototype.getFooter=function (type) {
			return _createMethodObject(Word.Body, this, "GetFooter", 1, [type], false, true, null, 4);
		};
		Section.prototype.getHeader=function (type) {
			return _createMethodObject(Word.Body, this, "GetHeader", 1, [type], false, true, null, 4);
		};
		Section.prototype.getNext=function () {
			_throwIfApiNotSupported("Section.getNext", _defaultApiSetName, "1.3", _hostName);
			return _createMethodObject(Word.Section, this, "GetNext", 1, [], false, false, null, 4);
		};
		Section.prototype.getNextOrNullObject=function () {
			...
			return _createMethodObject(Word.Section, this, "GetNextOrNullObject", 1, [], false, false, null, 4);
		};
	...
	var SectionCollection=(function (_super) {
		...
		SectionCollection.prototype.getFirst=function () {
			...
			return _createMethodObject(Word.Section, this, "GetFirst", 1, [], false, false, null, 4);
		};
		SectionCollection.prototype.getFirstOrNullObject=function () {
			...
			return _createMethodObject(Word.Section, this, "GetFirstOrNullObject", 1, [], false, false, null, 4);
		};
		SectionCollection.prototype._GetItem=function (index) {
			return _createIndexerObject(Word.Section, this, [index]);
		};
		...
		SectionCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.Section, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		SectionCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.Section, true, _this, childItemData, index); });
		};
	...
	var Setting=(function (_super) {
		...
		Object.defineProperty(Setting.prototype, "_scalarPropertyNames", {
			get: function () {
				return ["_ReferenceId", "key", "value", "_Id"];
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(Setting.prototype, "value", {
			get: function () {
				...
				if (!this._isNull && typeof this.m_value==="string") {
					...
					newValue=Setting.replaceStringDateWithDate(newValue);
					return newValue;
				}
			...
			set: function (value) {
				var newValue=JSON.stringify(Setting._replaceDateWithStringDate(value));
				if (newValue !==null) {
					this.m_value=newValue;
					_invokeSetProperty(this, "Value", newValue, 0);
					return;
				}
				this.m_value=value;
				_invokeSetProperty(this, "Value", value, 0);
		...
		Object.defineProperty(Setting.prototype, "_ReferenceId", {
			get: function () {
				_throwIfNotLoaded("_ReferenceId", this.__R, _typeSetting, this._isNull);
				return this.__R;
			},
			enumerable: true,
			configurable: true
	...
	var SettingCollection=(function (_super) {
		...
		Object.defineProperty(SettingCollection.prototype, "_scalarPropertyNames", {
			get: function () {
				return ["_ReferenceId"];
			},
			enumerable: true,
		...
		Object.defineProperty(SettingCollection.prototype, "_ReferenceId", {
			get: function () {
				_throwIfNotLoaded("_ReferenceId", this.__R, _typeSettingCollection, this._isNull);
				return this.__R;
			},
			enumerable: true,
			configurable: true
		...
		SettingCollection.prototype.add=function (key, value) {
			var newValue=JSON.stringify(Setting._replaceDateWithStringDate(value));
			if (newValue !==null) {
				return _createMethodObject(Word.Setting, this, "Add", 0, [key, newValue], false, false, null, 0);
			}
			return _createMethodObject(Word.Setting, this, "Add", 0, [key, value], false, true, null, 0);
		};
		...
		SettingCollection.prototype.getItem=function (key) {
			return _createIndexerObject(Word.Setting, this, [key]);
		};
		SettingCollection.prototype.getItemOrNullObject=function (key) {
			return _createMethodObject(Word.Setting, this, "GetItemOrNullObject", 1, [key], false, false, null, 4);
		};
		...
		SettingCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.Setting, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		SettingCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.Setting, true, _this, childItemData, index); });
		};
	...
	var Table=(function (_super) {
		...
		Object.defineProperty(Table.prototype, "rows", {
			get: function () {
				if (!this._Ro) {
					this._Ro=_createPropertyObject(Word.TableRowCollection, this, "Rows", true, 4);
				}
				return this._Ro;
			},
			enumerable: true,
		...
		Object.defineProperty(Table.prototype, "headerRowCount", {
			...
			set: function (value) {
				this._H=value;
				_invokeSetProperty(this, "HeaderRowCount", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(Table.prototype, "styleBandedColumns", {
			...
			set: function (value) {
				this._Sty=value;
				_invokeSetProperty(this, "StyleBandedColumns", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Table.prototype, "styleBandedRows", {
			...
			set: function (value) {
				this._Styl=value;
				_invokeSetProperty(this, "StyleBandedRows", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(Table.prototype, "styleFirstColumn", {
			...
			set: function (value) {
				this._StyleF=value;
				_invokeSetProperty(this, "StyleFirstColumn", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Table.prototype, "styleLastColumn", {
			...
			set: function (value) {
				this._StyleL=value;
				_invokeSetProperty(this, "StyleLastColumn", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Table.prototype, "styleTotalRow", {
			...
			set: function (value) {
				this._StyleT=value;
				_invokeSetProperty(this, "StyleTotalRow", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		Table.prototype.addColumns=function (insertLocation, columnCount, values) {
			_invokeMethod(this, "AddColumns", 0, [insertLocation, columnCount, values], 0, 0);
		};
		Table.prototype.addRows=function (insertLocation, rowCount, values) {
			return _createMethodObject(Word.TableRowCollection, this, "AddRows", 0, [insertLocation, rowCount, values], true, false, null, 0);
		};
		Table.prototype.autoFitWindow=function () {
			_invokeMethod(this, "AutoFitWindow", 0, [], 0, 0);
		};
		...
		Table.prototype.deleteColumns=function (columnIndex, columnCount) {
			_invokeMethod(this, "DeleteColumns", 0, [columnIndex, columnCount], 0, 0);
		};
		Table.prototype.deleteRows=function (rowIndex, rowCount) {
			_invokeMethod(this, "DeleteRows", 0, [rowIndex, rowCount], 0, 0);
		};
		Table.prototype.distributeColumns=function () {
			_invokeMethod(this, "DistributeColumns", 0, [], 0, 0);
		};
		Table.prototype.getBorder=function (borderLocation) {
			return _createMethodObject(Word.TableBorder, this, "GetBorder", 1, [borderLocation], false, false, null, 4);
		};
		Table.prototype.getCell=function (rowIndex, cellIndex) {
			return _createMethodObject(Word.TableCell, this, "GetCell", 1, [rowIndex, cellIndex], false, false, null, 4);
		};
		Table.prototype.getCellOrNullObject=function (rowIndex, cellIndex) {
			return _createMethodObject(Word.TableCell, this, "GetCellOrNullObject", 1, [rowIndex, cellIndex], false, false, null, 4);
		};
		Table.prototype.getCellPadding=function (cellPaddingLocation) {
			return _invokeMethod(this, "GetCellPadding", 1, [cellPaddingLocation], 4, 0);
		};
		Table.prototype.getNext=function () {
			return _createMethodObject(Word.Table, this, "GetNext", 1, [], false, false, null, 4);
		};
		Table.prototype.getNextOrNullObject=function () {
			return _createMethodObject(Word.Table, this, "GetNextOrNullObject", 1, [], false, false, null, 4);
		};
		Table.prototype.getParagraphAfter=function () {
			return _createMethodObject(Word.Paragraph, this, "GetParagraphAfter", 1, [], false, false, null, 4);
		};
		Table.prototype.getParagraphAfterOrNullObject=function () {
			return _createMethodObject(Word.Paragraph, this, "GetParagraphAfterOrNullObject", 1, [], false, false, null, 4);
		};
		Table.prototype.getParagraphBefore=function () {
			return _createMethodObject(Word.Paragraph, this, "GetParagraphBefore", 1, [], false, false, null, 4);
		};
		Table.prototype.getParagraphBeforeOrNullObject=function () {
			return _createMethodObject(Word.Paragraph, this, "GetParagraphBeforeOrNullObject", 1, [], false, false, null, 4);
		};
		...
		Table.prototype.mergeCells=function (topRow, firstCell, bottomRow, lastCell) {
			_throwIfApiNotSupported("Table.mergeCells", _defaultApiSetName, "1.4", _hostName);
			return _createMethodObject(Word.TableCell, this, "MergeCells", 0, [topRow, firstCell, bottomRow, lastCell], false, true, null, 0);
		};
		...
		Table.prototype.setCellPadding=function (cellPaddingLocation, cellPadding) {
			_invokeMethod(this, "SetCellPadding", 0, [cellPaddingLocation, cellPadding], 0, 0);
		};
	...
	var TableCollection=(function (_super) {
		...
		TableCollection.prototype.getFirst=function () {
			return _createMethodObject(Word.Table, this, "GetFirst", 1, [], false, false, null, 4);
		};
		TableCollection.prototype.getFirstOrNullObject=function () {
			return _createMethodObject(Word.Table, this, "GetFirstOrNullObject", 1, [], false, false, null, 4);
		};
		TableCollection.prototype._GetItem=function (index) {
			return _createIndexerObject(Word.Table, this, [index]);
		};
		...
		TableCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.Table, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		TableCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.Table, true, _this, childItemData, index); });
		};
	...
	var TableRow=(function (_super) {
		...
		Object.defineProperty(TableRow.prototype, "cells", {
			get: function () {
				if (!this._Ce) {
					this._Ce=_createPropertyObject(Word.TableCellCollection, this, "Cells", true, 4);
				}
				return this._Ce;
			},
			enumerable: true,
		...
		Object.defineProperty(TableRow.prototype, "parentTable", {
			get: function () {
				if (!this._P) {
					this._P=_createPropertyObject(Word.Table, this, "ParentTable", false, 4);
				}
				return this._P;
			},
			enumerable: true,
		...
		Object.defineProperty(TableRow.prototype, "preferredHeight", {
			...
			set: function (value) {
				this._Pr=value;
				_invokeSetProperty(this, "PreferredHeight", value, 0);
			},
			enumerable: true,
			configurable: true
		});
		...
		TableRow.prototype.getNext=function () {
			return _createMethodObject(Word.TableRow, this, "GetNext", 1, [], false, false, null, 4);
		};
		TableRow.prototype.getNextOrNullObject=function () {
			return _createMethodObject(Word.TableRow, this, "GetNextOrNullObject", 1, [], false, false, null, 4);
		};
		TableRow.prototype.insertContentControl=function () {
			_throwIfApiNotSupported("TableRow.insertContentControl", _defaultApiSetName, "1.4", _hostName);
			return _createMethodObject(Word.ContentControl, this, "InsertContentControl", 0, [], false, false, null, 0);
		};
		TableRow.prototype.insertRows=function (insertLocation, rowCount, values) {
			return _createMethodObject(Word.TableRowCollection, this, "InsertRows", 1, [insertLocation, rowCount, values], true, false, null, 4);
		};
		TableRow.prototype.merge=function () {
			_throwIfApiNotSupported("TableRow.merge", _defaultApiSetName, "1.4", _hostName);
			return _createMethodObject(Word.TableCell, this, "Merge", 0, [], false, false, null, 0);
		};
	...
	var TableRowCollection=(function (_super) {
		...
		TableRowCollection.prototype.getFirst=function () {
			return _createMethodObject(Word.TableRow, this, "GetFirst", 1, [], false, false, null, 4);
		};
		TableRowCollection.prototype.getFirstOrNullObject=function () {
			return _createMethodObject(Word.TableRow, this, "GetFirstOrNullObject", 1, [], false, false, null, 4);
		};
		TableRowCollection.prototype._GetItem=function (index) {
			return _createIndexerObject(Word.TableRow, this, [index]);
		};
		...
		TableRowCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.TableRow, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		TableRowCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.TableRow, true, _this, childItemData, index); });
		};
	...
	var TableCell=(function (_super) {
		...
		Object.defineProperty(TableCell.prototype, "parentRow", {
			get: function () {
				if (!this._P) {
					this._P=_createPropertyObject(Word.TableRow, this, "ParentRow", false, 4);
				}
				return this._P;
			},
			enumerable: true,
		...
		Object.defineProperty(TableCell.prototype, "parentTable", {
			get: function () {
				if (!this._Pa) {
					this._Pa=_createPropertyObject(Word.Table, this, "ParentTable", false, 4);
				}
				return this._Pa;
			},
			enumerable: true,
		...
		TableCell.prototype.deleteColumn=function () {
			_invokeMethod(this, "DeleteColumn", 0, [], 0, 0);
		};
		TableCell.prototype.deleteRow=function () {
			_invokeMethod(this, "DeleteRow", 0, [], 0, 0);
		};
		...
		TableCell.prototype.getNext=function () {
			return _createMethodObject(Word.TableCell, this, "GetNext", 1, [], false, false, null, 4);
		};
		TableCell.prototype.getNextOrNullObject=function () {
			return _createMethodObject(Word.TableCell, this, "GetNextOrNullObject", 1, [], false, false, null, 4);
		};
		TableCell.prototype.insertColumns=function (insertLocation, columnCount, values) {
			_invokeMethod(this, "InsertColumns", 0, [insertLocation, columnCount, values], 0, 0);
		};
		TableCell.prototype.insertRows=function (insertLocation, rowCount, values) {
			return _createMethodObject(Word.TableRowCollection, this, "InsertRows", 0, [insertLocation, rowCount, values], true, false, null, 0);
		};
		...
		TableCell.prototype.split=function (rowCount, columnCount) {
			_throwIfApiNotSupported("TableCell.split", _defaultApiSetName, "1.4", _hostName);
			_invokeMethod(this, "Split", 0, [rowCount, columnCount], 0, 0);
		};
	...
	var TableCellCollection=(function (_super) {
		...
		TableCellCollection.prototype.getFirst=function () {
			return _createMethodObject(Word.TableCell, this, "GetFirst", 1, [], false, false, null, 4);
		};
		TableCellCollection.prototype.getFirstOrNullObject=function () {
			return _createMethodObject(Word.TableCell, this, "GetFirstOrNullObject", 1, [], false, false, null, 4);
		};
		TableCellCollection.prototype._GetItem=function (index) {
			return _createIndexerObject(Word.TableCell, this, [index]);
		};
		...
		TableCellCollection.prototype._handleResult=function (value) {
			...
			if (!_isNullOrUndefined(obj[OfficeExtension.Constants.items])) {
				...
				var _data=obj[OfficeExtension.Constants.items];
				for (var i=0; i < _data.length; i++) {
					var _item=_createChildItemObject(Word.TableCell, true, this, _data[i], i);
					_item._handleResult(_data[i]);
					this.m__items.push(_item);
				}
			}
		...
		TableCellCollection.prototype._handleRetrieveResult=function (value, result) {
			var _this=this;
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result, function (childItemData, index) { return _createChildItemObject(Word.TableCell, true, _this, childItemData, index); });
		};
	...
	var EventType;
	(function (EventType) {
		EventType["contentControlDeleted"]="ContentControlDeleted";
		EventType["contentControlSelectionChanged"]="ContentControlSelectionChanged";
		EventType["contentControlDataChanged"]="ContentControlDataChanged";
		EventType["contentControlAdded"]="ContentControlAdded";
		EventType["annotationAdded"]="AnnotationAdded";
		EventType["annotationChanged"]="AnnotationChanged";
		EventType["annotationDeleted"]="AnnotationDeleted";
	})(EventType=Word.EventType || (Word.EventType={}));
...
OSF.AdditionalPostContextSettingOverride=function () {
	var original=Office.context.requirements.isSetSupported;
	Office.context.requirements.isSetSupported=function (name, version) {
		if (((name.toLowerCase()==='customxmlparts' || name.toLowerCase()==='dialogapi' || name.toLowerCase()==='identityapi') && version <=1.1)
			|| (name.toLowerCase()==='wordapi' && version <=1.3)) {
			return true;
		}
