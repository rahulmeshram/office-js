...
(function (Word) {
	...
	var Annotation=(function (_super) {
		...
		Object.defineProperty(Annotation.prototype, "_scalarPropertyNames", {
			get: function () {
				return ["object", "parentObject", "parentObjectType"];
			},
			enumerable: true,
			configurable: true
		});
	...
	var AnnotationCollection=(function (_super) {
		...
		AnnotationCollection.prototype.getByType=function (annotationType) {
			return _invokeMethod(this, "GetByType", 0, [annotationType], 0, 0);
		};
	...
	var Document=(function (_super) {
		...
		Object.defineProperty(Document.prototype, "annotations", {
			get: function () {
				if (!this._An) {
					this._An=_createPropertyObject(Word.AnnotationCollection, this, "Annotations", false, 4);
				}
				return this._An;
			},
			enumerable: true,
