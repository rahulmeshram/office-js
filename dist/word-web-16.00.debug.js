...
// Sources:
// osfweb: 16.0\11215.10000
// runtime: 16.0.11314.30006
// core: 16.0\11318.10000
// host: 
...
(function (OSFAriaLogger) {
	...
	var AriaLogger=(function () {
		...
		AriaLogger.setInfo=function (info) {
			AriaLogger.appInfo=info;
		};
		AriaLogger.getTelemetryLogger=function () {
			if (AriaLogger.otelTelemetryLogger===undefined) {
				var contract={
					assetId: AriaLogger.appInfo.assetId,
					browserToken: AriaLogger.appInfo.clientId,
					hostJsVersion: AriaLogger.appInfo.hostJSVersion,
					id: AriaLogger.appInfo.appId,
					instanceId: AriaLogger.appInfo.appInstanceId,
					name: AriaLogger.appInfo.name,
					officeJsVersion: AriaLogger.appInfo.officeJSVersion,
					osfRuntimeVersion: OSF.ConstantNames.FileVersion,
					sessionId: AriaLogger.appInfo.sessionId,
					url: AriaLogger.appInfo.appURL
				};
				...
				var version=AriaLogger.appInfo.hostVersion;
				var context={
					'App.Name': host,
					'App.Platform': flavor,
					'App.Version': version
		...
		AriaLogger.prototype.loadAriaScriptAndLog=function (tableName, telemetryData) {
			...
			if (AriaLogger.EnableSendingTelemetryWithOTel && eventEnabled(tableName)) {
...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.11215.10000";
		...
		OSFAriaLogger.AriaLogger.setInfo(appInfo);
...
(function (Word) {
	...
	var _adjustToDateTime=OfficeExtension.Utility.adjustToDateTime;
	var _processRetrieveResult=OfficeExtension.Utility.processRetrieveResult;
	var _typeAnnotations="Annotations";
	var Annotations=(function (_super) {
		__extends(Annotations, _super);
		function Annotations() {
			return _super !==null && _super.apply(this, arguments) || this;
		}
		Object.defineProperty(Annotations.prototype, "_className", {
			get: function () {
				return "Annotations";
			},
			enumerable: true,
		...
		Annotations.prototype.getAnnotations=function (annotationType) {
			return _invokeMethod(this, "GetAnnotations", 0, [annotationType], 0, 0);
		};
		Annotations.prototype._handleResult=function (value) {
			_super.prototype._handleResult.call(this, value);
			if (_isNullOrUndefined(value))
				return;
			var obj=value;
		...
		Annotations.prototype._handleRetrieveResult=function (value, result) {
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result);
		};
		Object.defineProperty(Annotations.prototype, "onAnnotationAdded", {
			get: function () {
				if (!this.m_annotationAdded) {
					this.m_annotationAdded=new OfficeExtension.EventHandlers(this.context, this, "AnnotationAdded", null);
				}
		...
		Annotations.prototype.toJSON=function () {
			return _toJson(this, {}, {});
		};
		return Annotations;
	}(OfficeExtension.ClientObject));
	...
	var Document=(function (_super) {
		...
		Document.prototype.getAnnotations=function () {
			return _createMethodObject(Word.Annotations, this, "GetAnnotations", 1, [], false, false, null, 4);
		};
