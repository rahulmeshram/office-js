...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.11319.30000";
...
(function (OSFWebAuth) {
	...
	function initialize() {
		console.log("webauth.implicit is being initialized");
		OSF.OUtil.loadScript(OSF._OfficeAppFactory.getLoadScriptHelper().getOfficeJsBasePath()+CDN_PATH_WEBAUTHJS, function () {
			...
			console.log("webauth.implicit was initialized");
		});
	}
	OSFWebAuth.initialize=initialize;
	function load(config) {
		console.log("Implicit.Load is triggered");
		return Implicit.Load(config);
	}
...
(function (OfficeFirstPartyAuth) {
	function getAccessToken(options) {
		...
		if (OSF.WebAuh) {
			console.log("kotai:OSF.WebAuh is available");
		}
		else {
			console.log("kotai:OSF.WebAuh is NOT available");
		}
