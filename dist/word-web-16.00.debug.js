...
// Sources:
// osfweb: custom
// runtime: 16.0.11127.30003
// core: 16.0\11201.10000
// host: 16.0\11201.10000
...
(function (OSFAriaLogger) {
	...
	function generateTelemetryEvent(eventName, telemetryData) {
		...
		dataFields.push(oteljs.makeStringDataField("tag", "0"));
		var flags={};
	...
	var AriaLogger=(function () {
		...
		AriaLogger.getTelemetryLogger=function (info) {
			if (AriaLogger.otelTelemetryLogger===undefined) {
				...
				var context={
					...
					'App.Version': AriaLogger.appInfo.hostVersion
				};
		...
		AriaLogger.sendOtelTelemetryEventCallback=function (info, eventName, telemetryData) {
			var event=generateTelemetryEvent(eventName, telemetryData);
			if (event===undefined) {
				return;
			}
			try {
				var logger=AriaLogger.getTelemetryLogger(info);
		...
		AriaLogger.sendOtelTelemetryEvent=function (eventName, telemetryData) {
			...
			var afterLoadOtelSink=function () {
				Microsoft.Office.WebExtension.onReadyInternal().then(function (info) { return AriaLogger.sendOtelTelemetryEventCallback(info, eventName, telemetryData); });
			};
