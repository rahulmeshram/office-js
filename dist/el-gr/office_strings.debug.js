...
Strings.OfficeOM.L_ConfirmDialog = "Εμπιστεύεστε τον τομέα {0} όπου φιλοξενείται αυτή η περίοδος λειτουργίας του Office;";
...
Strings.OfficeOM.L_NoHttpsWAC = "Αυτή η περίοδος λειτουργίας του Office δεν χρησιμοποιεί ασφαλή σύνδεση. Συνιστάται να τραβήξετε επιπλέον προφυλάξεις.";
...
Strings.OfficeOM.L_NotTrustedWAC = "Αυτό το πρόσθετο έχει απενεργοποιηθεί για να σας βοηθήσει να παραμείνετε ασφαλείς. Για να συνεχίσετε να χρησιμοποιείτε το πρόσθετο, επικυρώστε ότι αυτό το στοιχείο φιλοξενείται σε έναν αξιόπιστο τομέα ή ανοίξτε το στην εφαρμογή υπολογιστή του Office.";
...
Strings.OfficeOM.L_WriteNotSupportedWhenModalDialogOpen = "Όταν ένα αποκλειστικό παράθυρο διαλόγου είναι ανοιχτό, η λειτουργία γραφής δεν υποστηρίζεται για το Office.";