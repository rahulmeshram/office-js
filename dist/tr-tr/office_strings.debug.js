...
Strings.OfficeOM.L_AttemptingToSetReadOnlyProperty = "Salt okunur olan '{0}' özelliği ayarlanmaya çalışılıyor.";
...
Strings.OfficeOM.L_ConfirmCancelMessage = "Üzgünüz, devam edemiyoruz.";
Strings.OfficeOM.L_ConfirmDialog = "Bu Office oturumunun barındırıldığı {0} etki alanına güveniyor musunuz?";
Strings.OfficeOM.L_ConfirmRefreshMessage = "Devam etmek için, eklentiyi kaldırıp yeniden ekleyin veya sayfayı yenileyin.";
...
Strings.OfficeOM.L_ContinueButton = "Devam et";
...
Strings.OfficeOM.L_DialogOK = "Tamam";
Strings.OfficeOM.L_DialogRequireHTTPS = "HTTP protokolü desteklenmiyor. Bunun yerine HTTPS kullanın";
...
Strings.OfficeOM.L_InvalidApiArgumentsMessage = "Giriş bağımsız değişkenleri geçersiz.";
...
Strings.OfficeOM.L_InvalidArgumentGeneric = "İşleve eklenen bağımsız değişkenler, eksik, bu duruma uygun değil veya doğru biçimde değil.";
...
Strings.OfficeOM.L_InvalidResourceUrl = "Geçersiz uygulama kaynağı URL'si sağlandı.";
Strings.OfficeOM.L_InvalidResourceUrlMessage = "Bildirimde geçersiz kaynak URL'si belirtildi.";
Strings.OfficeOM.L_InvalidSSOAddinMessage = "Bu eklenti için kimlik API'si desteklenmiyor.";
...
Strings.OfficeOM.L_NewWindowCrossZone = "Tarayıcınızdaki güvenlik ayarları, bir iletişim kutusu oluşturmamızı engelliyor. Farklı bir tarayıcı deneyin veya '{1}' ile adres çubuğunuzdaki etki alanının aynı güvenlik bölgesinde olması için {0}.";
...
Strings.OfficeOM.L_NoHttpsWAC = "Bu Office oturumu için güvenli bir bağlantı kullanılmıyor. Ek önlemler almanızı öneririz.";
...
Strings.OfficeOM.L_NotTrustedWAC = "Bu eklenti güvenliğinizi sağlamak amacıyla devre dışı bırakıldı. Eklentiyi kullanmaya devam etmek için, bu öğenin güvenilen bir etki alanında barındırıldığını doğrulayın veya Office masaüstü uygulamasında açın.";
...
Strings.OfficeOM.L_PropertyDoesNotExist = "'{0}' özelliği nesnede yok.";
...
Strings.OfficeOM.L_SSOClientError = "Office'ten gelen kimlik doğrulaması isteğinde bir hata oluştu.";
Strings.OfficeOM.L_SSOClientErrorMessage = "İstemcide beklenmeyen bir hata oluştu.";
Strings.OfficeOM.L_SSOConnectionLostError = "Oturum açma işlemi sırasında bir bağlantı kesildi.";
...
Strings.OfficeOM.L_Timeout = "İşlem zaman aşımına uğradı.";
...
Strings.OfficeOM.L_UnsupportedUserIdentity = "Kullanıcı kimliği türü desteklenmiyor.";
Strings.OfficeOM.L_UnsupportedUserIdentityMessage = "Kullanıcının kimlik türü desteklenmiyor.";
...
Strings.OfficeOM.L_WriteNotSupportedWhenModalDialogOpen = "Kalıcı iletişim kutusu açıkken Office için yazma işlemi desteklenmez.";