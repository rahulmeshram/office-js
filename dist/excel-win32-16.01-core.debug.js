...
!function(e) {
    ...
    (function(e) {
        function n(e) {
            ...
            isNaN(n) || isNaN(r) || isNaN(i)) throw "version format incorrect";
            return {
                major: n,
                minor: r,
                patch: i
    ...
    t.Dialog = p, t.displayWebDialog = function(e, t) {
        return void 0 === t && (t = {}), new o.CoreUtility.Promise((function(r, i) {
            if (t.width && t.height && (!n(t.width) || !n(t.height))) throw new o.Error({
