...
OSF._OfficeAppFactory = (function OSF__OfficeAppFactory() {
    ...
    Microsoft.Office.WebExtension.getAccessToken = function Microsoft_Office_WebExtension_getAccessToken(target) {
        if (OSF.WebAuth) {
            return OSF.WebAuth.getToken(target);
        }
        return null;
    };
