...
_u.ExtensibilityStrings.l_CallSaveAsyncBeforeToken_Text = "అంశాన్ని సేవ్ చేసే వరకు టోకెన్‌ని తిరిగి పొందడం సాధ్యం కాదు.";
...
_u.ExtensibilityStrings.l_InvalidDate_Text = "ఇన్‌పుట్ చెల్లుబాటు అయ్యే తేదీని పరిష్కరించడం లేదు.";
...
_u.ExtensibilityStrings.l_NumberOfNotificationsExceeded_Text = "నోటిఫికేషన్ పరిమితిని చేరుకున్నారు కనుక నోటిఫికేషన్‌ని జోడించడం సాధ్యం కాలేదు.";
_u.ExtensibilityStrings.l_NumberOfRecipientsExceeded_Text = "ఫీల్డ్‌లో చేర్చిన మొత్తం గ్రహీతల సంఖ్య {0} కంటే ఎక్కువ ఉండకూడదు.";
_u.ExtensibilityStrings.l_OffsetNotfound_Text = "ఈ సమయ ముద్ర కోసం ఆఫ్‌సెట్‌ని కనుగొనలేకపోయాము.";
_u.ExtensibilityStrings.l_Olk_Http_Error_Text = "అభ్యర్థన విఫలమైంది. దయచేసి HTTP దోషం కోడ్ కోసం సమస్యల విశ్లేషణ ఆబ్జెక్ట్‌ని చూడండి.";
_u.ExtensibilityStrings.l_ParameterValueTooLongError_Text = "పరామితి '{0}' విలువ చాలా పెద్దదిగా ఉంది. అక్షరాల గరిష్ట సంఖ్య '{1}'.";
_u.ExtensibilityStrings.l_ParametersNotAsExpected_Text = "ఆశించిన ఆకృతితో ఇచ్చిన పారామీటర్‌లు సరిపోలడం లేదు.";
_u.ExtensibilityStrings.l_PersistedNotificationArrayReadError_Text = "ప్రస్తుతం ఉన్న నోటిఫికేషన్‌లను తిరిగి పొందడం సాధ్యం కాలేదు కనుక మీరు చేసిన API కాల్ విఫలమైంది.";
_u.ExtensibilityStrings.l_PersistedNotificationArraySaveError_Text = "నోటిఫికేషన్‌లను తిరిగి పొందడం సాధ్యం కాలేదు కనుక మీరు చేసిన API కాల్ విఫలమైంది.";
