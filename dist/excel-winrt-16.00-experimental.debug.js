...
++scalarPropCount;
					...
					if (shouldPolyfill) {
						for (var i=0; i < scalarPropNames.length; i++) {
							...
							if (!CommonUtility.isUndefined(propValue)) {
								promises.push(CommonActionFactory.createSetPropertyAction(this._context, this, propName, propValue));
							}
						}
					}
					else {
						promises.push(CommonActionFactory.createUpdateAction(this._context, this, scalarProps));
					}
				}
				for (var propName in navigationProps) {
					var navigationPropProxy=this[propName];
					var navigationPropValue=navigationProps[propName];
					promises.push(navigationPropProxy._recursivelyUpdate(navigationPropValue));
				}
				return OfficeExtension_1.Promise.all(promises).then(function () { });
			}
			catch (innerError) {
				throw new _Internal.RuntimeError({
					code: CoreErrorCodes.invalidArgument,
	...
	var ServiceApiQueue=(function () {
		...
		ServiceApiQueue.prototype.processActions=function (actionsToRetry) {
			var _this=this;
			if ((!actionsToRetry && this.m_actions.length===0) || (actionsToRetry && actionsToRetry.length===0)) {
				return;
			}
			var actions=actionsToRetry || this.m_actions;
			this.m_actions=[];
			...
			executor
				...
				CoreUtility.log('Executor Error:');
				CoreUtility.log(ex);
				for (var i=0; i < actions.length; i++) {
					var action=actions[i];
					action.reject(ex);
		...
		ServiceApiQueue.prototype.processActionResults=function (request, actions, actionResults, err) {
			...
			var actionResultActionIds=actionResults.map(function (actionResult) { return actionResult.ActionId; });
			for (var i=0; i < actions.length; i++) {
				var action=actions[i];
				var actionId=action.action.actionInfo.Id;
				var actionIdIdx=actionResultActionIds.indexOf(actionId);
				if (actionIdIdx >=0) {
					var resultValue=actionResults[actionIdIdx].Value;
					...
					if (i < actions.length - 1) {
						this.processActions(actions.slice(i+1));
						break;
					}
				}
			}
	...
	var OperationalApiHelper=(function () {
		...
		OperationalApiHelper.invokeRecursiveUpdate=function (obj, properties) {
			return obj._recursivelyUpdate(properties);
		};
		...
		OperationalApiHelper.isNullObject=function (type, parent) {
			var _a=parent._objectPath, flags=_a.flags, getByIdMethodName=_a.getByIdMethodName, isCollection=_a.isCollection, isInvalidAfterRequest=_a.isInvalidAfterRequest, operationType=_a.operationType, objectPathInfo=_a.objectPathInfo;
			var previousMethodName=objectPathInfo.Name;
			var nullMethodName=previousMethodName+"OrNullObject";
			var args=objectPathInfo.ArgumentInfo.Arguments;
			var obj=OperationalApiHelper.createMethodObject(type, parent, nullMethodName, operationType, args, isCollection, isInvalidAfterRequest, getByIdMethodName, flags);
			return OperationalApiHelper.invokeRetrieve(obj, ['dummy'])
				.then(function () { return false; })["catch"](function (err) {
...
(function (ExcelOp) {
	...
	var _isNullObject=OfficeExtension.OperationalApiHelper.isNullObject;
	...
	var Runtime=(function (_super) {
		...
		Runtime.prototype.isNullObject=function () {
			return _isNullObject(Runtime, this);
		};
	...
	var Application=(function (_super) {
		...
		Application.prototype.isNullObject=function () {
			return _isNullObject(Application, this);
		};
	...
	var IterativeCalculation=(function (_super) {
		...
		IterativeCalculation.prototype.isNullObject=function () {
			return _isNullObject(IterativeCalculation, this);
		};
	...
	var Workbook=(function (_super) {
		...
		Object.defineProperty(Workbook.prototype, "_navigationPropertyNames", {
			get: function () {
				return ["worksheets", "names", "tables", "application", "bindings", "functions", "_V1Api", "pivotTables", "settings", "customXmlParts", "internalTest", "properties", "styles", "protection", "dataConnections", "_Runtime", "comments", "slicers", "tableStyles", "pivotTableStyles", "slicerStyles", "timelineStyles"];
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(Workbook.prototype, "comments", {
			get: function () {
				_throwIfApiNotSupported("Workbook.comments", _defaultApiSetName, "2.0", _hostName);
		...
		Object.defineProperty(Workbook.prototype, "pivotTableStyles", {
			get: function () {
				_throwIfApiNotSupported("Workbook.pivotTableStyles", _defaultApiSetName, "1.9", _hostName);
				return _createPropertyObject(ExcelOp.PivotTableStyleCollection, this, "PivotTableStyles", true, 4);
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(Workbook.prototype, "slicerStyles", {
			get: function () {
				_throwIfApiNotSupported("Workbook.slicerStyles", _defaultApiSetName, "1.9", _hostName);
				return _createPropertyObject(ExcelOp.SlicerStyleCollection, this, "SlicerStyles", true, 4);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Workbook.prototype, "slicers", {
			get: function () {
				_throwIfApiNotSupported("Workbook.slicers", _defaultApiSetName, "2.0", _hostName);
		...
		Object.defineProperty(Workbook.prototype, "tableStyles", {
			get: function () {
				_throwIfApiNotSupported("Workbook.tableStyles", _defaultApiSetName, "1.9", _hostName);
				return _createPropertyObject(ExcelOp.TableStyleCollection, this, "TableStyles", true, 4);
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(Workbook.prototype, "timelineStyles", {
			get: function () {
				_throwIfApiNotSupported("Workbook.timelineStyles", _defaultApiSetName, "1.9", _hostName);
				return _createPropertyObject(ExcelOp.TimelineStyleCollection, this, "TimelineStyles", true, 4);
			},
			enumerable: true,
			configurable: true
		});
		...
		Workbook.prototype.getActiveSlicer=function () {
			_throwIfApiNotSupported("Workbook.getActiveSlicer", _defaultApiSetName, "2.0", _hostName);
		...
		Workbook.prototype.close=function (closeBehavior) {
			_throwIfApiNotSupported("Workbook.close", _defaultApiSetName, "2.0", _hostName);
		...
		Workbook.prototype.save=function (saveBehavior) {
			_throwIfApiNotSupported("Workbook.save", _defaultApiSetName, "2.0", _hostName);
		...
		Workbook.prototype.isNullObject=function () {
			return _isNullObject(Workbook, this);
		};
	...
	var WorkbookProtection=(function (_super) {
		...
		WorkbookProtection.prototype.isNullObject=function () {
			return _isNullObject(WorkbookProtection, this);
		};
	...
	var WorkbookCreated=(function (_super) {
		...
		WorkbookCreated.prototype.isNullObject=function () {
			return _isNullObject(WorkbookCreated, this);
		};
	...
	var Worksheet=(function (_super) {
		...
		Object.defineProperty(Worksheet.prototype, "comments", {
			get: function () {
				_throwIfApiNotSupported("Worksheet.comments", _defaultApiSetName, "2.0", _hostName);
				return _createPropertyObject(ExcelOp.CommentCollection, this, "Comments", true, 4);
			},
			enumerable: true,
			configurable: true
		...
		Object.defineProperty(Worksheet.prototype, "slicers", {
			get: function () {
				_throwIfApiNotSupported("Worksheet.slicers", _defaultApiSetName, "2.0", _hostName);
				return _createPropertyObject(ExcelOp.SlicerCollection, this, "Slicers", true, 4);
			},
			enumerable: true,
			configurable: true
		...
		Worksheet.prototype.isNullObject=function () {
			return _isNullObject(Worksheet, this);
		};
	...
	var WorksheetCollection=(function (_super) {
		...
		WorksheetCollection.prototype.addFromBase64=function (base64File, sheetNamesToInsert, positionType, relativeTo) {
			_throwIfApiNotSupported("WorksheetCollection.addFromBase64", _defaultApiSetName, "2.0", _hostName);
		...
		WorksheetCollection.prototype.isNullObject=function () {
			return _isNullObject(WorksheetCollection, this);
		};
	...
	var WorksheetProtection=(function (_super) {
		...
		WorksheetProtection.prototype.isNullObject=function () {
			return _isNullObject(WorksheetProtection, this);
		};
	...
	var WorksheetFreezePanes=(function (_super) {
		...
		WorksheetFreezePanes.prototype.isNullObject=function () {
			return _isNullObject(WorksheetFreezePanes, this);
		};
	...
	var Range=(function (_super) {
		...
		Range.prototype.getSpillParent=function () {
			_throwIfApiNotSupported("Range.getSpillParent", _defaultApiSetName, "2.0", _hostName);
		...
		Range.prototype.getSpillingToRange=function () {
			_throwIfApiNotSupported("Range.getSpillingToRange", _defaultApiSetName, "2.0", _hostName);
		...
		Range.prototype.setCellProperties=function (cellPropertiesData) {
			if (cellPropertiesData instanceof OfficeExtension.ClientResult) {
				cellPropertiesData=cellPropertiesData.value;
			}
		...
		Range.prototype.setColumnProperties=function (columnPropertiesData) {
			if (columnPropertiesData instanceof OfficeExtension.ClientResult) {
				columnPropertiesData=columnPropertiesData.value;
			}
		...
		Range.prototype.setRowProperties=function (rowPropertiesData) {
			if (rowPropertiesData instanceof OfficeExtension.ClientResult) {
				rowPropertiesData=rowPropertiesData.value;
			}
		...
		Range.prototype.isNullObject=function () {
			return _isNullObject(Range, this);
		};
	...
	var RangeAreas=(function (_super) {
		...
		RangeAreas.prototype.isNullObject=function () {
			return _isNullObject(RangeAreas, this);
		};
	...
	var RangeView=(function (_super) {
		...
		RangeView.prototype.isNullObject=function () {
			return _isNullObject(RangeView, this);
		};
	...
	var RangeViewCollection=(function (_super) {
		...
		RangeViewCollection.prototype.isNullObject=function () {
			return _isNullObject(RangeViewCollection, this);
		};
	...
	var SettingCollection=(function (_super) {
		...
		SettingCollection.prototype.isNullObject=function () {
			return _isNullObject(SettingCollection, this);
		};
	...
	var Setting=(function (_super) {
		...
		Setting.prototype.isNullObject=function () {
			return _isNullObject(Setting, this);
		};
	...
	var NamedItemCollection=(function (_super) {
		...
		NamedItemCollection.prototype.isNullObject=function () {
			return _isNullObject(NamedItemCollection, this);
		};
	...
	var NamedItem=(function (_super) {
		...
		NamedItem.prototype.isNullObject=function () {
			return _isNullObject(NamedItem, this);
		};
	...
	var NamedItemArrayValues=(function (_super) {
		...
		NamedItemArrayValues.prototype.isNullObject=function () {
			return _isNullObject(NamedItemArrayValues, this);
		};
	...
	var Binding=(function (_super) {
		...
		Binding.prototype.isNullObject=function () {
			return _isNullObject(Binding, this);
		};
	...
	var BindingCollection=(function (_super) {
		...
		BindingCollection.prototype.isNullObject=function () {
			return _isNullObject(BindingCollection, this);
		};
	...
	var TableCollection=(function (_super) {
		...
		TableCollection.prototype.isNullObject=function () {
			return _isNullObject(TableCollection, this);
		};
	...
	var TableScopedCollection=(function (_super) {
		...
		TableScopedCollection.prototype.isNullObject=function () {
			return _isNullObject(TableScopedCollection, this);
		};
	...
	var Table=(function (_super) {
		...
		Table.prototype.isNullObject=function () {
			return _isNullObject(Table, this);
		};
	...
	var TableColumnCollection=(function (_super) {
		...
		TableColumnCollection.prototype.isNullObject=function () {
			return _isNullObject(TableColumnCollection, this);
		};
	...
	var TableColumn=(function (_super) {
		...
		TableColumn.prototype.isNullObject=function () {
			return _isNullObject(TableColumn, this);
		};
	...
	var TableRowCollection=(function (_super) {
		...
		TableRowCollection.prototype.isNullObject=function () {
			return _isNullObject(TableRowCollection, this);
		};
	...
	var TableRow=(function (_super) {
		...
		TableRow.prototype.isNullObject=function () {
			return _isNullObject(TableRow, this);
		};
	...
	var DataValidation=(function (_super) {
		...
		DataValidation.prototype.isNullObject=function () {
			return _isNullObject(DataValidation, this);
		};
	...
	var RemoveDuplicatesResult=(function (_super) {
		...
		RemoveDuplicatesResult.prototype.isNullObject=function () {
			return _isNullObject(RemoveDuplicatesResult, this);
		};
	...
	var RangeFormat=(function (_super) {
		...
		RangeFormat.prototype.isNullObject=function () {
			return _isNullObject(RangeFormat, this);
		};
	...
	var FormatProtection=(function (_super) {
		...
		FormatProtection.prototype.isNullObject=function () {
			return _isNullObject(FormatProtection, this);
		};
	...
	var RangeFill=(function (_super) {
		...
		RangeFill.prototype.isNullObject=function () {
			return _isNullObject(RangeFill, this);
		};
	...
	var RangeBorder=(function (_super) {
		...
		RangeBorder.prototype.isNullObject=function () {
			return _isNullObject(RangeBorder, this);
		};
	...
	var RangeBorderCollection=(function (_super) {
		...
		RangeBorderCollection.prototype.isNullObject=function () {
			return _isNullObject(RangeBorderCollection, this);
		};
	...
	var RangeFont=(function (_super) {
		...
		RangeFont.prototype.isNullObject=function () {
			return _isNullObject(RangeFont, this);
		};
	...
	var ChartCollection=(function (_super) {
		...
		ChartCollection.prototype.isNullObject=function () {
			return _isNullObject(ChartCollection, this);
		};
	...
	var Chart=(function (_super) {
		...
		Chart.prototype.isNullObject=function () {
			return _isNullObject(Chart, this);
		};
	...
	var ChartPivotOptions=(function (_super) {
		...
		ChartPivotOptions.prototype.isNullObject=function () {
			return _isNullObject(ChartPivotOptions, this);
		};
	...
	var ChartAreaFormat=(function (_super) {
		...
		ChartAreaFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartAreaFormat, this);
		};
	...
	var ChartSeriesCollection=(function (_super) {
		...
		ChartSeriesCollection.prototype.isNullObject=function () {
			return _isNullObject(ChartSeriesCollection, this);
		};
	...
	var ChartSeries=(function (_super) {
		...
		ChartSeries.prototype.isNullObject=function () {
			return _isNullObject(ChartSeries, this);
		};
	...
	var ChartSeriesFormat=(function (_super) {
		...
		ChartSeriesFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartSeriesFormat, this);
		};
	...
	var ChartPointsCollection=(function (_super) {
		...
		ChartPointsCollection.prototype.isNullObject=function () {
			return _isNullObject(ChartPointsCollection, this);
		};
	...
	var ChartPoint=(function (_super) {
		...
		ChartPoint.prototype.isNullObject=function () {
			return _isNullObject(ChartPoint, this);
		};
	...
	var ChartPointFormat=(function (_super) {
		...
		ChartPointFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartPointFormat, this);
		};
	...
	var ChartAxes=(function (_super) {
		...
		ChartAxes.prototype.isNullObject=function () {
			return _isNullObject(ChartAxes, this);
		};
	...
	var ChartAxis=(function (_super) {
		...
		ChartAxis.prototype.isNullObject=function () {
			return _isNullObject(ChartAxis, this);
		};
	...
	var ChartAxisFormat=(function (_super) {
		...
		ChartAxisFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartAxisFormat, this);
		};
	...
	var ChartAxisTitle=(function (_super) {
		...
		ChartAxisTitle.prototype.isNullObject=function () {
			return _isNullObject(ChartAxisTitle, this);
		};
	...
	var ChartAxisTitleFormat=(function (_super) {
		...
		ChartAxisTitleFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartAxisTitleFormat, this);
		};
	...
	var ChartDataLabels=(function (_super) {
		...
		ChartDataLabels.prototype.isNullObject=function () {
			return _isNullObject(ChartDataLabels, this);
		};
	...
	var ChartDataLabel=(function (_super) {
		...
		ChartDataLabel.prototype.isNullObject=function () {
			return _isNullObject(ChartDataLabel, this);
		};
	...
	var ChartDataLabelFormat=(function (_super) {
		...
		ChartDataLabelFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartDataLabelFormat, this);
		};
	...
	var ChartErrorBars=(function (_super) {
		...
		ChartErrorBars.prototype.isNullObject=function () {
			return _isNullObject(ChartErrorBars, this);
		};
	...
	var ChartErrorBarsFormat=(function (_super) {
		...
		ChartErrorBarsFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartErrorBarsFormat, this);
		};
	...
	var ChartGridlines=(function (_super) {
		...
		ChartGridlines.prototype.isNullObject=function () {
			return _isNullObject(ChartGridlines, this);
		};
	...
	var ChartGridlinesFormat=(function (_super) {
		...
		ChartGridlinesFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartGridlinesFormat, this);
		};
	...
	var ChartLegend=(function (_super) {
		...
		ChartLegend.prototype.isNullObject=function () {
			return _isNullObject(ChartLegend, this);
		};
	...
	var ChartLegendEntry=(function (_super) {
		...
		ChartLegendEntry.prototype.isNullObject=function () {
			return _isNullObject(ChartLegendEntry, this);
		};
	...
	var ChartLegendEntryCollection=(function (_super) {
		...
		ChartLegendEntryCollection.prototype.isNullObject=function () {
			return _isNullObject(ChartLegendEntryCollection, this);
		};
	...
	var ChartLegendFormat=(function (_super) {
		...
		ChartLegendFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartLegendFormat, this);
		};
	...
	var ChartMapOptions=(function (_super) {
		...
		ChartMapOptions.prototype.isNullObject=function () {
			return _isNullObject(ChartMapOptions, this);
		};
	...
	var ChartTitle=(function (_super) {
		...
		ChartTitle.prototype.isNullObject=function () {
			return _isNullObject(ChartTitle, this);
		};
	...
	var ChartFormatString=(function (_super) {
		...
		ChartFormatString.prototype.isNullObject=function () {
			return _isNullObject(ChartFormatString, this);
		};
	...
	var ChartTitleFormat=(function (_super) {
		...
		ChartTitleFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartTitleFormat, this);
		};
	...
	var ChartFill=(function (_super) {
		...
		ChartFill.prototype.isNullObject=function () {
			return _isNullObject(ChartFill, this);
		};
	...
	var ChartBorder=(function (_super) {
		...
		ChartBorder.prototype.isNullObject=function () {
			return _isNullObject(ChartBorder, this);
		};
	...
	var ChartBinOptions=(function (_super) {
		...
		ChartBinOptions.prototype.isNullObject=function () {
			return _isNullObject(ChartBinOptions, this);
		};
	...
	var ChartBoxwhiskerOptions=(function (_super) {
		...
		ChartBoxwhiskerOptions.prototype.isNullObject=function () {
			return _isNullObject(ChartBoxwhiskerOptions, this);
		};
	...
	var ChartLineFormat=(function (_super) {
		...
		ChartLineFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartLineFormat, this);
		};
	...
	var ChartFont=(function (_super) {
		...
		ChartFont.prototype.isNullObject=function () {
			return _isNullObject(ChartFont, this);
		};
	...
	var ChartTrendline=(function (_super) {
		...
		ChartTrendline.prototype.isNullObject=function () {
			return _isNullObject(ChartTrendline, this);
		};
	...
	var ChartTrendlineCollection=(function (_super) {
		...
		ChartTrendlineCollection.prototype.isNullObject=function () {
			return _isNullObject(ChartTrendlineCollection, this);
		};
	...
	var ChartTrendlineFormat=(function (_super) {
		...
		ChartTrendlineFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartTrendlineFormat, this);
		};
	...
	var ChartTrendlineLabel=(function (_super) {
		...
		ChartTrendlineLabel.prototype.isNullObject=function () {
			return _isNullObject(ChartTrendlineLabel, this);
		};
	...
	var ChartTrendlineLabelFormat=(function (_super) {
		...
		ChartTrendlineLabelFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartTrendlineLabelFormat, this);
		};
	...
	var ChartPlotArea=(function (_super) {
		...
		ChartPlotArea.prototype.isNullObject=function () {
			return _isNullObject(ChartPlotArea, this);
		};
	...
	var ChartPlotAreaFormat=(function (_super) {
		...
		ChartPlotAreaFormat.prototype.isNullObject=function () {
			return _isNullObject(ChartPlotAreaFormat, this);
		};
	...
	var VisualCollection=(function (_super) {
		...
		VisualCollection.prototype.isNullObject=function () {
			return _isNullObject(VisualCollection, this);
		};
	...
	var Visual=(function (_super) {
		...
		Visual.prototype.isNullObject=function () {
			return _isNullObject(Visual, this);
		};
	...
	var VisualProperty=(function (_super) {
		...
		VisualProperty.prototype.isNullObject=function () {
			return _isNullObject(VisualProperty, this);
		};
	...
	var VisualPropertyCollection=(function (_super) {
		...
		VisualPropertyCollection.prototype.isNullObject=function () {
			return _isNullObject(VisualPropertyCollection, this);
		};
	...
	var DataControllerClient=(function (_super) {
		...
		DataControllerClient.prototype.isNullObject=function () {
			return _isNullObject(DataControllerClient, this);
		};
	...
	var RangeSort=(function (_super) {
		...
		RangeSort.prototype.isNullObject=function () {
			return _isNullObject(RangeSort, this);
		};
	...
	var TableSort=(function (_super) {
		...
		TableSort.prototype.isNullObject=function () {
			return _isNullObject(TableSort, this);
		};
	...
	var Filter=(function (_super) {
		...
		Filter.prototype.isNullObject=function () {
			return _isNullObject(Filter, this);
		};
	...
	var AutoFilter=(function (_super) {
		...
		AutoFilter.prototype.isNullObject=function () {
			return _isNullObject(AutoFilter, this);
		};
	...
	var CustomXmlPartScopedCollection=(function (_super) {
		...
		CustomXmlPartScopedCollection.prototype.isNullObject=function () {
			return _isNullObject(CustomXmlPartScopedCollection, this);
		};
	...
	var CustomXmlPartCollection=(function (_super) {
		...
		CustomXmlPartCollection.prototype.isNullObject=function () {
			return _isNullObject(CustomXmlPartCollection, this);
		};
	...
	var CustomXmlPart=(function (_super) {
		...
		CustomXmlPart.prototype.isNullObject=function () {
			return _isNullObject(CustomXmlPart, this);
		};
	...
	var _V1Api=(function (_super) {
		...
		_V1Api.prototype.isNullObject=function () {
			return _isNullObject(_V1Api, this);
		};
	...
	var PivotTableCollection=(function (_super) {
		...
		PivotTableCollection.prototype.isNullObject=function () {
			return _isNullObject(PivotTableCollection, this);
		};
	...
	var PivotTable=(function (_super) {
		...
		PivotTable.prototype.isNullObject=function () {
			return _isNullObject(PivotTable, this);
		};
	...
	var PivotLayout=(function (_super) {
		...
		PivotLayout.prototype.isNullObject=function () {
			return _isNullObject(PivotLayout, this);
		};
	...
	var PivotHierarchyCollection=(function (_super) {
		...
		PivotHierarchyCollection.prototype.isNullObject=function () {
			return _isNullObject(PivotHierarchyCollection, this);
		};
	...
	var PivotHierarchy=(function (_super) {
		...
		PivotHierarchy.prototype.isNullObject=function () {
			return _isNullObject(PivotHierarchy, this);
		};
	...
	var RowColumnPivotHierarchyCollection=(function (_super) {
		...
		RowColumnPivotHierarchyCollection.prototype.isNullObject=function () {
			return _isNullObject(RowColumnPivotHierarchyCollection, this);
		};
	...
	var RowColumnPivotHierarchy=(function (_super) {
		...
		RowColumnPivotHierarchy.prototype.isNullObject=function () {
			return _isNullObject(RowColumnPivotHierarchy, this);
		};
	...
	var FilterPivotHierarchyCollection=(function (_super) {
		...
		FilterPivotHierarchyCollection.prototype.isNullObject=function () {
			return _isNullObject(FilterPivotHierarchyCollection, this);
		};
	...
	var FilterPivotHierarchy=(function (_super) {
		...
		FilterPivotHierarchy.prototype.isNullObject=function () {
			return _isNullObject(FilterPivotHierarchy, this);
		};
	...
	var DataPivotHierarchyCollection=(function (_super) {
		...
		DataPivotHierarchyCollection.prototype.isNullObject=function () {
			return _isNullObject(DataPivotHierarchyCollection, this);
		};
	...
	var DataPivotHierarchy=(function (_super) {
		...
		DataPivotHierarchy.prototype.isNullObject=function () {
			return _isNullObject(DataPivotHierarchy, this);
		};
	...
	var PivotFieldCollection=(function (_super) {
		...
		PivotFieldCollection.prototype.isNullObject=function () {
			return _isNullObject(PivotFieldCollection, this);
		};
	...
	var PivotField=(function (_super) {
		...
		PivotField.prototype.isNullObject=function () {
			return _isNullObject(PivotField, this);
		};
	...
	var PivotItemCollection=(function (_super) {
		...
		PivotItemCollection.prototype.isNullObject=function () {
			return _isNullObject(PivotItemCollection, this);
		};
	...
	var PivotItem=(function (_super) {
		...
		PivotItem.prototype.isNullObject=function () {
			return _isNullObject(PivotItem, this);
		};
	...
	var DocumentProperties=(function (_super) {
		...
		DocumentProperties.prototype.isNullObject=function () {
			return _isNullObject(DocumentProperties, this);
		};
	...
	var CustomProperty=(function (_super) {
		...
		CustomProperty.prototype.isNullObject=function () {
			return _isNullObject(CustomProperty, this);
		};
	...
	var CustomPropertyCollection=(function (_super) {
		...
		CustomPropertyCollection.prototype.isNullObject=function () {
			return _isNullObject(CustomPropertyCollection, this);
		};
	...
	var ConditionalFormatCollection=(function (_super) {
		...
		ConditionalFormatCollection.prototype.isNullObject=function () {
			return _isNullObject(ConditionalFormatCollection, this);
		};
	...
	var ConditionalFormat=(function (_super) {
		...
		ConditionalFormat.prototype.isNullObject=function () {
			return _isNullObject(ConditionalFormat, this);
		};
	...
	var DataBarConditionalFormat=(function (_super) {
		...
		DataBarConditionalFormat.prototype.isNullObject=function () {
			return _isNullObject(DataBarConditionalFormat, this);
		};
	...
	var ConditionalDataBarPositiveFormat=(function (_super) {
		...
		ConditionalDataBarPositiveFormat.prototype.isNullObject=function () {
			return _isNullObject(ConditionalDataBarPositiveFormat, this);
		};
	...
	var ConditionalDataBarNegativeFormat=(function (_super) {
		...
		ConditionalDataBarNegativeFormat.prototype.isNullObject=function () {
			return _isNullObject(ConditionalDataBarNegativeFormat, this);
		};
	...
	var CustomConditionalFormat=(function (_super) {
		...
		CustomConditionalFormat.prototype.isNullObject=function () {
			return _isNullObject(CustomConditionalFormat, this);
		};
	...
	var ConditionalFormatRule=(function (_super) {
		...
		ConditionalFormatRule.prototype.isNullObject=function () {
			return _isNullObject(ConditionalFormatRule, this);
		};
	...
	var IconSetConditionalFormat=(function (_super) {
		...
		IconSetConditionalFormat.prototype.isNullObject=function () {
			return _isNullObject(IconSetConditionalFormat, this);
		};
	...
	var ColorScaleConditionalFormat=(function (_super) {
		...
		ColorScaleConditionalFormat.prototype.isNullObject=function () {
			return _isNullObject(ColorScaleConditionalFormat, this);
		};
	...
	var TopBottomConditionalFormat=(function (_super) {
		...
		TopBottomConditionalFormat.prototype.isNullObject=function () {
			return _isNullObject(TopBottomConditionalFormat, this);
		};
	...
	var PresetCriteriaConditionalFormat=(function (_super) {
		...
		PresetCriteriaConditionalFormat.prototype.isNullObject=function () {
			return _isNullObject(PresetCriteriaConditionalFormat, this);
		};
	...
	var TextConditionalFormat=(function (_super) {
		...
		TextConditionalFormat.prototype.isNullObject=function () {
			return _isNullObject(TextConditionalFormat, this);
		};
	...
	var CellValueConditionalFormat=(function (_super) {
		...
		CellValueConditionalFormat.prototype.isNullObject=function () {
			return _isNullObject(CellValueConditionalFormat, this);
		};
	...
	var ConditionalRangeFormat=(function (_super) {
		...
		ConditionalRangeFormat.prototype.isNullObject=function () {
			return _isNullObject(ConditionalRangeFormat, this);
		};
	...
	var ConditionalRangeFont=(function (_super) {
		...
		ConditionalRangeFont.prototype.isNullObject=function () {
			return _isNullObject(ConditionalRangeFont, this);
		};
	...
	var ConditionalRangeFill=(function (_super) {
		...
		ConditionalRangeFill.prototype.isNullObject=function () {
			return _isNullObject(ConditionalRangeFill, this);
		};
	...
	var ConditionalRangeBorder=(function (_super) {
		...
		ConditionalRangeBorder.prototype.isNullObject=function () {
			return _isNullObject(ConditionalRangeBorder, this);
		};
	...
	var ConditionalRangeBorderCollection=(function (_super) {
		...
		ConditionalRangeBorderCollection.prototype.isNullObject=function () {
			return _isNullObject(ConditionalRangeBorderCollection, this);
		};
	...
	var NumberFormattingService=(function (_super) {
		...
		NumberFormattingService.prototype.isNullObject=function () {
			return _isNullObject(NumberFormattingService, this);
		};
	...
	var NumberFormatter=(function (_super) {
		...
		NumberFormatter.prototype.isNullObject=function () {
			return _isNullObject(NumberFormatter, this);
		};
	...
	var CustomFunctionManager=(function (_super) {
		...
		CustomFunctionManager.prototype.isNullObject=function () {
			return _isNullObject(CustomFunctionManager, this);
		};
	...
	var Style=(function (_super) {
		...
		Style.prototype.isNullObject=function () {
			return _isNullObject(Style, this);
		};
	...
	var StyleCollection=(function (_super) {
		...
		StyleCollection.prototype.isNullObject=function () {
			return _isNullObject(StyleCollection, this);
		};
	...
	var TableStyleCollection=(function (_super) {
		...
		TableStyleCollection.prototype.add=function (name, makeUniqueName) {
			return _createAndInstantiateMethodObject(ExcelOp.TableStyle, this, "Add", 0, [name, makeUniqueName], false, true, null, 0);
		};
		TableStyleCollection.prototype.getDefault=function () {
			return _createAndInstantiateMethodObject(ExcelOp.TableStyle, this, "GetDefault", 0, [], false, false, null, 0);
		};
		TableStyleCollection.prototype.getItem=function (name) {
			return _createIndexerObject(ExcelOp.TableStyle, this, [name]);
		};
		TableStyleCollection.prototype.getCount=function () {
			return _invokeMethod(this, "GetCount", 1, [], 4, 0);
		};
		TableStyleCollection.prototype.setDefault=function (newDefaultStyle) {
			return _invokeMethod(this, "SetDefault", 0, [newDefaultStyle], 0);
		};
		TableStyleCollection.prototype.retrieve=function () {
			var select=[];
			for (var _i=0; _i < arguments.length; _i++) {
				select[_i]=arguments[_i];
			}
		...
		TableStyleCollection.prototype.isNullObject=function () {
			return _isNullObject(TableStyleCollection, this);
		};
	...
	ExcelOp.TableStyleCollection=TableStyleCollection;
	var TableStyle=(function (_super) {
		...
		TableStyle.prototype.duplicate=function () {
			return _createAndInstantiateMethodObject(ExcelOp.TableStyle, this, "Duplicate", 0, [], false, false, null, 0);
		};
		...
		TableStyle.prototype.retrieve=function () {
			var select=[];
			for (var _i=0; _i < arguments.length; _i++) {
				select[_i]=arguments[_i];
			}
		...
		TableStyle.prototype.isNullObject=function () {
			return _isNullObject(TableStyle, this);
		};
	...
	var PivotTableStyleCollection=(function (_super) {
		...
		PivotTableStyleCollection.prototype.add=function (name, makeUniqueName) {
			return _createAndInstantiateMethodObject(ExcelOp.PivotTableStyle, this, "Add", 0, [name, makeUniqueName], false, true, null, 0);
		};
		PivotTableStyleCollection.prototype.getDefault=function () {
			return _createAndInstantiateMethodObject(ExcelOp.PivotTableStyle, this, "GetDefault", 0, [], false, false, null, 0);
		};
		PivotTableStyleCollection.prototype.getItem=function (name) {
			return _createIndexerObject(ExcelOp.PivotTableStyle, this, [name]);
		};
		...
		PivotTableStyleCollection.prototype.retrieve=function () {
			var select=[];
			for (var _i=0; _i < arguments.length; _i++) {
				select[_i]=arguments[_i];
			}
		...
		PivotTableStyleCollection.prototype.isNullObject=function () {
			return _isNullObject(PivotTableStyleCollection, this);
		};
	...
	ExcelOp.PivotTableStyleCollection=PivotTableStyleCollection;
	var PivotTableStyle=(function (_super) {
		...
		PivotTableStyle.prototype.duplicate=function () {
			return _createAndInstantiateMethodObject(ExcelOp.PivotTableStyle, this, "Duplicate", 0, [], false, false, null, 0);
		};
		...
		PivotTableStyle.prototype.retrieve=function () {
			var select=[];
			for (var _i=0; _i < arguments.length; _i++) {
				select[_i]=arguments[_i];
			}
		...
		PivotTableStyle.prototype.isNullObject=function () {
			return _isNullObject(PivotTableStyle, this);
		};
	...
	ExcelOp.PivotTableStyle=PivotTableStyle;
	var SlicerStyleCollection=(function (_super) {
		...
		SlicerStyleCollection.prototype.add=function (name, makeUniqueName) {
			return _createAndInstantiateMethodObject(ExcelOp.SlicerStyle, this, "Add", 0, [name, makeUniqueName], false, true, null, 0);
		};
		SlicerStyleCollection.prototype.getDefault=function () {
			return _createAndInstantiateMethodObject(ExcelOp.SlicerStyle, this, "GetDefault", 0, [], false, false, null, 0);
		};
		SlicerStyleCollection.prototype.getItem=function (name) {
			return _createIndexerObject(ExcelOp.SlicerStyle, this, [name]);
		};
		...
		SlicerStyleCollection.prototype.retrieve=function () {
			var select=[];
			for (var _i=0; _i < arguments.length; _i++) {
				select[_i]=arguments[_i];
			}
		...
		SlicerStyleCollection.prototype.isNullObject=function () {
			return _isNullObject(SlicerStyleCollection, this);
		};
	...
	ExcelOp.SlicerStyleCollection=SlicerStyleCollection;
	var SlicerStyle=(function (_super) {
		...
		SlicerStyle.prototype.duplicate=function () {
			return _createAndInstantiateMethodObject(ExcelOp.SlicerStyle, this, "Duplicate", 0, [], false, false, null, 0);
		};
		...
		SlicerStyle.prototype.retrieve=function () {
			var select=[];
			for (var _i=0; _i < arguments.length; _i++) {
				select[_i]=arguments[_i];
			}
		...
		SlicerStyle.prototype.isNullObject=function () {
			return _isNullObject(SlicerStyle, this);
		};
	...
	ExcelOp.SlicerStyle=SlicerStyle;
	var TimelineStyleCollection=(function (_super) {
		...
		TimelineStyleCollection.prototype.add=function (name, makeUniqueName) {
			return _createAndInstantiateMethodObject(ExcelOp.TimelineStyle, this, "Add", 0, [name, makeUniqueName], false, true, null, 0);
		};
		TimelineStyleCollection.prototype.getDefault=function () {
			return _createAndInstantiateMethodObject(ExcelOp.TimelineStyle, this, "GetDefault", 0, [], false, false, null, 0);
		};
		TimelineStyleCollection.prototype.getItem=function (name) {
			return _createIndexerObject(ExcelOp.TimelineStyle, this, [name]);
		};
		...
		TimelineStyleCollection.prototype.retrieve=function () {
			var select=[];
			for (var _i=0; _i < arguments.length; _i++) {
				select[_i]=arguments[_i];
			}
		...
		TimelineStyleCollection.prototype.isNullObject=function () {
			return _isNullObject(TimelineStyleCollection, this);
		};
	...
	ExcelOp.TimelineStyleCollection=TimelineStyleCollection;
	var TimelineStyle=(function (_super) {
		...
		TimelineStyle.prototype.duplicate=function () {
			return _createAndInstantiateMethodObject(ExcelOp.TimelineStyle, this, "Duplicate", 0, [], false, false, null, 0);
		};
		...
		TimelineStyle.prototype.retrieve=function () {
			var select=[];
			for (var _i=0; _i < arguments.length; _i++) {
				select[_i]=arguments[_i];
			}
		...
		TimelineStyle.prototype.isNullObject=function () {
			return _isNullObject(TimelineStyle, this);
		};
	...
	ExcelOp.TimelineStyle=TimelineStyle;
	var InternalTest=(function (_super) {
		...
		InternalTest.prototype.exitCellEdit=function () {
			...
			return _invokeMethod(this, "ExitCellEdit", 0, [], 0);
		};
		...
		InternalTest.prototype.isNullObject=function () {
			return _isNullObject(InternalTest, this);
		};
	...
	ExcelOp.internalTest=_createTopLevelServiceObject(InternalTest, _localDocumentContext, "Microsoft.ExcelServices.InternalTest", false, 4);
	var PageLayout=(function (_super) {
		...
		PageLayout.prototype.isNullObject=function () {
			return _isNullObject(PageLayout, this);
		};
	...
	var HeaderFooter=(function (_super) {
		...
		HeaderFooter.prototype.isNullObject=function () {
			return _isNullObject(HeaderFooter, this);
		};
	...
	var HeaderFooterGroup=(function (_super) {
		...
		HeaderFooterGroup.prototype.isNullObject=function () {
			return _isNullObject(HeaderFooterGroup, this);
		};
	...
	var PageBreak=(function (_super) {
		...
		PageBreak.prototype.isNullObject=function () {
			return _isNullObject(PageBreak, this);
		};
	...
	var PageBreakCollection=(function (_super) {
		...
		PageBreakCollection.prototype.isNullObject=function () {
			return _isNullObject(PageBreakCollection, this);
		};
	...
	var DataConnectionCollection=(function (_super) {
		...
		DataConnectionCollection.prototype.isNullObject=function () {
			return _isNullObject(DataConnectionCollection, this);
		};
	...
	var RangeCollection=(function (_super) {
		...
		RangeCollection.prototype.isNullObject=function () {
			return _isNullObject(RangeCollection, this);
		};
	...
	var CommentCollection=(function (_super) {
		...
		CommentCollection.prototype.isNullObject=function () {
			return _isNullObject(CommentCollection, this);
		};
		CommentCollection.prototype.toJSON=function () {
			return {};
		};
	...
	var Comment=(function (_super) {
		...
		Comment.prototype.isNullObject=function () {
			return _isNullObject(Comment, this);
		};
		Comment.prototype.toJSON=function () {
			return {};
		};
	...
	var CommentReplyCollection=(function (_super) {
		...
		CommentReplyCollection.prototype.isNullObject=function () {
			return _isNullObject(CommentReplyCollection, this);
		};
	...
	var CommentReply=(function (_super) {
		...
		CommentReply.prototype.isNullObject=function () {
			return _isNullObject(CommentReply, this);
		};
	...
	var ShapeCollection=(function (_super) {
		...
		ShapeCollection.prototype.addSvg=function (xml) {
			return _createAndInstantiateMethodObject(ExcelOp.Shape, this, "AddSvg", 0, [xml], false, false, null, 0);
		};
		...
		ShapeCollection.prototype.isNullObject=function () {
			return _isNullObject(ShapeCollection, this);
		};
	...
	var Shape=(function (_super) {
		...
		Shape.prototype.setZOrder=function (position) {
			return _invokeMethod(this, "SetZOrder", 0, [position], 0);
		};
		...
		Shape.prototype.isNullObject=function () {
			return _isNullObject(Shape, this);
		};
	...
	var GeometricShape=(function (_super) {
		...
		GeometricShape.prototype.isNullObject=function () {
			return _isNullObject(GeometricShape, this);
		};
	...
	var Image=(function (_super) {
		...
		Image.prototype.isNullObject=function () {
			return _isNullObject(Image, this);
		};
	...
	var ShapeGroup=(function (_super) {
		...
		ShapeGroup.prototype.isNullObject=function () {
			return _isNullObject(ShapeGroup, this);
		};
	...
	var GroupShapeCollection=(function (_super) {
		...
		GroupShapeCollection.prototype.isNullObject=function () {
			return _isNullObject(GroupShapeCollection, this);
		};
	...
	var Line=(function (_super) {
		...
		Line.prototype.connectBeginShape=function (shape, connectionSite) {
			return _invokeMethod(this, "ConnectBeginShape", 0, [shape, connectionSite], 0);
		};
		Line.prototype.connectEndShape=function (shape, connectionSite) {
			return _invokeMethod(this, "ConnectEndShape", 0, [shape, connectionSite], 0);
		};
		Line.prototype.disconnectBeginShape=function () {
			return _invokeMethod(this, "DisconnectBeginShape", 0, [], 0);
		};
		Line.prototype.disconnectEndShape=function () {
			return _invokeMethod(this, "DisconnectEndShape", 0, [], 0);
		};
		...
		Line.prototype.isNullObject=function () {
			return _isNullObject(Line, this);
		};
	...
	var ShapeFill=(function (_super) {
		...
		ShapeFill.prototype.isNullObject=function () {
			return _isNullObject(ShapeFill, this);
		};
	...
	var ShapeLineFormat=(function (_super) {
		...
		ShapeLineFormat.prototype.isNullObject=function () {
			return _isNullObject(ShapeLineFormat, this);
		};
	...
	var TextFrame=(function (_super) {
		...
		TextFrame.prototype.isNullObject=function () {
			return _isNullObject(TextFrame, this);
		};
	...
	var TextRange=(function (_super) {
		...
		TextRange.prototype.getSubstring=function (start, length) {
			return _createAndInstantiateMethodObject(ExcelOp.TextRange, this, "GetSubstring", 0, [start, length], false, false, null, 0);
		};
		...
		TextRange.prototype.isNullObject=function () {
			return _isNullObject(TextRange, this);
		};
	...
	var ShapeFont=(function (_super) {
		...
		ShapeFont.prototype.isNullObject=function () {
			return _isNullObject(ShapeFont, this);
		};
	...
	var Slicer=(function (_super) {
		...
		Slicer.prototype.isNullObject=function () {
			return _isNullObject(Slicer, this);
		};
	...
	var SlicerCollection=(function (_super) {
		...
		SlicerCollection.prototype.isNullObject=function () {
			return _isNullObject(SlicerCollection, this);
		};
	...
	var SlicerItem=(function (_super) {
		...
		SlicerItem.prototype.isNullObject=function () {
			return _isNullObject(SlicerItem, this);
		};
	...
	var SlicerItemCollection=(function (_super) {
		...
		SlicerItemCollection.prototype.isNullObject=function () {
			return _isNullObject(SlicerItemCollection, this);
		};
	...
	var Ribbon=(function (_super) {
		...
		Ribbon.prototype.isNullObject=function () {
			return _isNullObject(Ribbon, this);
		};
	...
	})(ShapeTextHorizontalAlignment=ExcelOp.ShapeTextHorizontalAlignment || (ExcelOp.ShapeTextHorizontalAlignment={}));
	...
	})(ShapeTextVerticalAlignment=ExcelOp.ShapeTextVerticalAlignment || (ExcelOp.ShapeTextVerticalAlignment={}));
	...
	})(ShapeTextVerticalOverflow=ExcelOp.ShapeTextVerticalOverflow || (ExcelOp.ShapeTextVerticalOverflow={}));
	...
	})(ShapeTextHorizontalOverflow=ExcelOp.ShapeTextHorizontalOverflow || (ExcelOp.ShapeTextHorizontalOverflow={}));
	...
	})(ShapeTextOrientation=ExcelOp.ShapeTextOrientation || (ExcelOp.ShapeTextOrientation={}));
	var ShapeAutoSize;
	...
	var FunctionResult=(function (_super) {
		...
		FunctionResult.prototype.isNullObject=function () {
			return _isNullObject(FunctionResult, this);
		};
	...
	var Functions=(function (_super) {
		...
		Functions.prototype.isNullObject=function () {
			return _isNullObject(Functions, this);
		};
